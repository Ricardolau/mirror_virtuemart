...
*/
if( vmIsJoomla('1.5', '<' )) {
	vmRedirect('index2.php?option=com_virtuemart&page=store.index', 'This Feature is only available on Joomla! 1.5.');
}
...
$extension_type = vmGet($_REQUEST, 'extension_type', 'payment');
