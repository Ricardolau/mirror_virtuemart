...
/**
 *
 * @version $Id: free_shipping.php 1760 2009-05-03 22:58:57Z Aravot $
 * @package VirtueMart
 * @subpackage shipping
...
class free_shipping {
	...
	function list_rates( &$d ) {
		...
		$html = "<strong>" . $VM_LANG->_( 'VM_FREE_SHIPPING_CUSTOMER_TEXT' ) . "</strong><br/>\n" ;
		$html .= "<input type=\"hidden\" name=\"shipping_rate_id\" value=\"free_shipping|$vendor_name|" . $VM_LANG->_( 'VM_FREE_SHIPPING' ) . "|0|1\" />" ;
