...
/**
*
* @version $Id: vmShippingMethod.php 1510 2008-08-08 19:11:42Z soeren_nb $
* @package VirtueMart
* @subpackage html
...
if ($id > 0 ) {
    ...
    if( $db->next_record() ) {
    	...
    	$VM_LANG->load('plg_'.$db->f('folder').'_'.$db->f('element'));
...
$formObj = &new formFactory( $VM_LANG->_('Add/Edit Plugin') );
//Then Start the form
$formObj->startForm();
?>
