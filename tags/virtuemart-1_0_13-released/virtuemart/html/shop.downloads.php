  	...
  	if (ENABLE_DOWNLOADS == '1') { ?>
	  	<form method="post" action="<?php echo $mm_action_url ?>index.php" name="downloadForm">
		  	...
		  	<div align="center">
			    ...
			    <br /><br />
			    <input type="submit" onclick="if( document.downloadForm.download_id.value.length < 12) { alert('<?php echo $VM_LANG->_CONTACT_FORM_NC ?>');return false;} else return true;" class="button" value="<?php echo $VM_LANG->_PHPSHOP_DOWNLOADS_START ?>" />
			 </div>
