...
$listObj->writeSearchHeader($VM_LANG->_('VM_PRODUCT_DISCOUNT_LIST_LBL'), IMAGEURL."ps_image/percentage.png", $modulename, "product_discount_list");
...
$columns = Array(  "#" => "width=\"20\"", 
					...
					$VM_LANG->_('VM_PRODUCT_DISCOUNT_AMOUNT') => '',
					$VM_LANG->_('VM_PRODUCT_DISCOUNT_AMOUNTTYPE') => '',
					$VM_LANG->_('VM_PRODUCT_DISCOUNT_STARTDATE') => '',
					$VM_LANG->_('VM_PRODUCT_DISCOUNT_ENDDATE') => '',
...
while ($db->next_record()) {
    ...
    $tmp_cell = $db->f("is_percent")=='1' ? $VM_LANG->_('VM_PRODUCT_DISCOUNT_ISPERCENT') : $VM_LANG->_('VM_PRODUCT_DISCOUNT_ISTOTAL');
	$listObj->addCell( $tmp_cell );
