...
<table class="adminlist">
	...
	<tr>
		...
		if( !in_array( $db->f( "field_name"), $ps_csv->reserved_words )) { ?> <a class="toolbar"
			href="index2.php?option=com_virtuemart&page=<?php echo $_REQUEST['page'] ?>&func=csvFieldDelete&field_id=<?php echo $db->f("field_id") ?>&vmtoken=<?php echo vmSpoofValue($sess->getSessionId()) ?>"
