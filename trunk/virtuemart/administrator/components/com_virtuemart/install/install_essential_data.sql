...
--
INSERT INTO `#__virtuemart_adminmenuentries` (`id`, `module_id`, `parent_id`, `name`, `link`, `depends`, `icon_class`,`uikit_icon`, `ordering`, `published`, `tooltip`, `view`, `task`) VALUES
(null , 1, 0, 'COM_VIRTUEMART_CATEGORY_S', '', '', 'vmicon vmicon-16-folder_camera', 'category', 1, 1, '', 'category', ''),
(null, 1, 0, 'COM_VIRTUEMART_PRODUCT_S', '', '', 'vmicon vmicon-16-camera', 'product', 2, 1, '', 'product', ''),
(null, 1, 0, 'COM_VIRTUEMART_PRODUCT_CUSTOM_FIELD_S', '', '', 'vmicon vmicon-16-document_move','customfield', 5, 1, '', 'custom', ''),
(null, 1, 0, 'COM_VIRTUEMART_PRODUCT_INVENTORY', '', '', 'vmicon vmicon-16-price_watch','inventory', 7, 1, '', 'inventory', ''),
(null, 1, 0, 'COM_VIRTUEMART_CALC_S', '', '', 'vmicon vmicon-16-calculator','calculator', 8, 1, '', 'calc', ''),
(null, 1, 0, 'COM_VIRTUEMART_REVIEW_RATE_S', '', '', 'vmicon vmicon-16-comments', 'comments',9, 1, '', 'ratings', ''),
(null, 2, 0, 'COM_VIRTUEMART_ORDER_S', '', '', 'vmicon vmicon-16-page_white_stack','cart', 1, 1, '', 'orders', ''),
(null, 2, 0, 'COM_VIRTUEMART_COUPON_S', '', '', 'vmicon vmicon-16-shopping','gift-box', 10, 1, '', 'coupon', ''),
(null, 2, 0, 'COM_VIRTUEMART_REPORT', '', '', 'vmicon vmicon-16-chart_bar', 'revenue',3, 1, '', 'report',''),
(null, 2, 0, 'COM_VIRTUEMART_USER_S', '', '', 'vmicon vmicon-16-user', 'user', 4, 1, '', 'user', ''),
(null, 2, 0, 'COM_VIRTUEMART_SHOPPERGROUP_S', '', '', 'vmicon vmicon-16-user-group', 'users' , 5, 1, '', 'shoppergroup', ''),
(null, 3, 0, 'COM_VIRTUEMART_MANUFACTURER_S', '', '', 'vmicon vmicon-16-wrench_orange', 'manufacturer', 1, 1, '', 'manufacturer', ''),
(null, 3, 0, 'COM_VIRTUEMART_MANUFACTURER_CATEGORY_S', '', '', 'vmicon vmicon-16-folder_wrench', 'category', 2, 1, '', 'manufacturercategories', ''),
(null, 4, 0, 'COM_VIRTUEMART_STORE', '', '', 'vmicon vmicon-16-reseller_account_template', 'shop', 1, 1, '', 'user', 'editshop'),
(null, 4, 0, 'COM_VIRTUEMART_MEDIA_S', '', '', 'vmicon vmicon-16-pictures', 'image', 2, 1, '', 'media', ''),
(null, 4, 0, 'COM_VIRTUEMART_SHIPMENTMETHOD_S', '', '', 'vmicon vmicon-16-lorry', 'shipment', 3, 1, '', 'shipmentmethod', ''),
(null, 4, 0, 'COM_VIRTUEMART_PAYMENTMETHOD_S', '', '', 'vmicon vmicon-16-creditcards', 'credit-card', 4, 1, '', 'paymentmethod', ''),
(null, 5, 0, 'COM_VIRTUEMART_CONFIGURATION', '', '', 'vmicon vmicon-16-config', 'cog', 1, 1, '', 'config', ''),
(null, 5, 0, 'COM_VIRTUEMART_USERFIELD_S', '', '', 'vmicon vmicon-16-participation_rate', 'id-card', 2, 1, '', 'userfields', ''),
(null, 5, 0, 'COM_VIRTUEMART_ORDERSTATUS_S', '', '', 'vmicon vmicon-16-document_editing',  'future', 3, 1, '', 'orderstatus', ''),
(null, 5, 0, 'COM_VIRTUEMART_CURRENCY_S', '', '', 'vmicon vmicon-16-coins', 'currencies', 5, 1, '', 'currency', ''),
(null, 5, 0, 'COM_VIRTUEMART_COUNTRY_S', '', '', 'vmicon vmicon-16-globe',  'world',6, 1, '', 'country', ''),
(null, 11, 0, 'COM_VIRTUEMART_MIGRATION_UPDATE', '', '', 'vmicon vmicon-16-installer_box', 'lifesaver', 0, 1, '', 'updatesmigration', ''),
(null, 11, 0, 'COM_VIRTUEMART_ABOUT', '', '', 'vmicon vmicon-16-info', 'lifesaver',10, 1, '', 'about', ''),
(null, 11, 0, 'COM_VIRTUEMART_HELP_TOPICS', 'http://docs.virtuemart.net/', '', 'vmicon vmicon-16-help', 'lifesaver',5, 1, '', '', ''),
(null, 11, 0, 'COM_VIRTUEMART_COMMUNITY_FORUM', 'http://forum.virtuemart.net/', '', 'vmicon vmicon-16-reseller_programm','lifesaver', 7, 1, '', '', ''),
(null, 11, 0, 'COM_VIRTUEMART_STATISTIC_SUMMARY', '', '', 'vmicon vmicon-16-info','lifesaver', 1, 1, '', 'virtuemart', ''),
(null, 11, 0, 'COM_VIRTUEMART_LOG', '', '', 'vmicon vmicon-16-info', 'lifesaver',2, 1, '', 'log', ''),
(null, 11, 0, 'COM_VIRTUEMART_SUPPORT', '', '', 'vmicon vmicon-16-help', 'lifesaver',3, 1, '', 'support', '');
--
