...
/**
*
* @version $Id: admin.country_form.php 1760 2009-05-03 22:58:57Z Aravot $
* @package VirtueMart
* @subpackage html
...
$formObj =& new formFactory( $VM_LANG->_('VM_COUNTRY_LIST_ADD') );
...
<table class="adminform">
	...
	<tr> 
		<td width="24%" align="right"><?php echo $VM_LANG->_('VM_COUNTRY_LIST_NAME') ?>:</td>
		<td width="76%"> 
			<input type="text" class="inputbox" name="country_name" value="<?php $db->sp("country_name") ?>" />
		</td>
	</tr>
	<tr> 
		<td width="24%" align="right"><?php echo $VM_LANG->_('VM_ZONE_ASSIGN_CURRENT_LBL') ?>:</td>
		<td width="76%"><?php echo $ps_zone->list_zones('zone_id',$db->f('zone_id'));  ?></td>
	</tr>
	<tr> 
		<td width="24%" align="right"><?php echo $VM_LANG->_('VM_COUNTRY_LIST_2_CODE') ?>:</td>
		<td width="76%"> 
			<input type="text" class="inputbox" name="country_2_code" value="<?php $db->sp("country_2_code") ?>" />
		</td>
	</tr>
	<tr> 
		<td width="24%" align="right"><?php echo $VM_LANG->_('VM_COUNTRY_LIST_3_CODE') ?>:</td>
		<td width="76%"> 
