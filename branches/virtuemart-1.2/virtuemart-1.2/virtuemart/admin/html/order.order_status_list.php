...
/**
*
* @version $Id: order.order_status_list.php 1760 2009-05-03 22:58:57Z Aravot $
* @package VirtueMart
* @subpackage html
...
$listObj->writeSearchHeader($VM_LANG->_('VM_ORDER_STATUS_LIST_MNU'), "", $modulename, "order_status_list");
...
$columns = Array(  "#" => "width=\"20\"", 
					...
					$VM_LANG->_('VM_ORDER_STATUS_LIST_NAME') => '',
					$VM_LANG->_('VM_ORDER_STATUS_LIST_CODE') => '',
