...
def createXML(path):
    ...
    forversion = "1.1.1"
    toversion = "1.1.3"
    releasedate = "January 22, 2009"
    description = "This is the patch file for updating VirtueMart from version 1.1.1 to version 1.1.3."
...
if __name__ == '__main__' :
    ...
    path = "D:/m/build/vm-1.1/vm-1.1.3-090122/1.1.1-1.1.3/Patch-VirtueMart-1.1.1-1.1.3"
    createXML(path)
