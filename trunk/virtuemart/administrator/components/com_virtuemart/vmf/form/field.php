...
abstract class vFormField
{
	...
	/**
	 * The vForm object of the form attached to the form field.
	 *
	 * @var    vForm
	 * @since  11.1
	 */
	...
	/**
	 * The form control prefix for field names from the vForm object attached to the form field.
	 *
	 * @var    string
	 * @since  11.1
	 */
	 ...
	 *
	 * @param   vForm  $form  The form to attach to the form field object.
	 *
	 * @since   11.1
	 */
	 ...
	 *
	 * @param   vForm  $form  The vForm object to attach to the form field.
	 *
	...
	protected function getTitle()
	{
		...
		$title = $this->translateLabel ? vmText::_($title) : $title;
	...
	protected function getLabel()
	{
		...
		$text = $this->translateLabel ? vmText::_($text) : $text;

		// Forcing the Alias field to display the tip below
		$position = $this->element['name'] == 'alias' ? ' data-placement="bottom" ' : '';

		$description = ($this->translateDescription && !empty($this->description)) ? vmText::_($this->description) : $this->description;
