...
/**
*
* @version $Id: admin.module_list.php 1760 2009-05-03 22:58:57Z Aravot $
* @package VirtueMart
* @subpackage html
...
$listObj->writeSearchHeader($VM_LANG->_('VM_MODULE_LIST_LBL'), VM_THEMEURL.'images/administration/dashboard/modules.png', "admin", "module_list");
...
$columns = Array(  "#" => 'width="3%"',
					...
					$VM_LANG->_('VM_MODULE_LIST_NAME') => 'width="20%"'
				);
...
$columns[$VM_LANG->_('VM_MODULE_LIST_FUNCTIONS')] = 'width="10%"';
