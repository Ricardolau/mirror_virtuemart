...
class vmLanguage extends vmAbstractLanguage {
  ...
  válassad ki azt az állapotot, amely lehetõvé teszi a letöltést (ami után a vevõ azonnal értesítést kap e-mailben a letöltés engedélyezésérõl).';
	...
	var $_PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_USPS_CONTAINER = 'USPS szállítókonténer';
	var $_PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_USPS_CONTAINER_TOOLTIP = 'USPS szállítókonténer';
	...
	var $_PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_USPS_PACKAGEID = 'USPS csomagazonosító (0 kell legyen, nem támogat több csomagot)';
	var $_PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_USPS_PACKAGEID_TOOLTIP = 'USPS csomagazonosító (0 kell legyen, nem támogat több csomagot)';
	var $_PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_USPS_SHIPSERVICE = 'Az USPS-szállítás típusa (Expressz,Elsõ osztályú,Elsõbbségi,Csomag,BPM,Könyvtár,Média)';
	var $_PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_USPS_SHIPSERVICE_TOOLTIP = 'Az USPS-szállítás típusa (Expressz,Elsõ osztályú,Elsõbbségi,Csomag,BPM,Könyvtár,Média)';
