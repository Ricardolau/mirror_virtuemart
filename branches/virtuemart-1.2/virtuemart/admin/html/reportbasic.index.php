...
<span class="sectionname"><?php echo $VM_LANG->_('VM_REPORTBASIC_MOD') ?></span><br /><br />
    ...
    <table class="adminform" width="100%" border="0" cellspacing="0" cellpadding="1">
        <tr>
          <td><?php echo $VM_LANG->_('VM_VIEW') ?></td>
          ...
          <label for="show_products"><?php echo $VM_LANG->_('VM_RB_INDIVIDUAL') ?></label> &nbsp; &nbsp; 
          </td>
        </tr>
        ...
        <tr>
          <td><?php echo $VM_LANG->_('VM_SHOW') ?></td>

          <td>
          <input type="submit" class="button" name="thisMonth" value="<?php echo $VM_LANG->_('VM_RB_THISMONTH_BUTTON'); ?>" /> &nbsp; 
          <input type="submit" class="button" name="lastMonth" value="<?php echo $VM_LANG->_('VM_RB_LASTMONTH_BUTTON'); ?>" /> &nbsp; 
          <input type="submit" class="button" name="last60" value="<?php echo $VM_LANG->_('VM_RB_LAST60_BUTTON'); ?>" /> &nbsp;
          <input type="submit" class="button" name="last90" value="<?php echo $VM_LANG->_('VM_RB_LAST90_BUTTON'); ?>" />
          </td>
        </tr>
        ...
        <tr valign="top">
          <td width="100"><?php echo $VM_LANG->_('VM_RB_START_DATE_TITLE'); ?></td>
        ...
        <tr>
          <td width="100"><?php echo $VM_LANG->_('VM_RB_END_DATE_TITLE'); ?></td>
        ...
        <tr>
          ...
          <td><input type="submit" class="button" name="sbmt" value="<?php echo $VM_LANG->_('VM_RB_SHOW_SEL_RANGE') ?>" /> </td>
        </tr>
      </table>
    </form>
...
/* setup the db and query */
 ...
 ?>
    <h4><?php 
    echo $VM_LANG->_('VM_RB_REPORT_FOR') ." ";
    echo date("M j, Y", $start_date)." --&gt; ". date("M j, Y", $end_date); 
    ?></h4>

    <table class="adminlist">
      <tr>
        <th><?php echo $VM_LANG->_('VM_RB_DATE') ?></th>

        <th><?php echo $VM_LANG->_('VM_RB_ORDERS') ?></th>

        <th><?php echo $VM_LANG->_('VM_RB_TOTAL_ITEMS') ?></th>

        <th><?php echo $VM_LANG->_('VM_RB_REVENUE') ?></th>
      </tr>
<?php
  ...
  <?php
    ...
    <tr><td>&nbsp;</td><td colspan="2">
      <table class="adminlist">
        <tr>
          <td colspan="3" align="left"><h3><?php echo $VM_LANG->_('VM_RB_PRODLIST') ?></h3></td>
        </tr>
        <tr bgcolor="#ffffff">
          <th>#</th>
          <th><?php echo $VM_LANG->_('VM_PRODUCT_NAME_TITLE') ?></th>
