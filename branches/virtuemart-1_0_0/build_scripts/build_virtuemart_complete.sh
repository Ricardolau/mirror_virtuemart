...
7za a -ttar -r $SVN_PATH/frontend_files.tar $SVN_PATH/js $SVN_PATH/css $SVN_PATH/shop_image $SVN_PATH/virtuemart.php $SVN_PATH/virtuemart_parser.php $SVN_PATH/show_image_in_imgtag.php
...
7za d $SVN_PATH/com_virtuemart.tar virtuemart.php virtuemart_parser.php show_image_in_imgtag.php
...
7za a -tzip $WRITE_PATH/VirtueMart_$VERSION-COMPLETE_PACKAGE.zip $SVN_PATH/com_virtuemart_$VERSION.tar.gz $SVN_PATH/mod_virtuemart_$VERSION.tar.gz $SVN_PATH/mod_virtuemart_allinone_$VERSION.tar.gz $SVN_PATH/mod_virtuemart_cart_$VERSION.tar.gz $SVN_PATH/mod_virtuemart_featureprod_$VERSION.tar.gz $SVN_PATH/mod_virtuemart_latestprod_$VERSION.tar.gz $SVN_PATH/mod_virtuemart_randomprod_$VERSION.tar.gz $SVN_PATH/mod_virtuemart_manufacturers_$VERSION.tar.gz $SVN_PATH/mod_product_categories_$VERSION.tar.gz $SVN_PATH/mod_productscroller_$VERSION.tar.gz $SVN_PATH/mod_virtuemart_search_$VERSION.tar.gz $SVN_PATH/mod_virtuemart_topten_$VERSION.tar.gz $SVN_PATH/mosproductsnap_$VERSION.tar.gz $SVN_PATH/virtuemart.searchbot_$VERSION.tar.gz $SVN_PATH/REAMDE.php
