...
$langvars = array (
	...
	'VM_ADMIN_CFG_GLOBAL' => 'Global',
	'VM_ADMIN_CFG_SITE' => 'Site',
	'VM_ADMIN_CFG_SHIPPING' => 'Shipping',
	'VM_ADMIN_CFG_CHECKOUT' => 'Checkout',
	'VM_ADMIN_CFG_DOWNLOADABLEGOODS' => 'Downloads',
	...
	'VM_ADMIN_CFG_SHOW_PRICES_EXPLAIN' => 'Check to show prices. If using catalogue functionality, some don\'t want prices to appear on pages.',
	...
	'VM_ADMIN_CFG_TAX_MODE_EXPLAIN' => 'This determines which tax rate is taken for calculating taxes:<br />
	...
	'VM_ADMIN_CFG_MULTI_TAX_RATE' => 'Enable multiple tax rates?',
	'VM_ADMIN_CFG_MULTI_TAX_RATE_EXPLAIN' => 'Check this, if you have products with different tax rates (e.g. 7% for books and food, 16% for other stuff)',
	...
	'VM_ADMIN_CFG_MAIL_FORMAT_EXPLAIN' => 'This determines how your order confirmation emails are set up:<br />
	...
	'VM_ADMIN_CFG_FLYPAGE' => 'FLYPAGE',
	'VM_ADMIN_CFG_FLYPAGE_EXPLAIN' => 'This is the default page for displaying product details.',
	...
	'VM_ADMIN_CFG_STORE_SHIPPING_METHOD_DISABLE' => 'Disable Shipping method selection. Choose if your customers buy downloadable goods which don\'t have to be shipped.',
	...
	'VM_ADMIN_CFG_DOWNLOADROOT' => 'DOWNLOADROOT',
	...
	'VM_ADMIN_CFG_PRICE_SHOW_INCLUDINGTAX' => 'Show "(including XX% tax)" when applicable?',
	'VM_ADMIN_CFG_PRICE_SHOW_INCLUDINGTAX_TIP' => 'When checked, users will see the text "(including xx% tax)" when prices are shown incl. tax.',
	...
	'VM_ADMIN_CFG_PRICE_SHOW_EXCLUDINGTAX' => 'Show "(excluding tax)" ?',
	'VM_ADMIN_CFG_PRICE_SHOW_EXCLUDINGTAX_TIP' => 'When checked, users will see the text "(excluding tax)" when prices are shown excl. tax.',
	'VM_ADMIN_CFG_PRICE_SHOW_PACKAGING_PRICELABEL' => 'Show the price label for packaging?',
	'VM_ADMIN_CFG_PRICE_SHOW_PACKAGING_PRICELABEL_TIP' => 'When checked, the price label is derived from the product\'s unit and packaging values:<br/>
