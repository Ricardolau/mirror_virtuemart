...
class vmLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_CATEGORY = 'Vare gruppe';
	var $_PHPSHOP_CATEGORIES = 'Vare grupper';
	...
	var $_PHPSHOP_ACCOUNT_TITLE = 'Konto oplysninger';
	...
	var $_PHPSHOP_FLYPAGE_LBL = 'Vare oplysninger';
	var $_PHPSHOP_PRODUCT_SEARCH_LBL = 'Søg efter vare';
	var $_PHPSHOP_PRODUCT_NAME_TITLE = 'Vare navn';
	...
	var $_PHPSHOP_ADD_SHIPTO_2 = 'Leverings adresse';
	...
	var $_PHPSHOP_EMAIL_SENDTO = 'En bekræftelses email er blevet sendt til ';
	var $_PHPSHOP_NO_USER_TO_SELECT = 'Beklager, men der findes ingen brugere som du kan tilføje til kunde listen i virtuemart.';
	...
	var $_PHPSHOP_MOD_NO_AUTH = 'Du har ikke rettigheder til at tilgå modulet.';
	...
	var $_PHPSHOP_USER_LIST_LBL = 'Kunde liste';
	...
	var $_PHPSHOP_USER_FORM_LBL = 'Ny/ret bruger data';
	var $_PHPSHOP_USER_FORM_BILLTO_LBL = 'Faktura oplysninger';
	var $_PHPSHOP_USER_FORM_SHIPTO_LBL = 'Leverings adresse';
	var $_PHPSHOP_USER_FORM_ADD_SHIPTO_LBL = 'Tilføj adresse';
	var $_PHPSHOP_USER_FORM_NO_SHIPPING_ADDRESSES = 'Ingen leverings adresse';
	...
	var $_PHPSHOP_USER_FORM_MIDDLE_NAME = 'Mellem navn';
	...
	var $_PHPSHOP_USER_FORM_CUSTOMER_NUMBER = 'Kunde nummer / ID';
	var $_PHPSHOP_USER_FORM_COMPANY_NAME = 'Firma navn';
	...
	var $_PHPSHOP_USER_FORM_PHONE2 = 'Mobil telefon';
	...
	var $_PHPSHOP_MODULE_LIST_PERMS = 'Modul rettigheder';
	var $_PHPSHOP_MODULE_LIST_FUNCTIONS = 'Functioner';
	var $_PHPSHOP_MODULE_LIST_ORDER = 'Rækkefølge';
	var $_PHPSHOP_MODULE_FORM_MNU = 'Nyt modul';
	var $_PHPSHOP_MODULE_FORM_LBL = 'Modul data';
	var $_PHPSHOP_MODULE_FORM_MODULE_LABEL = 'Modul navn (til Topmenu)';
	var $_PHPSHOP_MODULE_FORM_NAME = 'Modul navn';
	var $_PHPSHOP_MODULE_FORM_PERMS = 'Modul Rett.';
	var $_PHPSHOP_MODULE_FORM_HEADER = 'Modul hovede';
	var $_PHPSHOP_MODULE_FORM_FOOTER = 'Modul fod';
	var $_PHPSHOP_MODULE_FORM_MENU = 'Vis modulet i Admin menuen?';
	var $_PHPSHOP_MODULE_FORM_ORDER = 'Visnings rækkefølge';
	...
	var $_PHPSHOP_FUNCTION_LIST_NAME = 'Funktion Navn';
	var $_PHPSHOP_FUNCTION_LIST_CLASS = 'Class Navn';
	var $_PHPSHOP_FUNCTION_LIST_METHOD = 'Class Metode';
	var $_PHPSHOP_FUNCTION_LIST_PERMS = 'Rettighed.';
	var $_PHPSHOP_FUNCTION_FORM_MNU = 'Ny funktion';
	var $_PHPSHOP_FUNCTION_FORM_LBL = 'Funktions info';
	var $_PHPSHOP_FUNCTION_FORM_NAME = 'Funktions navn';
	var $_PHPSHOP_FUNCTION_FORM_CLASS = 'Klasse navn';
	var $_PHPSHOP_FUNCTION_FORM_METHOD = 'Klasse metode';
	var $_PHPSHOP_FUNCTION_FORM_PERMS = 'Funktion Rettighed';
	var $_PHPSHOP_FUNCTION_FORM_DESCRIPTION = 'Funktions beskrivelse';
	...
	var $_PHPSHOP_COUNTRY_LIST_NAME = 'Lande navn';
	var $_PHPSHOP_COUNTRY_LIST_3_CODE = 'Lande kode (3)';
	var $_PHPSHOP_COUNTRY_LIST_2_CODE = 'Lande kode (2)';
	...
	var $_PHPSHOP_ISSHIP_PING_CARRIER_LBL = 'Fragt firma';
	var $_PHPSHOP_ISSHIP_PING_RESPONSE_LBL = 'Svar<br />Tid';
	var $_PHPSHOP_ISSHIP_PING_TIME_LBL = 'sek.';
	var $_PHPSHOP_ISSHIP_LIST_MNU = 'Vis fragt måder';
	var $_PHPSHOP_ISSHIP_LIST_LBL = 'Aktive fragt måder';
	var $_PHPSHOP_ISSHIP_LIST_CARRIER_LBL = 'Fragt måder';
	var $_PHPSHOP_ISSHIP_LIST_PUBLISH_LBL = 'Aktiv';
	var $_PHPSHOP_ISSHIP_LIST_RATE_LBL = 'Administrations gebyr';
	...
	var $_PHPSHOP_ISSHIP_FORM_MNU = 'Konfigurer fragt metode';
	var $_PHPSHOP_ISSHIP_FORM_ADD_LBL = 'Ny fragt metode';
	var $_PHPSHOP_ISSHIP_FORM_UPDATE_LBL = 'Opsætning';
	var $_PHPSHOP_ISSHIP_FORM_REFRESH_LBL = 'Opfrisk';
	var $_PHPSHOP_ISSHIP_FORM_CARRIER_LBL = 'Fragt metode';
	var $_PHPSHOP_ISSHIP_FORM_PUBLISH_LBL = 'Aktiver';
	var $_PHPSHOP_ISSHIP_FORM_HANDLING_LBL = 'Administrations gebyr';
	...
	var $_PHPSHOP_ORDER_PRINT_PO_LBL = 'Indkøbs ordre';
	...
	var $_PHPSHOP_ORDER_PRINT_CUST_INFO_LBL = 'Kunde oplysninger';
	var $_PHPSHOP_ORDER_PRINT_CUST_BILLING_LBL = 'Faktura oplysninger';
	var $_PHPSHOP_ORDER_PRINT_CUST_SHIPPING_LBL = 'Leverings oplysninger';
	...
	var $_PHPSHOP_ORDER_PRINT_SHIPPING = 'Leverings og administrations gebyr';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_TAX = 'Fragt moms';
	var $_PHPSHOP_ORDER_PRINT_PAYMENT_LBL = 'Betalings form';
	var $_PHPSHOP_ORDER_PRINT_ACCOUNT_NAME = 'Konto navn';
	var $_PHPSHOP_ORDER_PRINT_ACCOUNT_NUMBER = 'Konto nummer';
	var $_PHPSHOP_ORDER_PRINT_EXPIRE_DATE = 'Udløbsdato';
	var $_PHPSHOP_ORDER_PRINT_PAYMENT_LOG_LBL = 'Betalings Log';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_LBL = 'Fragt oplysninger';
	var $_PHPSHOP_ORDER_PRINT_PAYINFO_LBL = 'Betalings information';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_CARRIER_LBL = 'Fragt firma';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_MODE_LBL = 'Forsendelses måde';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_DATE_LBL = 'Forsendelses dato';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_PRICE_LBL = 'Fragt pris';
	var $_PHPSHOP_ORDER_STATUS_LIST_MNU = 'Vis ordrestatus typer';
	var $_PHPSHOP_ORDER_STATUS_FORM_MNU = 'Ny ordrestatus type';
	var $_PHPSHOP_ORDER_STATUS_LIST_CODE = 'Ordrestatus kode';
	var $_PHPSHOP_ORDER_STATUS_LIST_NAME = 'Ordrestatus navn';
	var $_PHPSHOP_ORDER_STATUS_FORM_LBL = 'Ordre status';
	...
	var $_PHPSHOP_PRODUCT_INVENTORY_LBL = 'Vare beholdning';
	...
	var $_PHPSHOP_PRODUCT_LIST_NAME = 'Vare navn';
	...
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_INFO_LBL = 'Vare data';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_STATUS_LBL = 'Vare status';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_DIM_WEIGHT_LBL = 'Vare dimensioner';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_IMAGES_LBL = 'Vare billeder';
	var $_PHPSHOP_PRODUCT_FORM_NEW_ITEM_LBL = 'Ny vare';
	var $_PHPSHOP_PRODUCT_FORM_UPDATE_ITEM_LBL = 'Ret vare';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_INFO_LBL = 'Vare oplysninger';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_STATUS_LBL = 'Vare status';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_DIM_WEIGHT_LBL = 'Vare dimensioner og vægt';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_IMAGES_LBL = 'Vare billeder';
	...
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_ITEMS_LBL = 'Vare egenskaber';
	...
	var $_PHPSHOP_PRODUCT_FORM_PRICE_GROSS = 'Varens brutto pris';
	var $_PHPSHOP_PRODUCT_FORM_PRICE_NET = 'Varens netto pris';
	var $_PHPSHOP_PRODUCT_FORM_DESCRIPTION = 'Vare beskrivelse';
	...
	var $_PHPSHOP_PRODUCT_FORM_DISCOUNT_TYPE = 'Rabat type';
	...
	var $_PHPSHOP_PRODUCT_FORM_THUMB_IMAGE = 'Minirature billede';
	var $_PHPSHOP_PRODUCT_FORM_FULL_IMAGE = 'Billede';
	var $_PHPSHOP_PRODUCT_FORM_WEIGHT_UOM_DEFAULT = 'pund';
	var $_PHPSHOP_PRODUCT_FORM_DIMENSION_UOM_DEFAULT = 'tommer';
	...
	var $_PHPSHOP_PRODUCT_FORM_BOX = 'Enheder i kassen';
	var $_PHPSHOP_PRODUCT_FORM_BOX_DESCRIPTION = 'Her kan angives stk pr kasse. (max. 65535)';
	var $_PHPSHOP_PRODUCT_DISPLAY_ADD_PRODUCT_LBL = 'Resultat af opretelse';
	var $_PHPSHOP_PRODUCT_DISPLAY_UPDATE_PRODUCT_LBL = 'Resultat af opdatering';
	var $_PHPSHOP_PRODUCT_DISPLAY_ADD_ITEM_LBL = 'Resultat af post oprettelse';
	var $_PHPSHOP_PRODUCT_DISPLAY_UPDATE_ITEM_LBL = 'Resultat af post opdatering';
	var $_PHPSHOP_PRODUCT_CSV_UPLOAD = 'Import CSV fil';
	var $_PHPSHOP_PRODUCT_FOLDERS = 'Vare mapper';
	...
	var $_PHPSHOP_CATEGORY_FORM_LBL = 'Varegruppe oplysninger';
	var $_PHPSHOP_CATEGORY_FORM_NAME = 'Varegruppe navn';
	var $_PHPSHOP_CATEGORY_FORM_PARENT = 'Parent';
	var $_PHPSHOP_CATEGORY_FORM_DESCRIPTION = 'Varegruppe beskrivelse';
	var $_PHPSHOP_CATEGORY_FORM_PUBLISH = 'Aktiv?';
	var $_PHPSHOP_CATEGORY_FORM_FLYPAGE = 'Varegruppe oversigt';
	var $_PHPSHOP_ATTRIBUTE_LIST_MNU = 'Vis varianter';
	var $_PHPSHOP_ATTRIBUTE_LIST_LBL = 'Variant liste for';
	var $_PHPSHOP_ATTRIBUTE_LIST_NAME = 'Variant navn';
	var $_PHPSHOP_ATTRIBUTE_LIST_ORDER = 'Rækkefølge';
	var $_PHPSHOP_ATTRIBUTE_FORM_MNU = 'Ny variant';
	var $_PHPSHOP_ATTRIBUTE_FORM_LBL = 'Variant format';
	var $_PHPSHOP_ATTRIBUTE_FORM_NEW_FOR_PRODUCT = 'Ny vare variant';
	var $_PHPSHOP_ATTRIBUTE_FORM_UPDATE_FOR_PRODUCT = 'Ret vare variant';
	var $_PHPSHOP_ATTRIBUTE_FORM_NEW_FOR_ITEM = 'Ny variant';
	var $_PHPSHOP_ATTRIBUTE_FORM_UPDATE_FOR_ITEM = 'ret variant';
	var $_PHPSHOP_ATTRIBUTE_FORM_NAME = 'Variant navn';
	...
	var $_PHPSHOP_PRICE_FORM_LBL = 'Pris oplysninger';
	var $_PHPSHOP_PRICE_FORM_NEW_FOR_PRODUCT = 'Ny vare pris';
	var $_PHPSHOP_PRICE_FORM_UPDATE_FOR_PRODUCT = 'Ret vare pris';
	...
	var $_PHPSHOP_PRICE_FORM_GROUP = 'Kunde gruppe';
	var $_PHPSHOP_REPORTBASIC_MOD = 'Rapporter';
	var $_PHPSHOP_RB_INDIVIDUAL = 'Vare liste';
	...
	var $_PHPSHOP_RB_THISMONTH_BUTTON = 'Denne månede';
	var $_PHPSHOP_RB_LASTMONTH_BUTTON = 'Forrige månede';
	...
	var $_PHPSHOP_RB_PRODLIST = 'Vare liste';
	...
	var $_PHPSHOP_SHOPPER_LIST_USERNAME = 'Bruger navn';
	var $_PHPSHOP_SHOPPER_LIST_NAME = 'Fulde navn';
	var $_PHPSHOP_SHOPPER_LIST_GROUP = 'Gruppe';
	var $_PHPSHOP_SHOPPER_FORM_MNU = 'Ny kunde';
	var $_PHPSHOP_SHOPPER_FORM_LBL = 'Kunde oplysninger';
	var $_PHPSHOP_SHOPPER_FORM_BILLTO_LBL = 'Faktura oplysninger';
	var $_PHPSHOP_SHOPPER_FORM_ADDRESS_INFO_LBL = 'Information';
	var $_PHPSHOP_SHOPPER_FORM_SHIPTO_LBL = 'Leverings oplysninger';
	...
	var $_PHPSHOP_SHOPPER_FORM_PASSWORD_1 = 'Kodeord';
	var $_PHPSHOP_SHOPPER_FORM_PASSWORD_2 = 'Bekræft kodeord';
	var $_PHPSHOP_SHOPPER_FORM_GROUP = 'Kunde gruppe';
	var $_PHPSHOP_SHOPPER_FORM_COMPANY_NAME = 'Firma navn';
	...
	var $_PHPSHOP_SHOPPER_FORM_PHONE2 = 'Mobil telefon';
	...
	var $_PHPSHOP_SHOPPER_GROUP_LIST_NAME = 'Gruppe navn';
	...
	var $_PHPSHOP_SHOPPER_GROUP_FORM_NAME = 'Gruppe navn';
	var $_PHPSHOP_SHOPPER_GROUP_FORM_DESC = 'Gruppe beskrivelse';
	var $_PHPSHOP_STORE_MOD = 'Butik';
	var $_PHPSHOP_STORE_FORM_MNU = 'Butik opsætning';
	var $_PHPSHOP_STORE_FORM_LBL = 'Butik information';
	var $_PHPSHOP_STORE_FORM_CONTACT_LBL = 'Kontakt oplysninger';
	var $_PHPSHOP_STORE_FORM_FULL_IMAGE = 'Billede';
	var $_PHPSHOP_STORE_FORM_UPLOAD = 'Upload billede';
	var $_PHPSHOP_STORE_FORM_STORE_NAME = 'Butik navn';
	...
	var $_PHPSHOP_STORE_FORM_IMAGE_PATH = 'Billede sti';
	...
	var $_PHPSHOP_PAYMENT_METHOD_LIST_SHOPPER_GROUP = 'Kunde gruppe';
	var $_PHPSHOP_PAYMENT_METHOD_LIST_ENABLE_PROCESSOR = 'Betalings måde type';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_MNU = 'Ny betalings måde';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_LBL = 'Betalings måde opsætning';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_NAME = 'Betalings måde navn';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_SHOPPER_GROUP = 'Kunde gruppe';
	...
	var $_PHPSHOP_PAYMENT_METHOD_FORM_ENABLE_PROCESSOR = 'Betalings måde type';
	var $_PHPSHOP_TAX_MOD = 'Moms';
	var $_PHPSHOP_TAX_RATE = 'Moms satser';
	...
	var $_PHPSHOP_VENDOR_LIST_LBL = 'Leverandør liste';
	var $_PHPSHOP_VENDOR_LIST_VENDOR_NAME = 'Leverandør navn';
	...
	var $_PHPSHOP_VENDOR_FORM_INFO_LBL = 'Leverandør oplysninger';
	var $_PHPSHOP_VENDOR_FORM_CONTACT_LBL = 'Kontakt oplysninger';
	var $_PHPSHOP_VENDOR_FORM_FULL_IMAGE = 'Billede';
	var $_PHPSHOP_VENDOR_FORM_UPLOAD = 'Upload Billede';
	var $_PHPSHOP_VENDOR_FORM_STORE_NAME = 'Leverandørs butiks navn';
	var $_PHPSHOP_VENDOR_FORM_COMPANY_NAME = 'Leverandørs firma navn';
	...
	var $_PHPSHOP_VENDOR_FORM_CATEGORY = 'Leverandør varegruppe';
	...
	var $_PHPSHOP_VENDOR_FORM_IMAGE_PATH = 'Billed sti';
	var $_PHPSHOP_VENDOR_FORM_DESCRIPTION = 'Beskrivelse';
	var $_PHPSHOP_VENDOR_CAT_LIST_MNU = 'Vis leverandør grupper';
	var $_PHPSHOP_VENDOR_CAT_LIST_LBL = 'Leverandør grupper';
	var $_PHPSHOP_VENDOR_CAT_NAME = 'Gruppe navn';
	var $_PHPSHOP_VENDOR_CAT_DESCRIPTION = 'Gruppe beskrivelse';
	var $_PHPSHOP_VENDOR_CAT_VENDORS = 'Leverandører';
	var $_PHPSHOP_VENDOR_CAT_FORM_MNU = 'Ny leverandør gruppe';
	var $_PHPSHOP_VENDOR_CAT_FORM_LBL = 'Leverandør gruppe format';
	var $_PHPSHOP_VENDOR_CAT_FORM_INFO_LBL = 'Gruppe oplysninger';
	var $_PHPSHOP_VENDOR_CAT_FORM_NAME = 'Gruppe navn';
	var $_PHPSHOP_VENDOR_CAT_FORM_DESCRIPTION = 'Gruppe beskrivelse';
	...
	var $_PHPSHOP_MANUFACTURER_LIST_MANUFACTURER_NAME = 'Producent Navn';
	...
	var $_PHPSHOP_MANUFACTURER_FORM_INFO_LBL = 'Producent oplysninger';
	var $_PHPSHOP_MANUFACTURER_FORM_NAME = 'Producent navn';
	var $_PHPSHOP_MANUFACTURER_FORM_CATEGORY = 'Producent gruppe';
	...
	var $_PHPSHOP_MANUFACTURER_CAT_LIST_MNU = 'Vis producent grupper';
	var $_PHPSHOP_MANUFACTURER_CAT_LIST_LBL = 'Producent grupper';
	var $_PHPSHOP_MANUFACTURER_CAT_NAME = 'Gruppe navn';
	var $_PHPSHOP_MANUFACTURER_CAT_DESCRIPTION = 'Gruppe beskrivelse';
	var $_PHPSHOP_MANUFACTURER_CAT_MANUFACTURERS = 'Producenter';
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_MNU = 'Ny producent gruppe';
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_LBL = 'Producent gruppe format';
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_INFO_LBL = 'Gruppe oplysninger';
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_NAME = 'Gruppe navn';
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_DESCRIPTION = 'Gruppe beskrivelse';
	...
	var $_PHPSHOP_CART_SHIPPING = 'Fragt og administrations gebyr';
	var $_PHPSHOP_CART_TOTAL = 'Total';
	var $_PHPSHOP_CHECKOUT_NEXT = 'Næste';
	var $_PHPSHOP_CHECKOUT_REGISTER = 'REGISTRER';
	var $_PHPSHOP_CHECKOUT_CONF_BILLINFO = 'Faktura oplysninger';
	...
	var $_PHPSHOP_CHECKOUT_CONF_SHIPINFO = 'Leverings oplysninger';
	...
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO = 'Betalings oplysninger';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_NAMECARD = 'Navn på kortet';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_METHOD = 'Betalings form';
	...
	var $_PHPSHOP_ZONE_FORM_NAME_LBL = 'Zone Navn';
	var $_PHPSHOP_ZONE_FORM_DESC_LBL = 'Zone Beskrivelse';
	var $_PHPSHOP_ZONE_FORM_COST_PER_LBL = 'Zone pris pr vare';
	var $_PHPSHOP_ZONE_FORM_COST_LIMIT_LBL = 'Zone prisgrænse';
	var $_PHPSHOP_ZONE_LIST_LBL = 'Zone Oplysninger';
	var $_PHPSHOP_ZONE_LIST_NAME_LBL = 'Zone Navn';
	var $_PHPSHOP_ZONE_LIST_DESC_LBL = 'Zone Beskrivelse';
	var $_PHPSHOP_ZONE_LIST_COST_PER_LBL = 'Zone omkostning pr vare';
	var $_PHPSHOP_ZONE_LIST_COST_LIMIT_LBL = 'Zone prisgrænse';
	var $_PHPSHOP_LOGIN_FIRST = 'Du bedes være registreret og logget ind først.<br>Tak.';
	var $_PHPSHOP_STORE_FORM_TOS = 'Handels betingelser';
	...
	var $_PHPSHOP_NEW_CUSTOMER = 'Ny kunde? Angiv venligst faktura oplysninger';
	var $_PHPSHOP_ACC_CUSTOMER_ACCOUNT = 'Kunde konto:';
	var $_PHPSHOP_ACC_ORDER_INFO = 'Ordre oplysninger';
	var $_PHPSHOP_ACC_UPD_BILL = 'Her kan du rette dine faktura oplysninger.';
	var $_PHPSHOP_ACC_UPD_SHIP = 'Her kan du oprette eller vedligeholde leverings oplysninger.';
	var $_PHPSHOP_ACC_ACCOUNT_INFO = 'Konto oplysninger';
	var $_PHPSHOP_ACC_SHIP_INFO = 'Fragt oplysninger';
	var $_PHPSHOP_ACC_NO_ORDERS = 'Ingen ordre at vise';
	var $_PHPSHOP_ACC_BILL_DEF = '- Samme som faktura';
	var $_PHPSHOP_SHIPTO_TEXT = 'Du kan tilføje flere leverings adresser til din konto.';
	var $_PHPSHOP_CONFIG = 'Opsætning';
	var $_PHPSHOP_USERS = 'Kunder';
	var $_PHPSHOP_IS_CC_PAYMENT = 'er kort betaling?';
	var $_PHPSHOP_SHIPPING_MOD = 'Fragt';
	var $_PHPSHOP_SHIPPING_MENU_LABEL = 'Fragt';
	var $_PHPSHOP_CARRIER_LIST_MNU = 'Fragt firma';
	var $_PHPSHOP_CARRIER_LIST_LBL = 'Fragt firmaer';
	var $_PHPSHOP_RATE_LIST_MNU = 'Fragt priser';
	var $_PHPSHOP_RATE_LIST_LBL = 'Fragt priser';
	var $_PHPSHOP_CARRIER_LIST_NAME_LBL = 'Navn';
	var $_PHPSHOP_CARRIER_LIST_ORDER_LBL = 'Rækkefølge';
	var $_PHPSHOP_CARRIER_FORM_MNU = 'Nyt fragt firma';
	var $_PHPSHOP_CARRIER_FORM_LBL = 'Ret / Opret fragt firma';
	var $_PHPSHOP_RATE_FORM_MNU = 'Ny fragt pris';
	var $_PHPSHOP_RATE_FORM_LBL = 'Ret / Opret fragt pris';
	var $_PHPSHOP_RATE_FORM_NAME = 'Fragt pris beskrivelse';
	var $_PHPSHOP_RATE_FORM_CARRIER = 'Fragt firma';
	...
	var $_PHPSHOP_RATE_FORM_VALUE = 'Salgs pris';
	var $_PHPSHOP_RATE_FORM_PACKAGE_FEE = 'Kost pris';
	var $_PHPSHOP_RATE_FORM_CURRENCY = 'Valuta';
	var $_PHPSHOP_RATE_FORM_VAT_ID = 'Moms Id';
	var $_PHPSHOP_RATE_FORM_LIST_ORDER = 'Rækkefølge';
	var $_PHPSHOP_SHIPPING_RATE_LIST_CARRIER_LBL = 'Fragt firma';
	var $_PHPSHOP_SHIPPING_RATE_LIST_RATE_NAME = 'Fragt pris beskrivelse';
	var $_PHPSHOP_SHIPPING_RATE_LIST_RATE_WSTART = 'Vægt fra ...';
	var $_PHPSHOP_SHIPPING_RATE_LIST_RATE_WEND = '... til';
	var $_PHPSHOP_CARRIER_FORM_NAME = 'Fragt firma';
	var $_PHPSHOP_CARRIER_FORM_LIST_ORDER = 'Rækkefølge';
	var $_PHPSHOP_ERR_MSG_CARRIER_EXIST = 'FEJL: Fragt ID findes allerede.';
	var $_PHPSHOP_ERR_MSG_CARRIER_ID_REQ = 'FEJL: Vælg et fragt firma.';
	var $_PHPSHOP_ERR_MSG_CARRIER_INUSE = 'FEJL: Der eksisterer fragt priser. Slet fragt priser først';
	var $_PHPSHOP_ERR_MSG_CARRIER_NOTFOUND = 'FEJL: Kan ikke finde et fragt firma med dette ID.';
	var $_PHPSHOP_ERR_MSG_RATE_CARRIER_ID_REQ = 'FEJL: Vælg et fragt firma.';
	var $_PHPSHOP_ERR_MSG_RATE_CARRIER_ID_INV = 'FEJL: Kan ikke finde et fragt firma med dette ID.';
	var $_PHPSHOP_ERR_MSG_RATE_NAME_REQ = 'FEJL: Der mangler beskrivelse af fragt pris.';
	...
	var $_PHPSHOP_ERR_MSG_RATE_WEIGHT_VALUE_REQ = 'FEJL: Forsendeleses gebyr er påkrævet';
	var $_PHPSHOP_ERR_MSG_RATE_CURRENCY_ID_INV = 'FEJL: Vælg en valuta';
	var $_PHPSHOP_ERR_MSG_RATE_ID_REQ = 'FEJL: Fragt pris er påkrævet';
	var $_PHPSHOP_INFO_MSG_PLEASE_SELECT = 'Vælg venligst';
	var $_PHPSHOP_INFO_MSG_CARRIER = 'Fragt firma';
	var $_PHPSHOP_INFO_MSG_SHIPPING_METHOD = 'Fragt pris';
	var $_PHPSHOP_INFO_MSG_SHIPPING_PRICE = 'Pris';
	var $_PHPSHOP_INFO_MSG_VAT_ZERO_LBL = '0 (-ingen-)';
	var $_PHPSHOP_PAYMENT_FORM_CC = 'Kredit kort';
	var $_PHPSHOP_PAYMENT_FORM_USE_PP = 'Brug betalings system';
	var $_PHPSHOP_PAYMENT_FORM_BANK_DEBIT = 'Bank overførsel';
	var $_PHPSHOP_PAYMENT_FORM_AO = 'Address only / Cash on Delivery';
	var $_PHPSHOP_CHECKOUT_MSG_2 = 'Vælg venligst en leverings adresse!';
	var $_PHPSHOP_CHECKOUT_MSG_3 = 'Vælg venligst en leverings måde!';
	var $_PHPSHOP_CHECKOUT_MSG_4 = 'Vælg venligst en betalings form!';
	var $_PHPSHOP_CHECKOUT_MSG_99 = 'Kontroler venligst din bestilling og bekræft den!';
	var $_PHPSHOP_CHECKOUT_ERR_NO_SHIP = 'Vælg venligst en leverings måde.';
	var $_PHPSHOP_CHECKOUT_ERR_OTHER_SHIP = 'Vælg venligst en anden leverings måde.';
	...
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCDATE = 'Indtastet kreditkort nummer er forkert.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCMON = 'Angiv venligst udløbs månede.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCYEAR = 'Angiv venligst udløbs år.';
	var $_PHPSHOP_CHECKOUT_ERR_CCDATE_INV = 'Udløbs datoen er forkert.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_SHIPTO = 'Vælg venligst en leverings adresse.';
	var $_PHPSHOP_CHECKOUT_ERR_CCNUM_INV = 'Ugyldigt konto nummer.';
	var $_PHPSHOP_CHECKOUT_ERR_EMPTY_CART = 'Din indkøbskurv er tom!';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CARR = 'FEJL: Vælg venligst et fragt firma!';
	var $_PHPSHOP_CHECKOUT_ERR_RATE_NOT_FOUND = 'FEJL: Den valgte fragt pris blev ikke fundet i systemet!';
	var $_PHPSHOP_CHECKOUT_ERR_SHIPTO_NOT_FOUND = 'Fejl: Din leveringsadresse kunne ikke findes!';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCDATA = 'FEJL: Der findes ikke noget kreditkort data...';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCNR_FOUND = 'FEJL: Kreditkort nummer findes ikke!';
	...
	var $_PHPSHOP_CHECKOUT_ERR_NO_BA_HOLDER_NAME = 'Du mangler at angive navn på bank konto indehaver.';
	...
	var $_PHPSHOP_CHECKOUT_ERR_NO_VALID_STEP = 'Ordre afgivelse er ikke komplet!';
	var $_PHPSHOP_CHECKOUT_MSG_LOG = 'Betalings information er gemt til senere brug.<br />';
	var $_PHPSHOP_CHECKOUT_ERR_MIN_POV = 'Vores grænse for mindste køb er endu ikke nået..';
	var $_PHPSHOP_CHECKOUT_ERR_MIN_POV2 = 'Vi har en mindste købs grænse på:';
	var $_PHPSHOP_CHECKOUT_PAYMENT_CC = 'Kreditkort betaling';
	var $_PHPSHOP_CHECKOUT_PAYMENT_OTHER = 'andre betalings måder';
	var $_PHPSHOP_CHECKOUT_PAYMENT_SELECT = 'Vælg venligst en betalings måde:';
	var $_PHPSHOP_STORE_FORM_MPOV = 'Mindste købs grænse';
	var $_PHPSHOP_ACCOUNT_BANK_TITLE = 'Bank oplysninger';
	...
	var $_PHPSHOP_ACCOUNT_LBL_BANK_ACCOUNT_HOLDER = 'Konto indehaver';
	var $_PHPSHOP_MODULES = 'Moduler';
	var $_PHPSHOP_FUNCTIONS = 'Funktioner';
	var $_PHPSHOP_SPECIAL_PRODUCTS = 'Udsalgs varer';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_NOTE = 'Eventuelle kommentarer i forbindelse med ordreafgivelse';
	var $_PHPSHOP_ORDER_PRINT_CUSTOMER_NOTE = 'Kunde kommentar';
	...
	var $_PHPSHOP_DOWNLOADS_ERR_EXP = 'Beklager, men din download mulighed er forældet';
	var $_PHPSHOP_DOWNLOADS_ERR_MAX = 'Beklager, men din grænse for antal download er nået.';
	...
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_3 = 'maksimum antal download per fil er: ';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_4 = 'Kan donwloades indtil {expire} dage efter den første download er fuldført';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_5 = 'Spørgsmål eller problemer?';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_6 = 'Download-Info for ';
	var $_PHPSHOP_PRODUCT_FORM_DOWNLOADABLE = 'download bar vare?';
	var $_PHPSHOP_PAYPAL_THANKYOU = 'Tak for din betaling.
        ...
        Du kan nu fortsætte eller logg på <a href=http://www.paypal.com>www.paypal.com</a> for at se betalings detaljer.';
	var $_PHPSHOP_PAYPAL_ERROR = 'Der skete en fejl i forsøget på at gennemføre betalingen.Ordren er endnu ikke betalt.';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER1 = 'Tak fordi du valgte at hanlde hos os. Information om ordren følger.';
	...
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER5 = 'Se ordren på nedenstående link.';
	...
	var $_PHPSHOP_AFFILIATE_MOD = 'Selskabs administration';
	var $_PHPSHOP_AFFILIATE_LIST_MNU = 'Vis selskaber';
	var $_PHPSHOP_AFFILIATE_LIST_LBL = 'Selskaber';
	var $_PHPSHOP_AFFILIATE_LIST_AFFILIATE_NAME = 'Selskabs navn';
	...
	var $_PHPSHOP_AFFILIATE_LIST_MONTH_COMMISSION = 'Måneds provision';
	...
	var $_PHPSHOP_AFFILIATE_FORM_RATE = 'Provisions sats (percent)';
	var $_PHPSHOP_AFFILIATE_FORM_ACTIVE = 'Aktiv?';
	var $_PHPSHOP_DELIVERY_TIME = 'Forventet leveringstid';
	var $_PHPSHOP_DELIVERY_INFORMATION = 'Leverings oplysninger';
	...
	var $_PHPSHOP_ADMIN_CFG_FILE_STATUS = ' Konfigurations fil status:';
	...
	var $_PHPSHOP_ADMIN_CFG_TAX_MODE = 'Moms system:';
	var $_PHPSHOP_ADMIN_CFG_TAX_MODE_SHIP = 'Styret af leverings adresse';
	var $_PHPSHOP_ADMIN_CFG_TAX_MODE_VENDOR = 'Styret af afsender adresse';
	var $_PHPSHOP_ADMIN_CFG_TAX_MODE_EXPLAIN = 'Dette styrer hvilken moms sats der skal anvendes./>
												...
												<li>or "EU mode", hvor en pr-produkt momssats bruges hvis den handlende er i den Europæiske Union, ellers bliver momssatsen basseret på den handlendes adresse.</li></ul>';
	var $_PHPSHOP_ADMIN_CFG_MULTI_TAX_RATE = 'Aktiver differentieret moms?';
	var $_PHPSHOP_ADMIN_CFG_MULTI_TAX_RATE_EXPLAIN = 'Angives hvis du har forskellig moms på dine varer (feks aviser og frimærker der er momsfritaget eller ligende)';
	var $_PHPSHOP_ADMIN_CFG_SUBSTRACT_PAYEMENT_BEFORE = 'Fratræk kontant rabat, før moms/fragt beregning';
	var $_PHPSHOP_ADMIN_CFG_REVIEW = 'Kunde anmeldelser';
	...
	var $_PHPSHOP_ADMIN_CFG_SUBSTRACT_PAYEMENT_BEFORE_EXPLAIN = 'Hvis angivet fratrækkes kontant rabbat før moms og fragt.';
	var $_PHPSHOP_ADMIN_CFG_ACCOUNT_CAN_BE_BLANK = 'Kunde bank oplysninger?';
	...
	var $_PHPSHOP_ADMIN_CFG_CHECK_STOCK_EXPLAIN = 'Vælges hvis varebeholdning skal tjekkes når en kunde ligger en vare i indkøbsvognen.<br/>Købet kan kun gennemføres hvis varen er på lager.
                                                                                          Hvis valgt, vil det ikke tillade brugeren at tilføje flere ting til kurven end der er tilgængelige på lageret.';
	var $_PHPSHOP_ADMIN_CFG_ENABLE_AFFILIATE = 'Partner program?';
	...
	var $_PHPSHOP_ADMIN_CFG_URLIMAGE_EXPLAIN = 'URL til VirtueMart komponentens billede mappe.(skal slutte med en skråstreg!)';
	...
	var $_PHPSHOP_ADMIN_CFG_PAGEPATH_EXPLAIN = 'Stien til virtuemarts htmo mappe.';
	...
	var $_PHPSHOP_ADMIN_CFG_FLYPAGE_EXPLAIN = 'Dette er standard siden for visning af vare detaljer.';
	var $_PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE = 'Varegruppe skabelon';
	var $_PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE_EXPLAIN = 'Standard varegruppe skabelon, for visning af varer til en varegruppe.<br />
	...
	var $_PHPSHOP_ADMIN_CFG_MAXIMUMROWS_EXPLAIN = 'Angiver antal rækker der vises i ordre listen.';
	...
	var $_PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_STANDARD = 'Standard fragt modul med egen opsatte fragtfirmaer og fragt priser. <strong>ANBEFALES !</strong>';
	...
	var $_PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS_STANDARD = '<strong>Standard :</strong><br/>
               1. Leverings adresse forespørgsel<br />
              2. Leverings måde forespørgsel<br />
              3. Betalings form forespørgsel<br />
              4. Afgiv Ordre';
	var $_PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS_2 = '<strong>Rutine 2:</strong><br/>
               1. Leverings adresse forespørgsel<br />
              2. Betalings form forespørgsel<br />
              3. Afgiv Ordre';
	var $_PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS_3 = '<strong>Rutine 3:</strong><br/>
               1. Leverings måde forespørgsel<br />
              2. Betalings form forespørgsel<br />
              3. Afgiv Ordre';
	var $_PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS_4 = '<strong>Rutine 4:</strong><br/>
               1. Betalings form forespørgsel<br />
              2. Afgiv ordre';
	var $_PHPSHOP_ADMIN_CFG_ENABLE_DOWNLOADS = 'Download varer';
  ...
  Perioden starter når første vare downloades! Når tidsgrænsen er overskredet, deaktiveres download-IDen.<br />Bemærk : 86400s=24h.';
	...
	var $_PHPSHOP_ADMIN_CFG_PAYPAL_EMAIL_EXPLAIN = 'Email adresse der anvendes hos Paypal til at modtage betaling.';
	var $_PHPSHOP_ADMIN_CFG_PAYPAL_STATUS_SUCCESS = 'Ordre status ved gennemført betaling';
  ...
  vælg samme status der også aktivere download. (dermed bliver kunden informeret om køb via email).';
	var $_PHPSHOP_ADMIN_CFG_PAYPAL_STATUS_FAILED = 'Ordre status ved fejlende betaling';
	...
	var $_PHPSHOP_ADMIN_CFG_ENABLE_AUTORIZENET_TESTMODE = 'Test tilstand ?';
	...
	var $_PHPSHOP_SEARCH_ALL_PRODINFO = 'Search alle varer';
	var $_PHPSHOP_SEARCH_PRODNAME = 'Søg kun på varenavn';
	var $_PHPSHOP_SEARCH_MANU_VENDOR = 'kun på Producent/Leverandøry';
	var $_PHPSHOP_SEARCH_DESCRIPTION = 'Kun på vare beskrivelse';
	var $_PHPSHOP_SEARCH_AND = 'og';
	var $_PHPSHOP_SEARCH_NOT = 'ikke';
	var $_PHPSHOP_SEARCH_TEXT1 = 'I det første felt angives et varegruppe kriterie der skal indgå i søgningen.
        Det andet felt bruges til at angive en vare oplysnings kriterie (f.eks. Navn).
        Efter angivelse af søge kriterier, angiv da ordet der skal søges på. ';
	...
	var $_PHPSHOP_REVIEWS = 'Kunde anmeldelse';
	...
	var $_PHPSHOP_CREDITCARD_FORM_LBL = 'Ny/Ret Kreditkort type';
	var $_PHPSHOP_CREDITCARD_NAME = 'Kreditkort navn';
	var $_PHPSHOP_CREDITCARD_CODE = 'Kreditkort - Type nummer';
	var $_PHPSHOP_CREDITCARD_TYPE = 'Kreditkort type';
	...
	var $_PHPSHOP_ORDER_LINK = 'Klik her for at se ordre oplysninger.';
	...
	var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_3 = 'For at se ordre oplysninger, klik venligst dette link (eller kopier det til browserens adresse linie):';
	var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_SUBJ = 'Ny ordre status: Din ordre {order_id}';
	var $_PHPSHOP_ORDER_LIST_NOTIFY = 'Besked til kunden?';
	var $_PHPSHOP_ORDER_LIST_NOTIFY_ERR = 'Ordre status skal ændres først!';
	...
	var $_PHPSHOP_PRODUCT_DISCOUNT_LBL = 'Vare rabat';
	var $_PHPSHOP_PRODUCT_DISCOUNT_LIST_LBL = 'Vare rabatter';
	var $_PHPSHOP_PRODUCT_DISCOUNT_ADDEDIT = 'Ny/ret vare rabat';
	...
	var $_PHPSHOP_PRODUCT_DISCOUNT_STARTDATE = 'Start dato';
	var $_PHPSHOP_PRODUCT_DISCOUNT_STARTDATE_TIP = 'Angiver hvornår rabatten starter';
	var $_PHPSHOP_PRODUCT_DISCOUNT_ENDDATE = 'Slut dato';
	...
	var $_PHPSHOP_CURRENCY_THOUSANDS = 'Tusind tals separator';
	var $_PHPSHOP_CURRENCY_THOUSANDS_TOOLTIP = 'Tegn der brugs som tusind tals separator (kan udelades)';
	...
	var $_PHPSHOP_FILEMANAGER_ADD = 'Ny billede fil';
	...
	var $_PHPSHOP_FILES_LIST = 'Fil Manager::Billed filer for';
	var $_PHPSHOP_FILES_LIST_FILENAME = 'Fil navn';
	...
	var $_PHPSHOP_FILES_LIST_THUMBNAIL_IMG = 'Miniature billede';
	...
	var $_PHPSHOP_FILES_FORM_UPLOAD_IMAGEPATH = 'standard sti for vare billeder';
	var $_PHPSHOP_FILES_FORM_UPLOAD_OWNPATH = 'Angiv filens placering';
	var $_PHPSHOP_FILES_FORM_UPLOAD_DOWNLOADPATH = 'Download sti (for varer der kan downloades!)';
	var $_PHPSHOP_FILES_FORM_AUTO_THUMBNAIL = 'Opret automatisk et miniature billede?';
	var $_PHPSHOP_FILES_FORM_FILE_PUBLISHED = 'Filen er udgivet?';
	var $_PHPSHOP_FILES_FORM_FILE_TITLE = 'Salgs fil navn (hvad kunden ser)';
	...
	var $_PHPSHOP_FILES_IMAGE_RESIZE_SUCCESS = 'Miniature billede er oprettet!';
	var $_PHPSHOP_FILES_IMAGE_RESIZE_FAILURE = 'Kunne ikke oprette miniature billede!';
	var $_PHPSHOP_FILES_UPLOAD_FAILURE = 'Fil/Billede Upload Fejl';
	var $_PHPSHOP_FILES_FULLIMG_DELETE_FAILURE = 'Kunne ikke slette billede filen';
	var $_PHPSHOP_FILES_FULLIMG_DELETE_SUCCESS = 'Stort billede er slettet.';
	var $_PHPSHOP_FILES_THUMBIMG_DELETE_FAILURE = 'Kunne ikke slette miniature billedet (kunne måske ikke findes): ';
	var $_PHPSHOP_FILES_THUMBIMG_DELETE_SUCCESS = 'Miniature billede er slettet.';
	var $_PHPSHOP_FILES_FILE_DELETE_FAILURE = 'Kunne ikke slette filen.';
	var $_PHPSHOP_FILES_FILE_DELETE_SUCCESS = 'Filen er slettet.';
	var $_PHPSHOP_FILES_NOT_FOUND = 'Den angivede fil kan ikke findes!';
	var $_PHPSHOP_IMAGE_NOT_FOUND = 'Billede ikke fundet!';
	var $_PHPSHOP_COUPON_MOD = 'Rabat kupon';
	var $_PHPSHOP_COUPONS = 'Rabat kuponner';
	var $_PHPSHOP_COUPON_LIST = 'Rabat kuponner';
	var $_PHPSHOP_COUPON_ALREADY_REDEEMED = 'Kuponnen er allerede indløst.';
	var $_PHPSHOP_COUPON_REDEEMED = 'Kuponnen er indløst! Mange tak.';
	var $_PHPSHOP_COUPON_ENTER_HERE = 'Er du i besidelse af en rabat kupon, angiv den venligst nedenfor:';
	var $_PHPSHOP_COUPON_SUBMIT_BUTTON = 'Udfør';
	var $_PHPSHOP_COUPON_CODE_EXISTS = 'Rabat kuponnen eksisterer. Prøv venligst igen.';
	var $_PHPSHOP_COUPON_EDIT_HEADER = 'Ret rabat kupon';
	var $_PHPSHOP_COUPON_EDIT_HELP_TEXT = 'Klik på en rabat kupon for at ændre den. For at slette en rabat kupon, marker den og klik på slet:';
	var $_PHPSHOP_COUPON_CODE_HEADER = 'Kode';
	var $_PHPSHOP_COUPON_PERCENT_TOTAL = 'Procent eller fast værdi';
	var $_PHPSHOP_COUPON_TYPE = 'Rabat kupon type';
	var $_PHPSHOP_COUPON_TYPE_TOOLTIP = 'Engangs rabat kuponner slettes efter de er indløst. En permanent rabat kupon forbliver aktiv.';
	...
	var $_PHPSHOP_COUPON_CONFIRM_DELETE = 'Er du sikker på at du vil slette rabat kuponnen?';
	var $_PHPSHOP_COUPON_COMPLETE_ALL_FIELDS = 'Udfyld venligst alle felter.';
	var $_PHPSHOP_COUPON_VALUE_NOT_NUMBER = 'Kupon værdi skal være et tal.';
	var $_PHPSHOP_COUPON_NEW_HEADER = 'Ny kupon';
	var $_PHPSHOP_COUPON_COUPON_HEADER = 'Kupon kode';
	var $_PHPSHOP_COUPON_PERCENT = 'Procent';
	var $_PHPSHOP_COUPON_TOTAL = 'Fast';
	var $_PHPSHOP_COUPON_VALUE = 'Værdi';
	var $_PHPSHOP_COUPON_CODE_SAVED = 'Rabat kupon er gemt.';
	var $_PHPSHOP_COUPON_SAVE_BUTTON = 'Gem kupon';
	var $_PHPSHOP_COUPON_DISCOUNT = 'Rabat kuponnert';
	var $_PHPSHOP_COUPON_CODE_INVALID = 'Rabat kupon kode kunne ikke findes, prøv venligst igen.';
	var $_PHPSHOP_COUPONS_ENABLE = 'Rabat kuponner';
	var $_PHPSHOP_COUPONS_ENABLE_EXPLAIN = 'Hvis angivet kan en kunde opnå en rabat ved at angive et rabat kupon nummer.';
	...
	var $_PHPSHOP_FREE_SHIPPING_AMOUNT = 'Købs grænse for gratis levering';
	var $_PHPSHOP_FREE_SHIPPING_AMOUNT_TOOLTIP = 'Købs beløb (MED MOMS!) der skal købes for, før det udløser gratis levering
	...
	var $_PHPSHOP_ACCOUNT_LBL_ACCOUNT_TYPE = 'Bank konto type';
	...
	var $_PHPSHOP_PAYMENT_ERROR = 'Fejl ved betalings håndtering';
	...
	var $_PHPSHOP_UPS_HANDLING_FEE = 'Fragt gebyr';
	var $_PHPSHOP_UPS_HANDLING_FEE_TOOLTIP = 'Dit administrations gebyr for denne forsendelses måde.';
	var $_PHPSHOP_UPS_TAX_CLASS = 'Moms gruppe';
	var $_PHPSHOP_UPS_TAX_CLASS_TOOLTIP = 'Anvend denne moms regel for fragt gebyret.';
	var $_PHPSHOP_ERROR_CODE = 'Fejl kode';
	var $_PHPSHOP_ERROR_DESC = 'Fejl beskrivelse';
	var $_PHPSHOP_CHANGE_TRANSACTION_KEY = 'Vis / Skift transaktions nøgle';
	var $_PHPSHOP_CHANGE_PASSKEY_FORM = 'Vis / Skift kodeord/Transaktions nøgle';
	var $_PHPSHOP_TYPE_PASSWORD = 'Angiv venligst din adgangskode';
	var $_PHPSHOP_CURRENT_PASSWORD = 'Gældende kodeord';
	var $_PHPSHOP_CURRENT_TRANSACTION_KEY = 'Gældende transaktions nøgle';
	var $_PHPSHOP_CHANGE_PASSKEY_SUCCESS = 'Transaktions nøglen er ændret.';
	var $_PHPSHOP_PAYMENT_CVV2 = 'Anmod kort kontrol kode (CVV2/CVC2/CID)';
	var $_PHPSHOP_PAYMENT_CVV2_TOOLTIP = 'Kontroller kort kontrol kode CVV2/CVC2/CID value (three- or four-digit number on the back of a credit card, on the Front of American Express Cards)?';
	var $_PHPSHOP_CUSTOMER_CVV2_TOOLTIP = 'Angiv venligst den 3 ciffrede kontrol kode';
	...
	var $_PHPSHOP_PRODUCT_FORM_UPLOAD_TOOLTIP = 'Du kan uploade en fil. Det er selven varen som skal sælges. En eksisterende fil vil blive overskrevet.';
	var $_PHPSHOP_PRODUCT_FORM_AVAILABILITY_TOOLTIP1 = 'Angiv en tekst som vises under vare detaljer.<br />f.eks.: 24h, 48 timer, 3 - 5 dage, På vej.....';
	var $_PHPSHOP_PRODUCT_FORM_AVAILABILITY_TOOLTIP2 = 'Eller vælge et billede der skal vises under vare detaljer.<br />Billeder findes på sti <i>/components/com_virtuemart/shop_image/availability</i><br />';
	...
	var $_PHPSHOP_PRODUCT_FORM_CUSTOM_ATTRIBUTE_LIST = 'Specifik variant liste';
	...
	var $_PHPSHOP_ADMIN_CFG_ENABLE_EPN_TESTMODE = 'Test tilstand ?';
	...
	var $_PHPSHOP_RELATED_PRODUCTS_TIP = 'Du kan opsætte varer der relaterer sig til denne. Væg en eller flere varer.';
	var $_PHPSHOP_RELATED_PRODUCTS_HEADING = 'Se også disse passende varer';
	var $_PHPSHOP_IMAGE_ACTION = 'Billede handling';
	var $_PHPSHOP_NONE = 'ingen';
	var $_PHPSHOP_ORDER_HISTORY = 'Ordre historik';
	...
	var $_PHPSHOP_ORDER_STATUS_CHANGE = 'Ny ordre status';
	...
	var $_PHPSHOP_PRODUCT_TYPE_LBL = 'Vare type';
	var $_PHPSHOP_PRODUCT_TYPE_LIST_LBL = 'Vare typer';
	var $_PHPSHOP_PRODUCT_TYPE_ADDEDIT = 'Ny/Ret vare type';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_LIST_LBL = 'Vare typer for';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_LIST_MNU = 'Vis vare typer';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_FORM_LBL = 'Ny vare type for';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_FORM_MNU = 'Ny vare type';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_FORM_PRODUCT_TYPE = 'Vare type';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_NAME = 'Vare type Navn';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_DESCRIPTION = 'Vare type beskrivelse';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_PARAMETERS = 'Specifikationer';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_LBL = 'Vare type oplysninger';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_PUBLISH = 'Udgiv?';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_BROWSEPAGE = 'Vare type Vis side';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_FLYPAGE = 'Vare type kort';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_LIST_LBL = 'Specifikationer for vare typer';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_LBL = 'Specifikations oplysninger';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_NOT_FOUND = 'Vare type findes ikke!';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_NAME = 'Specifikations Navn';
	...
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_LABEL = 'Specifikations Felttekst';
	...
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_DEFAULT_HELP_TEXT = 'For standard værdi brug dette format:<ul><li>Date: YYYY-MM-DD</li><li>Time: HH:MM:SS</li><li>Date & Time: YYYY-MM-DD HH:MM:SS</li></ul>';
	...
	var $_PHPSHOP_PARAMETER_SEARCH_IS_LIKE = 'Er lige med';
	var $_PHPSHOP_PARAMETER_SEARCH_IS_NOT_LIKE = 'Er forskellig fra';
	var $_PHPSHOP_PARAMETER_SEARCH_FULLTEXT = 'Full-Tekst Søgning';
	...
	var $_PHPSHOP_CSV_ENCLOSURE = 'Tekst skille tegn';
	...
	var $_PHPSHOP_PRODUCT_PACKAGING2 = 'Antal {unit} pr kasse:';
	var $_PHPSHOP_HIDE_OUT_OF_STOCK = 'Skjul udsolgte varer';
	var $_PHPSHOP_FEATURED_PRODUCTS_LIST_LBL = 'Udsalgs og tilbuds varer';
	var $_PHPSHOP_FEATURED = 'Udsalg';
	var $_PHPSHOP_BACK_TO_COUNTRY = 'Tilbage til land';
	var $_PHPSHOP_BACK_TO_FILEMANAGER = 'Tilbage til fil manager';
	...
	var $_PHPSHOP_SHOW_FEATURED = 'Udsalgs varer';
	...
	var $_PHPSHOP_PRODUCT_FORM_DISCOUNTED_PRICE = 'Rabat pris';
	var $_PHPSHOP_PRODUCT_FORM_DISCOUNTED_PRICE_TIP = 'Her kan du overstyre rabat opsætningen, angiv en speciel rabat for denne vare.<br/>
Systemet vil lave en ny post udfra rabat prisen.';
	...
	var $_PHPSHOP_ADMIN_CFG_NAV_AT_TOP = 'Vis vare sti?';
	...
	var $_PHPSHOP_ADMIN_CFG_DYNAMIC_THUMBNAIL_RESIZING = 'Automatisk billede skalering?';
	var $_PHPSHOP_ADMIN_CFG_DYNAMIC_THUMBNAIL_RESIZING_TIP = 'Hvis angivet, vil vare billeder automatisk blive skaleret ned til et lille vare billede med den størelse du angiver nedenfor.
        ...
        Det ny skalerede billede bliver gemt på serveren under /shop_image/prduct/resized. Virtumart vil altid kontrollere om der findes et skaleret billede her, før en eventuel gen-skalering.';
	var $_PHPSHOP_ADMIN_CFG_THUMBNAIL_WIDTH = 'Miniature billede brede';
	var $_PHPSHOP_ADMIN_CFG_THUMBNAIL_WIDTH_TIP = 'Den ønskede <strong>brede</strong> i pixels af det skallerede billede.';
	var $_PHPSHOP_ADMIN_CFG_THUMBNAIL_HEIGHT = 'Miniature billede højde';
	var $_PHPSHOP_ADMIN_CFG_THUMBNAIL_HEIGHT_TIP = 'Den ønskede <strong>højde</strong> i pixels af det skallerede billede.';
	var $_PHPSHOP_ADMIN_CFG_SHIPPING_NO_SELECTION = 'Angiv venligst mindst en leverings måde i Fragt opsætningen!';
	var $_PHPSHOP_ADMIN_CFG_PRICE_CONFIGURATION = 'Pris konfiguration';
	var $_PHPSHOP_ADMIN_CFG_PRICE_ACCESS_LEVEL = 'Bruger gruppe der må se priser';
	var $_PHPSHOP_ADMIN_CFG_PRICE_ACCESS_LEVEL_TIP = 'Den valgte brugergruppe og følgende brugergrupper med højere rettigheder vil kunne se vare priser.';
	var $_PHPSHOP_ADMIN_CFG_PRICE_SHOW_INCLUDINGTAX = 'Vis "(inkl. XX% moms)" ved nettopriser?';
	var $_PHPSHOP_ADMIN_CFG_PRICE_SHOW_INCLUDINGTAX_TIP = 'Hvis markret vil kunden se teksten "(inkl. xx% moms)" når priser vises inkl. moms.';
	var $_PHPSHOP_ADMIN_CFG_PRICE_SHOW_PACKAGING_PRICELABEL = 'Vis mængde pris?';
	var $_PHPSHOP_ADMIN_CFG_PRICE_SHOW_PACKAGING_PRICELABEL_TIP = 'Hvis angivet vises prisen i henhold til varens enhed og pakke størelse<br/>
...
Ellers vises prisen normalt: <strong>Pris: xx.xx</strong>';
	...
	var $_PHPSHOP_ADMIN_CFG_CORE_SETTINGS = 'Grund indstillinger';
	var $_PHPSHOP_ADMIN_CFG_FRONTEND_FEATURES = 'Netbutikken';
	var $_PHPSHOP_ADMIN_CFG_TAX_CONFIGURATION = 'Moms opsætning';
	var $_PHPSHOP_PRODUCT_LIST_QUANTITY_START = 'Antal start';
	var $_PHPSHOP_PRODUCT_LIST_QUANTITY_END = 'Antal slut';
	var $_PHPSHOP_ADMIN_CFG_USER_REGISTRATION_SETTINGS = 'Bruger registrering';
	var $_PHPSHOP_ADMIN_CFG_ALLOW_REGISTRATION = 'Bruger registrering tilladt?';
	var $_PHPSHOP_ADMIN_CFG_ACCOUNT_ACTIVATION = 'Ny bruger skal aktiveres?';
	var $_PHPSHOP_ADMIN_CFG_SILENT_REGISTRATION = 'Brug skjult bruger registrering?';
	var $_PHPSHOP_ADMIN_CFG_SILENT_REGISTRATION_TIP = 'Hvis angivet kræves kunden ikke et brugernavn og kodeord ved ny bruger registrering. I stedet anvendes angivet email adresse som brugernavn og et tilfældigt kodeord genereres. Oplysningerne sendes til kunden via email.';
	var $_PHPSHOP_USER_SEND_REGISTRATION_DETAILS = 'Kære %s,
Vi takker for din registrering hos %s. Din kunde konto er nu oprettet.
...
';
	...
	var $_PHPSHOP_ADMIN_CFG_ENABLE_PFP = 'Aktiver PayFlow Pro betalings måde?';
