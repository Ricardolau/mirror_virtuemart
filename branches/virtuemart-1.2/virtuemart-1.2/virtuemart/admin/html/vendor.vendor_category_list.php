...
/**
*
* @version $Id: vendor.vendor_category_list.php 1760 2009-05-03 22:58:57Z Aravot $
* @package VirtueMart
* @subpackage html
...
$listObj->writeSearchHeader($VM_LANG->_('VM_VENDOR_CAT_LIST_LBL'), "", $modulename, "vendor_category_list");
...
$columns = Array(  "#" => "width=\"20\"", 
					...
					$VM_LANG->_('VM_VENDOR_CAT_NAME') => 'width="21%"',
					$VM_LANG->_('VM_VENDOR_CAT_DESCRIPTION') => 'width="66%"',
					$VM_LANG->_('VM_VENDOR_CAT_VENDORS') => 'width="13%"',
...
while ($db->next_record()) { 
	...
	$tmp_cell = "<a href=\"" . $sess->url($url) . "\">".$VM_LANG->_('VM_LIST')."</a>";
	$listObj->addCell( $tmp_cell );
