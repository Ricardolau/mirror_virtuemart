...
if (empty($product_parent_id)) {
  $title = $VM_LANG->_('VM_PRODUCT_LBL');
} else {
  $title = $VM_LANG->_('VM_PRODUCT_FORM_ITEM_LBL');
}
$title .=  "<br/>". $VM_LANG->_('VM_PRICE_LIST_FOR_LBL')."&nbsp;&nbsp;";
...
$columns = Array(  "#" => "width=\"20\"", 
					...
					$VM_LANG->_('VM_PRICE_LIST_GROUP_NAME') => '',
					$VM_LANG->_('VM_PRICE_LIST_PRICE') => '',
					$VM_LANG->_('VM_PRODUCT_LIST_CURRENCY') => '',
					$VM_LANG->_('VM_PRODUCT_LIST_QUANTITY_START') => 'width="50"',
					$VM_LANG->_('VM_PRODUCT_LIST_QUANTITY_END') => 'width="50"',
