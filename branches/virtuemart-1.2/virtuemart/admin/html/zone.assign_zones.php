...
$listObj->writeSearchHeader($VM_LANG->_('VM_ASSIGN_ZONE_PG_LBL'), '', $modulename, "assign_zones");
...
$columns = Array(  "#" => "width=\"20\"", 
					$VM_LANG->_('VM_ZONE_ASSIGN_COUNTRY_LBL') => '',
					$VM_LANG->_('VM_ZONE_ASSIGN_CURRENT_LBL') => '',
					$VM_LANG->_('VM_ZONE_ASSIGN_ASSIGN_LBL') => ''
				);
