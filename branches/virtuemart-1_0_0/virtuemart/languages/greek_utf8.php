...
class vmLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_SELECT_CATEGORY = 'Επιλέξτε Κατηγορία:';
	var $_PHPSHOP_ADMIN = 'Διαχείρηση';
	var $_PHPSHOP_PRODUCT = 'Προιόν';
	var $_PHPSHOP_LIST = 'Λίστα';
	var $_PHPSHOP_ALL = 'Ολα';
	var $_PHPSHOP_LIST_ALL_PRODUCTS = 'Λίστα όλων των Προιόντων';
	var $_PHPSHOP_VIEW = 'Εμφάνιση';
	...
	var $_PHPSHOP_SUBMIT = 'Υποβολή';
	var $_PHPSHOP_RANDOM = 'Τυχαία Προιόντα';
	var $_PHPSHOP_LATEST = 'Τελευταία Προιόντα';
	var $_PHPSHOP_HOME_TITLE = 'Αρχή';
	var $_PHPSHOP_CART_TITLE = 'Καλάθι';
	var $_PHPSHOP_CHECKOUT_TITLE = 'Εξοδος';
	var $_PHPSHOP_LOGIN_TITLE = 'Εισαγωγή';
	var $_PHPSHOP_LOGOUT_TITLE = 'Αποσύνδεση';
	var $_PHPSHOP_BROWSE_TITLE = 'Εμφάνιση';
	var $_PHPSHOP_SEARCH_TITLE = 'Αναζήτηση';
	var $_PHPSHOP_ACCOUNT_TITLE = 'Διαχείρηση Λογαριασμού';
	var $_PHPSHOP_NAVIGATION_TITLE = 'Καθοδήγηση';
	var $_PHPSHOP_DEPARTMENT_TITLE = 'Τμήμα';
	var $_PHPSHOP_INFO = 'Πληροφορίες';
	var $_PHPSHOP_BROWSE_LBL = 'Εμφάνιση';
	var $_PHPSHOP_PRODUCTS_LBL = 'Προιόντα';
	var $_PHPSHOP_PRODUCT_LBL = 'Προιόν';
	var $_PHPSHOP_SEARCH_LBL = 'Αναζήτηση';
	var $_PHPSHOP_FLYPAGE_LBL = 'Αναλυτικά Προιόντος';
	var $_PHPSHOP_PRODUCT_SEARCH_LBL = 'Αναζήτηση Προιόντος';
	var $_PHPSHOP_PRODUCT_NAME_TITLE = 'Ονομα Προιόντος';
	var $_PHPSHOP_PRODUCT_CATEGORY_TITLE = 'Κατηγορία Προιόντος';
	var $_PHPSHOP_PRODUCT_DESC_TITLE = 'Περιγραφή';
	var $_PHPSHOP_CART_SHOW = 'Καλάθι Αγορών';
	var $_PHPSHOP_CART_ADD_TO = 'Προσθήκη';
	var $_PHPSHOP_CART_NAME = 'Ονομα';
	var $_PHPSHOP_CART_SKU = 'Κωδικός Προιόντος';
	...
	var $_PHPSHOP_NO_SEARCH_RESULT = 'Η αναζήτησή σας επέστρεψε 0 αποτελέσματα.<br />';
	var $_PHPSHOP_PRICE_LABEL = 'Τιμή: ';
	var $_PHPSHOP_ORDER_BUTTON_LABEL = 'Προσθήκη';
	var $_PHPSHOP_NO_CUSTOMER = 'Δεν είστε εγγεγραμμένος πελάτης ακόμα. Συμπληρώστε τα στοιχεία τιμολόγησης.';
	var $_PHPSHOP_DELETE_MSG = 'Είστε σίγουρος οτι θέλετε να γίνει η διαγραφή?';
	var $_PHPSHOP_THANKYOU = 'Ευχαριστούμε για την Παραγγελία σας.';
	var $_PHPSHOP_NOT_SHIPPED = 'Δεν έχει αποσταλλεί ακόμα';
	var $_PHPSHOP_EMAIL_SENDTO = 'Ενα email επιβεβαίωσης έχει αποσταλλεί στο';
	var $_PHPSHOP_NO_USER_TO_SELECT = 'Sorry, there\'s no user that you could add to the com_virtuemart userlist';
	var $_PHPSHOP_ERROR = 'ΛΑΘΟΣ';
	var $_PHPSHOP_MOD_NOT_REG = 'Το Module Δεν έχει εγκατασταθεί.';
	var $_PHPSHOP_MOD_ISNO_REG = 'δεν είναι έγκυρο VirtueMart module.';
	var $_PHPSHOP_MOD_NO_AUTH = 'Δεν έχετε εξουσιοδότηση πρόσβασης για το module.';
	var $_PHPSHOP_PAGE_404_1 = 'Δεν υπάρχει η σελίδα';
	var $_PHPSHOP_PAGE_404_2 = 'Ονομα αρχείου δεν υπάρχει:';
	var $_PHPSHOP_PAGE_403 = 'Ανεπαρκής εξουσιοδότηση πρόσβασης';
	var $_PHPSHOP_FUNC_NO_EXEC = 'Δεν έχετε εξουσιοδότηση για εκτέλεση';
	var $_PHPSHOP_FUNC_NOT_REG = 'Το Function δεν έχει καταχωρηθεί';
	var $_PHPSHOP_FUNC_ISNO_REG = ' δεν είναι έγκυρο MOS_com_phpShop function.';
	var $_PHPSHOP_ADMIN_MOD = 'Διαχειριστής';
	var $_PHPSHOP_USER_LIST_MNU = 'Εμφάνιση Χρηστών';
	var $_PHPSHOP_USER_LIST_LBL = 'Λίστα Χρηστών';
	var $_PHPSHOP_USER_LIST_USERNAME = 'Χρήστης';
	var $_PHPSHOP_USER_LIST_FULL_NAME = 'Πλήρες Ονομα';
	var $_PHPSHOP_USER_LIST_GROUP = 'Ομάδα';
	var $_PHPSHOP_USER_FORM_MNU = 'Προσθήκη Χρήστη';
	var $_PHPSHOP_USER_FORM_LBL = 'Προσθήκη/Ενημέρωση Στοιχείων Χρήστη';
	var $_PHPSHOP_USER_FORM_BILLTO_LBL = 'Πληροφορίες Τιμολόγησης';
	var $_PHPSHOP_USER_FORM_SHIPTO_LBL = 'Διεύθυνση Αποστολής';
	var $_PHPSHOP_USER_FORM_ADD_SHIPTO_LBL = 'Προσθήκη Διεύθυνσης';
	var $_PHPSHOP_USER_FORM_NO_SHIPPING_ADDRESSES = 'Καμμία Διεύθυνση Αποστολής.';
	var $_PHPSHOP_USER_FORM_ADDRESS_LABEL = 'Address Nickname';
	var $_PHPSHOP_USER_FORM_FIRST_NAME = 'Ονομα';
	var $_PHPSHOP_USER_FORM_LAST_NAME = 'Επώνυμο';
	var $_PHPSHOP_USER_FORM_MIDDLE_NAME = 'Μεσαίο Ονομα';
	var $_PHPSHOP_USER_FORM_TITLE = 'Τίτλος';
	var $_PHPSHOP_USER_FORM_USERNAME = 'Χρήστης';
	var $_PHPSHOP_USER_FORM_PASSWORD_1 = 'Σύνθημα';
	var $_PHPSHOP_USER_FORM_PASSWORD_2 = 'Επιβεβαίωση Συνθήματος';
	var $_PHPSHOP_USER_FORM_PERMS = 'Εξουσιοδοτήσεις';
	var $_PHPSHOP_USER_FORM_CUSTOMER_NUMBER = 'Κωδικός Πελάτη / ID';
	var $_PHPSHOP_USER_FORM_COMPANY_NAME = 'Ονομα Εταιρείας';
	...
	var $_PHPSHOP_USER_FORM_ZIP = 'Ταχ. Κώδικας';
	var $_PHPSHOP_USER_FORM_COUNTRY = 'Χώρα';
	var $_PHPSHOP_USER_FORM_PHONE = 'Τηλέφωνο';
	var $_PHPSHOP_USER_FORM_PHONE2 = 'Κινητό';
	var $_PHPSHOP_USER_FORM_FAX = 'Φαξ';
	var $_PHPSHOP_USER_FORM_EMAIL = 'Email';
	var $_PHPSHOP_MODULE_LIST_MNU = 'Εμφάνιση Modules';
	var $_PHPSHOP_MODULE_LIST_LBL = 'Λίστα Module';
	var $_PHPSHOP_MODULE_LIST_NAME = 'Ονομα Module';
	var $_PHPSHOP_MODULE_LIST_PERMS = 'Εξουσ. Module';
	var $_PHPSHOP_MODULE_LIST_FUNCTIONS = 'Functions';
	var $_PHPSHOP_MODULE_LIST_ORDER = 'Σειρά Ταξινομ.';
	var $_PHPSHOP_MODULE_FORM_MNU = 'Προσθήκη Module';
	var $_PHPSHOP_MODULE_FORM_LBL = 'Πληροφορίες Module';
	var $_PHPSHOP_MODULE_FORM_MODULE_LABEL = 'Επιγραφή Module ( για Topmenu )';
	var $_PHPSHOP_MODULE_FORM_NAME = 'Ονομα Module';
	var $_PHPSHOP_MODULE_FORM_PERMS = 'Εξουσ. Module';
	var $_PHPSHOP_MODULE_FORM_HEADER = 'Κεφαλίδα Module';
	var $_PHPSHOP_MODULE_FORM_FOOTER = 'Module Footer';
	var $_PHPSHOP_MODULE_FORM_MENU = 'Εμφάνιση Module στο μενού διαχείρησης?';
	...
	var $_PHPSHOP_FUNCTION_LIST_MNU = 'Εμφ. Function';
	var $_PHPSHOP_FUNCTION_LIST_LBL = 'Λίστα Function';
	var $_PHPSHOP_FUNCTION_LIST_NAME = 'Ονομα Function';
	var $_PHPSHOP_FUNCTION_LIST_CLASS = 'Ονομα Class';
	var $_PHPSHOP_FUNCTION_LIST_METHOD = 'Class Method';
	var $_PHPSHOP_FUNCTION_LIST_PERMS = 'Εξουσιοδ.';
	...
	var $_PHPSHOP_CURRENCY_LIST_MNU = 'Εμφ. Νομισμάτων';
	var $_PHPSHOP_CURRENCY_LIST_LBL = 'Λίστα Νομισμάτων';
	var $_PHPSHOP_CURRENCY_LIST_ADD = 'Προσθ. Νομίσματος';
	var $_PHPSHOP_CURRENCY_LIST_NAME = 'Ονομα Νομίσματος';
	var $_PHPSHOP_CURRENCY_LIST_CODE = 'Κωδ. Νομίσματος';
	var $_PHPSHOP_COUNTRY_LIST_MNU = 'Εμφ. Χωρών';
	var $_PHPSHOP_COUNTRY_LIST_LBL = 'Λίστα Χωρών';
	var $_PHPSHOP_COUNTRY_LIST_ADD = 'Προσθ. Χώρας';
	var $_PHPSHOP_COUNTRY_LIST_NAME = 'Ονομα Χώρας';
	var $_PHPSHOP_COUNTRY_LIST_3_CODE = 'Κωδ. Χώρας (3)';
	var $_PHPSHOP_COUNTRY_LIST_2_CODE = 'Κωδ. Χώρας (2)';
	var $_PHPSHOP_STATE_LIST_MNU = 'Εμφ. Πολιτειών';
	var $_PHPSHOP_STATE_LIST_LBL = 'Εμφ. Πολιτειών για: ';
	var $_PHPSHOP_STATE_LIST_ADD = 'Προσθήκη/Ενημ. Πολιτείας';
	var $_PHPSHOP_STATE_LIST_NAME = 'Ονομα Πολιτείας';
	var $_PHPSHOP_STATE_LIST_3_CODE = 'Κωδ. Πολιτείας (3)';
	var $_PHPSHOP_STATE_LIST_2_CODE = 'Κωδ. Πολιτείας (2)';
	...
	var $_PHPSHOP_ISSHIP_PING_CARRIER_LBL = 'Μεταφορική';
	var $_PHPSHOP_ISSHIP_PING_RESPONSE_LBL = 'Χρόνος<br />Ανταπόκρισης';
	var $_PHPSHOP_ISSHIP_PING_TIME_LBL = 'δευτ.';
	var $_PHPSHOP_ISSHIP_LIST_MNU = 'Εμφ. Τρόπων Αποστολής';
	var $_PHPSHOP_ISSHIP_LIST_LBL = 'Active Ship Methods';
	var $_PHPSHOP_ISSHIP_LIST_CARRIER_LBL = 'Τρόποι Αποστολής';
	var $_PHPSHOP_ISSHIP_LIST_PUBLISH_LBL = 'Ενεργό';
	...
	var $_PHPSHOP_ISSHIP_FORM_CARRIER_LBL = 'Τρόπος Αποστολής';
	...
	var $_PHPSHOP_ORDER_LIST_MNU = 'Εμφ. Παραγγελιών';
	var $_PHPSHOP_ORDER_LIST_LBL = 'Λίστα Παραγγελιών';
	var $_PHPSHOP_ORDER_LIST_ID = 'Αρ. Παραγγελίας';
	var $_PHPSHOP_ORDER_LIST_CDATE = 'Ημ/νία Παραγγελίας';
	var $_PHPSHOP_ORDER_LIST_MDATE = 'Τελ. Αλλαγή';
	var $_PHPSHOP_ORDER_LIST_STATUS = 'Κατάσταση';
	var $_PHPSHOP_ORDER_LIST_TOTAL = 'Μερ. Σύνολο';
	var $_PHPSHOP_ORDER_ITEM = 'Είδη Παραγγελίας';
	var $_PHPSHOP_ORDER_PRINT_PO_LBL = 'Εντολή Αγοράς';
	var $_PHPSHOP_ORDER_PRINT_PO_NUMBER = 'Αρ. Παραγγελίας';
	var $_PHPSHOP_ORDER_PRINT_PO_DATE = 'Ημ/νία Παραγγελίας';
	var $_PHPSHOP_ORDER_PRINT_PO_STATUS = 'Κατάσταση';
	var $_PHPSHOP_ORDER_PRINT_CUST_INFO_LBL = 'Πληροφορίες Πελάτη';
	var $_PHPSHOP_ORDER_PRINT_CUST_BILLING_LBL = 'Πληροφορίες Τιμολόγησης';
	var $_PHPSHOP_ORDER_PRINT_CUST_SHIPPING_LBL = 'Πληροφορίες Αποστολής';
	var $_PHPSHOP_ORDER_PRINT_BILL_TO_LBL = 'Τιμολόγηση Σε';
	var $_PHPSHOP_ORDER_PRINT_SHIP_TO_LBL = 'Αποστολή Σε';
	var $_PHPSHOP_ORDER_PRINT_NAME = 'Ονομα';
	var $_PHPSHOP_ORDER_PRINT_COMPANY = 'Εταιρία';
	...
	var $_PHPSHOP_ORDER_PRINT_ZIP = 'Ταχ. Κώδικας';
	var $_PHPSHOP_ORDER_PRINT_COUNTRY = 'Χώρα';
	var $_PHPSHOP_ORDER_PRINT_PHONE = 'Τηλέφωνο';
	var $_PHPSHOP_ORDER_PRINT_FAX = 'Φαξ';
	var $_PHPSHOP_ORDER_PRINT_EMAIL = 'Email';
	var $_PHPSHOP_ORDER_PRINT_ITEMS_LBL = 'Είδη Παραγγελίας';
	var $_PHPSHOP_ORDER_PRINT_QUANTITY = 'Ποσότητα';
	var $_PHPSHOP_ORDER_PRINT_QTY = 'Ποσ.';
	var $_PHPSHOP_ORDER_PRINT_SKU = 'Κωδ. Προιόντος';
	var $_PHPSHOP_ORDER_PRINT_PRICE = 'Τιμή';
	var $_PHPSHOP_ORDER_PRINT_TOTAL = 'Σύνολο';
	var $_PHPSHOP_ORDER_PRINT_SUBTOTAL = 'Μερ. Σύνολο';
	var $_PHPSHOP_ORDER_PRINT_TOTAL_TAX = 'Σύν. Φόρου';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING = 'Εξοδα Αποστολής & Συσκευασίας';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_TAX = 'Φόρος Αποστολής';
	var $_PHPSHOP_ORDER_PRINT_PAYMENT_LBL = 'Τρόπος Πληρωμής ';
	var $_PHPSHOP_ORDER_PRINT_ACCOUNT_NAME = 'Ονομα Λογαριασμού';
	var $_PHPSHOP_ORDER_PRINT_ACCOUNT_NUMBER = 'Αρ. Λογαριασμού';
	var $_PHPSHOP_ORDER_PRINT_EXPIRE_DATE = 'Ημ/νία Λήξης';
	var $_PHPSHOP_ORDER_PRINT_PAYMENT_LOG_LBL = 'Ιστορικό Πληρωμών';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_LBL = 'Πληροφορίες Αποστολής';
	var $_PHPSHOP_ORDER_PRINT_PAYINFO_LBL = 'Πληροφορίες Πληρωμής';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_CARRIER_LBL = 'Μεταφορέας';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_MODE_LBL = 'Τρόπος Αποστολής';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_DATE_LBL = 'Ημ/νία Αποστολής';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_PRICE_LBL = 'Αξία Αποστολής';
	var $_PHPSHOP_ORDER_STATUS_LIST_MNU = 'Εμφ. Status Παραγγελιών';
	var $_PHPSHOP_ORDER_STATUS_FORM_MNU = 'Προσθήκη Νέου Status Παραγγελίας';
	var $_PHPSHOP_ORDER_STATUS_LIST_CODE = 'Κωδ. Status Παραγγελίας';
	var $_PHPSHOP_ORDER_STATUS_LIST_NAME = 'Ονομα Status';
	var $_PHPSHOP_ORDER_STATUS_FORM_LBL = 'Status Παραγγελίας';
	var $_PHPSHOP_ORDER_STATUS_FORM_CODE = 'Κωδ. Status Παραγγελίας';
	var $_PHPSHOP_ORDER_STATUS_FORM_NAME = 'Ονομα Status';
	var $_PHPSHOP_ORDER_STATUS_FORM_LIST_ORDER = 'Εμφ. Παραγγελίας';
	var $_PHPSHOP_PRODUCT_MOD = 'Προιόντα';
	var $_PHPSHOP_CURRENT_PRODUCT = 'Τρέχον Προιόν';
	var $_PHPSHOP_CURRENT_ITEM = 'Τρέχον Είδος';
	var $_PHPSHOP_PRODUCT_INVENTORY_LBL = 'Κατάλογος Προιόντων';
	var $_PHPSHOP_PRODUCT_INVENTORY_MNU = 'Εμφάνιση Καταλόγου';
	...
	var $_PHPSHOP_PRODUCT_LIST_MNU = 'Εμφ. Προιόντων';
	var $_PHPSHOP_PRODUCT_LIST_LBL = 'Λίστα Προιόντων';
	var $_PHPSHOP_PRODUCT_LIST_NAME = 'Ονομα Προιόντος';
	var $_PHPSHOP_PRODUCT_LIST_SKU = 'Κωδικός';
	var $_PHPSHOP_PRODUCT_LIST_PUBLISH = 'Δημοσίευση';
	var $_PHPSHOP_PRODUCT_LIST_SEARCH_BY_DATE = 'Αναζήτηση Προιόντος';
	var $_PHPSHOP_PRODUCT_LIST_SEARCH_BY_DATE_TYPE_PRODUCT = 'τροποποίηση';
	var $_PHPSHOP_PRODUCT_LIST_SEARCH_BY_DATE_TYPE_PRICE = 'με τροποποιημένη τιμή';
	var $_PHPSHOP_PRODUCT_LIST_SEARCH_BY_DATE_TYPE_WITHOUTPRICE = 'χωρίς τιμή';
	var $_PHPSHOP_PRODUCT_LIST_SEARCH_BY_DATE_AFTER = 'Μετά';
	var $_PHPSHOP_PRODUCT_LIST_SEARCH_BY_DATE_BEFORE = 'Πρίν';
	var $_PHPSHOP_PRODUCT_FORM_MNU = 'Προσθήκη Προιόντος';
	var $_PHPSHOP_PRODUCT_FORM_EDIT_PRODUCT = 'Επεξ. Προιόντος';
	var $_PHPSHOP_PRODUCT_FORM_SHOW_FLYPAGE = 'Εμφάνιση καρτέλλας προιόντος στο κατάστημα';
	var $_PHPSHOP_PRODUCT_FORM_ADD_ITEM_MNU = 'Προσθήκη Είδους';
	var $_PHPSHOP_PRODUCT_FORM_ADD_ANOTHER_ITEM_MNU = 'Προσθήκη άλλου Είδους';
	var $_PHPSHOP_PRODUCT_FORM_NEW_PRODUCT_LBL = 'Νέο Προιόν';
	var $_PHPSHOP_PRODUCT_FORM_UPDATE_PRODUCT_LBL = 'Ενημέρωση Προιόντος';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_INFO_LBL = 'Πληροφορίες Προιόντος';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_STATUS_LBL = 'Status Προιόντος';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_DIM_WEIGHT_LBL = 'Διαστάσεις & Βάρος Προιόντος';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_IMAGES_LBL = 'Εικόνες Προιόντος';
	...
	var $_PHPSHOP_PRODUCT_FORM_ITEM_STATUS_LBL = 'Status Είδους';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_DIM_WEIGHT_LBL = 'Διαστάσεις & Βάρος Είδους';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_IMAGES_LBL = 'Εικόνες Είδους';
	var $_PHPSHOP_PRODUCT_FORM_RETURN_LBL = 'Επιστροφή στο κύριο Προιόν';
	...
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_ITEMS_LBL = 'Είδη Προιόντος';
	...
	var $_PHPSHOP_PRODUCT_FORM_MANUFACTURER = 'Κατασκευαστής';
	var $_PHPSHOP_PRODUCT_FORM_SKU = 'Κωδικός';
	var $_PHPSHOP_PRODUCT_FORM_NAME = 'Ονομα';
	var $_PHPSHOP_PRODUCT_FORM_URL = 'URL';
	var $_PHPSHOP_PRODUCT_FORM_CATEGORY = 'Κατηγορία';
	var $_PHPSHOP_PRODUCT_FORM_PRICE_GROSS = 'Τιμή Προιόντος (Gross)';
	var $_PHPSHOP_PRODUCT_FORM_PRICE_NET = 'Τιμή Προιόντος (Net)';
	var $_PHPSHOP_PRODUCT_FORM_DESCRIPTION = 'Περιγραφή Προιόντος';
	var $_PHPSHOP_PRODUCT_FORM_S_DESC = 'Σύντομη Περιγραφή';
	var $_PHPSHOP_PRODUCT_FORM_IN_STOCK = 'Σε Απόθεμα';
	var $_PHPSHOP_PRODUCT_FORM_ON_ORDER = 'Σε Παραγγελία';
	var $_PHPSHOP_PRODUCT_FORM_AVAILABLE_DATE = 'Ημ/νία Διαθεσιμότητας';
	var $_PHPSHOP_PRODUCT_FORM_SPECIAL = 'Κατόπιν Παραγγελίας';
	var $_PHPSHOP_PRODUCT_FORM_DISCOUNT_TYPE = 'Τύπος Εκπτωσης';
	var $_PHPSHOP_PRODUCT_FORM_PUBLISH = 'Δημοσίευση?';
	var $_PHPSHOP_PRODUCT_FORM_LENGTH = 'Μήκος';
	var $_PHPSHOP_PRODUCT_FORM_WIDTH = 'Πλάτος';
	var $_PHPSHOP_PRODUCT_FORM_HEIGHT = 'Υψος';
	...
	var $_PHPSHOP_PRODUCT_FORM_WEIGHT_UOM_DEFAULT = 'λίβρες';
	var $_PHPSHOP_PRODUCT_FORM_DIMENSION_UOM_DEFAULT = 'inches';
	var $_PHPSHOP_PRODUCT_FORM_UNIT = 'Μονάδα';
	var $_PHPSHOP_PRODUCT_FORM_UNIT_DEFAULT = 'τεμ.';
	...
	var $_PHPSHOP_ATTRIBUTE_LIST_MNU = 'Εμφ. Χαρακτηριστικών';
	var $_PHPSHOP_ATTRIBUTE_LIST_LBL = 'Λίστα Χαρακτηριστικών για';
	var $_PHPSHOP_ATTRIBUTE_LIST_NAME = 'Ονομα Χαρακτηριστικού';
	var $_PHPSHOP_ATTRIBUTE_LIST_ORDER = 'Σειρά Ταξινόμησης';
	var $_PHPSHOP_ATTRIBUTE_FORM_MNU = 'Προσθ. Χαρακτ.';
	var $_PHPSHOP_ATTRIBUTE_FORM_LBL = 'Φόρμα Χαρακτηριστικών';
	var $_PHPSHOP_ATTRIBUTE_FORM_NEW_FOR_PRODUCT = 'Νέο Χαρακτηριστικό για προιόν';
	var $_PHPSHOP_ATTRIBUTE_FORM_UPDATE_FOR_PRODUCT = 'Ενημέρωση Χαρακτηριστικού για προιόν';
	var $_PHPSHOP_ATTRIBUTE_FORM_NEW_FOR_ITEM = 'Νέο Χαρακτηριστικό για είδος';
	var $_PHPSHOP_ATTRIBUTE_FORM_UPDATE_FOR_ITEM = 'Ενημέρωση Χαρακτηριστικού για είδος';
	var $_PHPSHOP_ATTRIBUTE_FORM_NAME = 'Ονομα Χαρακτηριστικού';
	var $_PHPSHOP_ATTRIBUTE_FORM_ORDER = 'Σειρά Ταξινόμησης';
	var $_PHPSHOP_PRICE_LIST_MNU = 'Εμφ. Τιμών';
	var $_PHPSHOP_PRICE_LIST_LBL = 'Λίστα Τιμών';
	...
	var $_PHPSHOP_PRICE_FORM_MNU = 'Προσθ. Τιμής';
	var $_PHPSHOP_PRICE_FORM_LBL = 'Πληροφορίες Τιμών';
	var $_PHPSHOP_PRICE_FORM_NEW_FOR_PRODUCT = 'Νέα τιμή για Προιόν';
	var $_PHPSHOP_PRICE_FORM_UPDATE_FOR_PRODUCT = 'Ενημέρωση Τιμής Προιόντος';
	var $_PHPSHOP_PRICE_FORM_NEW_FOR_ITEM = 'Νέα Τιμή Είδους';
	var $_PHPSHOP_PRICE_FORM_UPDATE_FOR_ITEM = 'Ενημέρωση Τιμής Είδους';
	...
	var $_PHPSHOP_RB_SALE_TITLE = 'Καταστάσεις Πωλήσεων';
	var $_PHPSHOP_RB_SALES_PAGE_TITLE = 'Sales Activity Overview';
	var $_PHPSHOP_RB_INTERVAL_TITLE = 'Set Interval';
	var $_PHPSHOP_RB_INTERVAL_MONTHLY_TITLE = 'Μηνιαία';
	var $_PHPSHOP_RB_INTERVAL_WEEKLY_TITLE = 'Εβδομαδιαία';
	var $_PHPSHOP_RB_INTERVAL_DAILY_TITLE = 'Ημερήσια';
	var $_PHPSHOP_RB_THISMONTH_BUTTON = 'Αυτόν τον Μήνα';
	var $_PHPSHOP_RB_LASTMONTH_BUTTON = 'Προηγ. Μήνας';
	var $_PHPSHOP_RB_LAST60_BUTTON = 'Τελ. 60 Ημέρες';
	var $_PHPSHOP_RB_LAST90_BUTTON = 'Τελ. 90 Ημέρες';
	...
	var $_PHPSHOP_SHOPPER_FORM_LBL = 'Πληροφορίες Αγοραστή';
	var $_PHPSHOP_SHOPPER_FORM_BILLTO_LBL = 'Πληροφορίες Τιμολογηθέντα';
	var $_PHPSHOP_SHOPPER_FORM_ADDRESS_INFO_LBL = 'Πληροφορίες';
	var $_PHPSHOP_SHOPPER_FORM_SHIPTO_LBL = 'Πληροφορίες Αποστολής';
	var $_PHPSHOP_SHOPPER_FORM_ADD_SHIPTO_LBL = 'Προσθ. Διεύθυνσης';
	var $_PHPSHOP_SHOPPER_FORM_ADDRESS_LABEL = 'Ψευδόυμο Διεύθυνσης';
	var $_PHPSHOP_SHOPPER_FORM_USERNAME = 'Χρήστης';
	var $_PHPSHOP_SHOPPER_FORM_FIRST_NAME = 'Ονομα';
	var $_PHPSHOP_SHOPPER_FORM_LAST_NAME = 'Επώνυμο';
	var $_PHPSHOP_SHOPPER_FORM_MIDDLE_NAME = 'Μεσαίο Ονομα';
	...
	var $_PHPSHOP_STORE_FORM_CONTACT_LBL = 'Πληροφορίες Επικοινωνίας';
	var $_PHPSHOP_STORE_FORM_FULL_IMAGE = 'Πλήρης Εικόνα';
	var $_PHPSHOP_STORE_FORM_UPLOAD = 'Upload Εικόνα';
	var $_PHPSHOP_STORE_FORM_STORE_NAME = 'Ονομα Καταστήματος';
	var $_PHPSHOP_STORE_FORM_COMPANY_NAME = 'Επωνυμία Καταστήματος';
	...
	var $_PHPSHOP_STORE_FORM_STATE = 'Πολιτεία/Επαρχία/Περιφέρεια';
	var $_PHPSHOP_STORE_FORM_COUNTRY = 'Χώρα';
	var $_PHPSHOP_STORE_FORM_ZIP = 'Ταχ. Κώδικας';
	var $_PHPSHOP_STORE_FORM_PHONE = 'Τηλέφωνο';
	...
	var $_PHPSHOP_STORE_FORM_FIRST_NAME = 'Ονομα';
	var $_PHPSHOP_STORE_FORM_MIDDLE_NAME = 'Μεσαίο Ονομα';
	var $_PHPSHOP_STORE_FORM_TITLE = 'Τίτλος';
	var $_PHPSHOP_STORE_FORM_PHONE_1 = 'Τηλέφωνο 1';
	var $_PHPSHOP_STORE_FORM_PHONE_2 = 'Τηλέφωνο 2';
	var $_PHPSHOP_STORE_FORM_FAX = 'Φαξ';
	var $_PHPSHOP_STORE_FORM_EMAIL = 'Email';
	var $_PHPSHOP_STORE_FORM_IMAGE_PATH = 'Διαδρομή (path) εικόνας';
	...
	var $_PHPSHOP_TAX_RATE = 'Ποσοστά Φόρων';
	var $_PHPSHOP_TAX_LIST_MNU = 'Εμφ. Ποσοστών Φόρων';
	var $_PHPSHOP_TAX_LIST_LBL = 'Λίστα Φόρων';
	var $_PHPSHOP_TAX_LIST_STATE = 'Πολιτεία ή Περιφέρεια Φόρου';
	var $_PHPSHOP_TAX_LIST_COUNTRY = 'Χώρα Φόρου';
	var $_PHPSHOP_TAX_LIST_RATE = 'Ποσοστό Φόρου';
	var $_PHPSHOP_TAX_FORM_MNU = 'Προσθ. Φόρου';
	var $_PHPSHOP_TAX_FORM_LBL = 'Προσθ. Πληροφοριών Φόρου';
	var $_PHPSHOP_TAX_FORM_STATE = 'Πολιτεία ή Περιφέρεια Φόρου';
	var $_PHPSHOP_TAX_FORM_COUNTRY = 'Χώρα Φόρου';
	var $_PHPSHOP_TAX_FORM_RATE = 'Ποσοστό (για 16% => δώστε 0.16)';
	var $_PHPSHOP_VENDOR_MOD = 'Προμηθευτής';
	var $_PHPSHOP_VENDOR_ADMIN = 'Προμηθευτές';
	var $_PHPSHOP_VENDOR_LIST_MNU = 'Εμφ. Προμηθευτών';
	var $_PHPSHOP_VENDOR_LIST_LBL = 'Λίστα Προμηθευτών';
	var $_PHPSHOP_VENDOR_LIST_VENDOR_NAME = 'Ονομα Προμηθευτή';
	var $_PHPSHOP_VENDOR_LIST_ADMIN = 'Admin';
	var $_PHPSHOP_VENDOR_FORM_MNU = 'Προσθ. Προμηθευτή';
	...
	var $_PHPSHOP_VENDOR_FORM_FULL_IMAGE = 'Πλήρη Εικόνα';
	var $_PHPSHOP_VENDOR_FORM_UPLOAD = 'Ανέβασμα Εικόνας';
	var $_PHPSHOP_VENDOR_FORM_STORE_NAME = 'Ονομα Καταστήματος Προμηθευτή';
	var $_PHPSHOP_VENDOR_FORM_COMPANY_NAME = 'Επωνυμία Προμηθευτή';
	...
	var $_PHPSHOP_VENDOR_FORM_ZIP = 'Ταχ. Κώδικας';
	var $_PHPSHOP_VENDOR_FORM_PHONE = 'Τηλέφωνο';
	...
	var $_PHPSHOP_VENDOR_FORM_FIRST_NAME = 'Ονομα';
	var $_PHPSHOP_VENDOR_FORM_MIDDLE_NAME = 'Μεσαίο Ονομα';
	var $_PHPSHOP_VENDOR_FORM_TITLE = 'Τίτλος';
	var $_PHPSHOP_VENDOR_FORM_PHONE_1 = 'Τηλέφωνο 1';
	var $_PHPSHOP_VENDOR_FORM_PHONE_2 = 'Τηλέφωνο 2';
	var $_PHPSHOP_VENDOR_FORM_FAX = 'Φαξ';
	...
	var $_PHPSHOP_VENDOR_CAT_LIST_MNU = 'Εμφ. Κατηγοριών Προμηθευτών';
	var $_PHPSHOP_VENDOR_CAT_LIST_LBL = 'Λίστα Κατηγοριών Προμηθευτών';
	var $_PHPSHOP_VENDOR_CAT_NAME = 'Ονομα Κατηγορίας';
	var $_PHPSHOP_VENDOR_CAT_DESCRIPTION = 'Περιγραφή';
	var $_PHPSHOP_VENDOR_CAT_VENDORS = 'Προμηθευτές';
	var $_PHPSHOP_VENDOR_CAT_FORM_MNU = 'Προσθ. Κατηγορίας Προμηθευτή';
	var $_PHPSHOP_VENDOR_CAT_FORM_LBL = 'Φόρμα Κατηγορίας Προμηθευτή';
	var $_PHPSHOP_VENDOR_CAT_FORM_INFO_LBL = 'Πληροφορίες Κατηγορίας';
	var $_PHPSHOP_VENDOR_CAT_FORM_NAME = 'Ονομα Κατηγορίας';
	var $_PHPSHOP_VENDOR_CAT_FORM_DESCRIPTION = 'Περιγραφή';
	var $_PHPSHOP_MANUFACTURER_MOD = 'Κατασκευαστής';
	var $_PHPSHOP_MANUFACTURER_ADMIN = 'Κατασκευαστές';
	var $_PHPSHOP_MANUFACTURER_LIST_MNU = 'Εμφ. Κατασκευαστών';
	var $_PHPSHOP_MANUFACTURER_LIST_LBL = 'Λίστα Κατασκευαστών';
	var $_PHPSHOP_MANUFACTURER_LIST_MANUFACTURER_NAME = 'Ονομα Κατασκευαστή';
	var $_PHPSHOP_MANUFACTURER_LIST_ADMIN = 'Admin';
	var $_PHPSHOP_MANUFACTURER_FORM_MNU = 'Προσθ. Κατασκ.';
	var $_PHPSHOP_MANUFACTURER_FORM_LBL = 'Εισαγωγή Πληροφοριών';
	var $_PHPSHOP_MANUFACTURER_FORM_INFO_LBL = 'Πληροφορίες Κατασκευαστή';
	var $_PHPSHOP_MANUFACTURER_FORM_NAME = 'Ονομα Κατασκευαστή';
	var $_PHPSHOP_MANUFACTURER_FORM_CATEGORY = 'Κατηγορία Κατασκευαστή';
	var $_PHPSHOP_MANUFACTURER_FORM_EMAIL = 'Email';
	var $_PHPSHOP_MANUFACTURER_FORM_URL = 'URL Ιστοσελίδας Κατασκευαστή';
	var $_PHPSHOP_MANUFACTURER_FORM_DESCRIPTION = 'Περιγραφή';
	var $_PHPSHOP_MANUFACTURER_CAT_LIST_MNU = 'Εμφ. Κατηγοριών Κατασκευαστή';
	var $_PHPSHOP_MANUFACTURER_CAT_LIST_LBL = 'Λίστα Κατηγοριών Κατασκευαστή';
	var $_PHPSHOP_MANUFACTURER_CAT_NAME = 'Ονομα Κατηγορίας';
	var $_PHPSHOP_MANUFACTURER_CAT_DESCRIPTION = 'Περιγραφή Κατηγορίας';
	var $_PHPSHOP_MANUFACTURER_CAT_MANUFACTURERS = 'Κατασκευαστές';
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_MNU = 'Προσθ. κατηγορίας Κατασκευαστή';
	...
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_NAME = 'Ονομα Κατηγορίας';
	...
	var $_PHPSHOP_CART_UPDATE = 'Ενημ. Ποσότητας στο καλάθι';
	var $_PHPSHOP_CART_DELETE = 'Διαγραφή Προιόντος από το καλάθι';
	...
	var $_PHPSHOP_ACC_ORDER_INFO = 'Πληροφορίες Παραγγελιών';
	var $_PHPSHOP_ACC_UPD_BILL = 'Εδώ μπορείτε να αλλάξετε τα στοιχεία σας.';
	...
	var $_PHPSHOP_ACC_NO_ORDERS = 'Δεν υπαρχουν παραγγελίες για εμφάνιση';
	var $_PHPSHOP_ACC_BILL_DEF = '- Προετεινόμενο (Ιδια με Τιμολόγησης)';
	...
	var $_PHPSHOP_CONFIG = 'Διαμόρφωση';
	var $_PHPSHOP_USERS = 'Χρήστες';
	var $_PHPSHOP_IS_CC_PAYMENT = 'is Credit Card payment?';
	var $_PHPSHOP_SHIPPING_MOD = 'Αποστολή';
	var $_PHPSHOP_SHIPPING_MENU_LABEL = 'Αποστολή';
	var $_PHPSHOP_CARRIER_LIST_MNU = 'Αποστολέας';
	var $_PHPSHOP_CARRIER_LIST_LBL = 'Εμφ. Αποστολέων';
	var $_PHPSHOP_RATE_LIST_MNU = 'Ποσοστά ΑΠοστολής';
	var $_PHPSHOP_RATE_LIST_LBL = 'Λίστα Ποσοστών Αποστολής';
	var $_PHPSHOP_CARRIER_LIST_NAME_LBL = 'Ονομα';
	var $_PHPSHOP_CARRIER_LIST_ORDER_LBL = 'Listorder';
	var $_PHPSHOP_CARRIER_FORM_MNU = 'Δημιουργία Αποστολέα';
	var $_PHPSHOP_CARRIER_FORM_LBL = 'Shipper edit / create';
	var $_PHPSHOP_RATE_FORM_MNU = 'Δημιουργ. Ποσοστού Αποστολής';
	...
	var $_PHPSHOP_INFO_MSG_CARRIER = 'Αποστολέας';
	var $_PHPSHOP_INFO_MSG_SHIPPING_METHOD = 'Φόρος Αποστολής';
	...
	var $_PHPSHOP_ACCOUNT_BANK_TITLE = 'Στοιχεία Λογαριασμού Τραπέζης';
	...
	var $_PHPSHOP_ACCOUNT_LBL_BANK_NAME = 'Ονομα Τράπεζας';
	...
	var $_PHPSHOP_SPECIAL_PRODUCTS = 'Ειδικά Προιόντα';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_NOTE = 'Εάν θέλετε συμπληρώστε παρατηρήσεις στην παραγγελία σας.';
	var $_PHPSHOP_ORDER_PRINT_CUSTOMER_NOTE = 'Παρατηρήσεις Πελάτη';
	var $_PHPSHOP_INCLUDING_TAX = '(Με ΦΠΑ $tax %)';
	var $_PHPSHOP_PLEASE_SEL_ITEM = 'Επιλέξτε Είδος';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_LBL = 'Είδος';
	var $_PHPSHOP_DOWNLOADS_TITLE = 'Περιοχή Λήψης';
	var $_PHPSHOP_DOWNLOADS_START = 'Εναρξη Λήψης';
	...
	var $_PHPSHOP_REGISTRATION_FORM_NONE = 'κενό';
	var $_PHPSHOP_REGISTRATION_FORM_MR = 'Κος';
	...
	var $_PHPSHOP_DELIVERY_TIME = 'Αποστέλεται σε ';
	var $_PHPSHOP_DELIVERY_INFORMATION = 'Delivery Information';
	var $_PHPSHOP_MORE_CATEGORIES = 'Υποκατηγορίες';
  ...
  select the status which enables the download (then the customer is instantly notified about the download via e-mail).';
	...
	var $_PHPSHOP_CONTINUE_SHOPPING = 'Αλλο Προιόν';
	...
	var $_PHPSHOP_PRODUCT_DISCOUNT_LBL = 'Εκπτωση Προιόντος';
	var $_PHPSHOP_PRODUCT_DISCOUNT_LIST_LBL = 'Λίστα Εκπτώσεων Προιόντων';
	var $_PHPSHOP_PRODUCT_DISCOUNT_ADDEDIT = 'Προσθ./Αλλαγή Εκπτωσης Προιόντος';
	var $_PHPSHOP_PRODUCT_DISCOUNT_AMOUNT = 'Αξία Εκπτωσης';
	var $_PHPSHOP_PRODUCT_DISCOUNT_AMOUNT_TIP = 'Πληκτρολογείστε την αξία της έκπτωσης';
	var $_PHPSHOP_PRODUCT_DISCOUNT_AMOUNTTYPE = 'Τύπος Εκπτωσης';
	var $_PHPSHOP_PRODUCT_DISCOUNT_ISPERCENT = 'Ποσοστό';
	var $_PHPSHOP_PRODUCT_DISCOUNT_ISTOTAL = 'Σύνολο';
	...
	var $_PHPSHOP_FLYPAGE_ENLARGE_IMAGE = 'Πλήρης Εμφ. Εικόνας';
	...
	var $_PHPSHOP_FILES_FORM_FILE_URL = 'URL Αρχείου (προεραιτικό)';
	var $_PHPSHOP_FILES_PATH_ERROR = 'Παρακαλώ δώστε έγκυρη διαδρομή (path)!';
	...
	var $_PHPSHOP_FILES_UPLOAD_FAILURE = 'Λάθος στο ανέβασμα Αρχείου/Εικόνας';
	var $_PHPSHOP_FILES_FULLIMG_DELETE_FAILURE = 'Αδύνατη η διαγραφή της πλήρης εικόνας.';
	var $_PHPSHOP_FILES_FULLIMG_DELETE_SUCCESS = 'Πλήρης εικόνα διεγράφη επιτυχώς.';
	...
	var $_PHPSHOP_FILES_FILE_DELETE_FAILURE = 'Αδύνατη η διαγραφή του αρχείου.';
	var $_PHPSHOP_FILES_FILE_DELETE_SUCCESS = 'Το αρχείο διεγράφηκε επιτυχώς.';
	var $_PHPSHOP_FILES_NOT_FOUND = 'Συγνώμη, αλλά το αρχείο δεν βρέθηκε!';
	var $_PHPSHOP_IMAGE_NOT_FOUND = 'Η εικόνα δεν βρέθηκε!';
	var $_PHPSHOP_COUPON_MOD = 'Κουπόνι';
	var $_PHPSHOP_COUPONS = 'Κουπόνια';
	var $_PHPSHOP_COUPON_LIST = 'Λίστα Κουπονιών';
	var $_PHPSHOP_COUPON_ALREADY_REDEEMED = 'Το κουπόνι έχει ήδη χρησιμοποιηθεί.';
	var $_PHPSHOP_COUPON_REDEEMED = 'Το κουπόνι ενεργοποιήθηκε! Ευχαριστούμε.';
	var $_PHPSHOP_COUPON_ENTER_HERE = 'Εάν έχετε κωδικό κουπονιού, συμπληρώστε το παρακάτω:';
	var $_PHPSHOP_COUPON_SUBMIT_BUTTON = 'Υποβολή';
	var $_PHPSHOP_COUPON_CODE_EXISTS = 'Αυτός ο κωδικός κουπονιού ήδη υπάρχει. Δοκιμάστε Ξανά.';
	var $_PHPSHOP_COUPON_EDIT_HEADER = 'Ενημέρωση Κουπονιού';
	var $_PHPSHOP_COUPON_EDIT_HELP_TEXT = 'Click a coupon code to edit it, or to delete a coupon code, select it and click Delete:';
	var $_PHPSHOP_COUPON_CODE_HEADER = 'Κωδικός';
	var $_PHPSHOP_COUPON_PERCENT_TOTAL = 'Ποσοστό ή Σύνολο';
	var $_PHPSHOP_COUPON_TYPE = 'Τύπος Κουπονιού';
	...
	var $_PHPSHOP_COUPON_TYPE_GIFT = 'Κουπόνι Δώρου';
	var $_PHPSHOP_COUPON_TYPE_PERMANENT = 'Μόνιμο Κουπόνι';
	var $_PHPSHOP_COUPON_VALUE_HEADER = 'Αξία';
	var $_PHPSHOP_COUPON_DELETE_BUTTON = 'Διαγραφή Κωδικού';
	var $_PHPSHOP_COUPON_CONFIRM_DELETE = 'Θελετε πραγματικά να διαγράψετε αυτό το κουπόνι?';
	var $_PHPSHOP_COUPON_COMPLETE_ALL_FIELDS = 'Παρακαλώ συμπληρώστε όλα τα πεδία.';
	var $_PHPSHOP_COUPON_VALUE_NOT_NUMBER = 'Αξία κουπονιού πρέπει να είναι αριθμός.';
	var $_PHPSHOP_COUPON_NEW_HEADER = 'Νέο Κουπόνι';
	var $_PHPSHOP_COUPON_COUPON_HEADER = 'Κωδ. Κουπονιού';
	var $_PHPSHOP_COUPON_PERCENT = 'Ποσοστό';
	var $_PHPSHOP_COUPON_TOTAL = 'Σύνολο';
	var $_PHPSHOP_COUPON_VALUE = 'Αξία';
	var $_PHPSHOP_COUPON_CODE_SAVED = 'Κωδ. Κουπονιού αποθηκεύθηκε.';
	var $_PHPSHOP_COUPON_SAVE_BUTTON = 'Αποθήκευση Κουπονιού';
	var $_PHPSHOP_COUPON_DISCOUNT = 'Κουπόνι Εκπτωσης';
	var $_PHPSHOP_COUPON_CODE_INVALID = 'Κωδ. Κουπονιού δεν βρέθηκε. Δοκιμάστε Ξανά.';
	var $_PHPSHOP_COUPONS_ENABLE = 'Ενεργ. Χρήσης Κουπονιού';
	...
	var $_PHPSHOP_FREE_SHIPPING = 'Δωρεάν Αποστολή';
	var $_PHPSHOP_FREE_SHIPPING_CUSTOMER_TEXT = 'Η αποστολή είναι δωρεάν σε αυτήν την παραγγελία';
	var $_PHPSHOP_FREE_SHIPPING_AMOUNT = 'Ελάχιστη Αξία για δωρεάν αποστολή';
	...
	var $_PHPSHOP_YOUR_STORE = 'Το Κατάστημά σας';
	var $_PHPSHOP_CONTROL_PANEL = 'Πίνακας Ελέγχου';
	var $_PHPSHOP_ADMIN_CFG_PDF_BUTTON = 'Κουμπί - PDF';
	var $_PHPSHOP_ADMIN_CFG_PDF_BUTTON_EXPLAIN = 'Εμφ. ή Αποκρ. Κουμπί PDF  στο κατάστημά σας';
	...
	var $_PHPSHOP_PRODUCT_FORM_ATTRIBUTE_LIST = 'Λίστα Χαρακτηριστικών';
	...
	var $_PHPSHOP_PARAMETERS_LBL = 'Παράμετροι';
	var $_PHPSHOP_PRODUCT_TYPE_LBL = 'Τύπος Προιόντος';
	var $_PHPSHOP_PRODUCT_TYPE_LIST_LBL = 'Λίστα Τύπων Προιόντων';
	var $_PHPSHOP_PRODUCT_TYPE_ADDEDIT = 'Προσθ./Αλλαγή Τύπων Προιόντων';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_LIST_LBL = 'Λίστα Τύπων Προιόντων για';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_LIST_MNU = 'Εμφάνιση Τύπων Προιόντων';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_FORM_LBL = 'Προσθήκη Τύπου Προιόντος για';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_FORM_MNU = 'Προσθήκη Τύπου Προιόντος';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_FORM_PRODUCT_TYPE = 'Τύπος Προιόντος';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_NAME = 'Ονομα Τύπου';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_DESCRIPTION = 'Περιγραφή Τύπου';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_PARAMETERS = 'Παράμετροι';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_LBL = 'Πληροφορίες Τύπου Προιόντος';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_PUBLISH = 'Δημοσίευση?';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_BROWSEPAGE = 'Σελίδα Εμφάνισης Τύπων Προιόντων';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_FLYPAGE = 'Product Type Flypage';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_LIST_LBL = 'Παράμετροι Τύπου Προιόντος';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_LBL = 'Πληροφορίες Παραμέτρων';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_NOT_FOUND = 'Ανύπαρκτος Τύπος Προιόντος!';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_NAME = 'Ονομα Παραμέτρου';
	...
	var $_PHPSHOP_PRODUCT_CLONE = 'Κλωνοποίηση Προιόντος';
	var $_PHPSHOP_CSV_SETTINGS = 'Ρυθμίσεις';
	...
	var $_PHPSHOP_FILTER = 'Φίλτρο';
	var $_PHPSHOP_BACK_TO_MAIN_SITE = 'Επιστροφή στην αρχή';
...
The Shop will create a new discount record from the discounted price.';
	var $_PHPSHOP_CART_PRICE_PER_UNIT = 'Τιμή Μονάδος';
...
When not checked, price labels look just as usual: <strong>Price: $xx.xx</strong>';
	...
	var $_PHPSHOP_ADMIN_CFG_TAX_CONFIGURATION = 'Διαμόρφωση Φόρων';
	var $_PHPSHOP_PRODUCT_LIST_QUANTITY_START = 'Ποσότητα Εναρξης';
	var $_PHPSHOP_PRODUCT_LIST_QUANTITY_END = 'Ποσότητα Λήξης';
	...
	var $_PHPSHOP_USER_SEND_REGISTRATION_DETAILS = 'Γειά σου %s,

Σε ευχαριστούμε για την εγγραφή σας στο %s. Ο κωδικός πελάτη σας, έχει δημιουργηθεί.
Μπορείτε να συνδεθείτε στο %s χρησιμοποιώντας το username και password:

Username - %s
Password - %s
';
	var $_PEAR_LOG_CRIT = 'Επικίνδυνο';
	var $_PEAR_LOG_ERR = 'Λάθος';
	var $_PEAR_LOG_WARNING = 'Προειδοποίηση';
	var $_PEAR_LOG_INFO = 'Πληροφορίες';
	var $_PEAR_LOG_TIP = 'Πληροφορίες';
	var $_PEAR_LOG_ALERT = 'Προειδοποίηση';
	var $_PEAR_LOG_EMERG = 'Επείγον';
	var $_PEAR_LOG_NOTICE = 'Προσοχή';
	...
	var $_PHPSHOP_ADMIN_CFG_ENABLE_PFP_TESTMODE = 'Δοκιμαστική Λειτουργία ?';
	var $_PHPSHOP_ADMIN_CFG_ENABLE_PFP_TESTMODE_EXPLAIN = 'Επιλέξτε \'Ναι\' για δοκιμές. Επιλέξτε \'Οχι\' για κανονική λειτουργία συναλλαγών.';
	...
	var $_VM_BROWSE_ORDERBY_DEFAULT_FIELD_LBL = 'Προεπιλεγμένος τρόπος ταξιν. προιόντος';
...
Afterwards you can select it here.';
	var $_VM_LEGALINFO_SHORTTEXT = '<h5>Πολιτική Επιστροφών</h5>

Μπορείτε να ακυρώσετε την παραγγελία μέσα σε δύο εβδομάδες, αφού την έχουμε παραλάβει.
Μπορείτε να επιστρέψετε καινούργια, μή ανοιγμένα είδη, από μία ακυρωμένη παραγγελία μέσα σε 2 εβδομάδες, αφού τα έχετε παραλάβει. Τα είδη θα πρέπει να επιστρέφονται στην αρχική τους συσκευασία.
Για περισσότερες πληροφορίες σχετικά με την ακύρωση παραγγελίας & επιστροφή ειδών, διαβάστε το <a href="%s" onclick="%s" target="_blank">Πολιτική Επιστροφών</a>.
';
	var $_PHPSHOP_ADMIN_CFG_TAX_MODE_EU = 'Μέθοδος Ευρωπαικής Ενωσης';
