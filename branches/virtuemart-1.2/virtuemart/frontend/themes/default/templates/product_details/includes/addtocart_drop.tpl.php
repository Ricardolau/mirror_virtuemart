...
<label for="product_id_field"><?php echo $VM_LANG->_( 'PHPSHOP_PLEASE_SEL_ITEM' ) ?></label>: <br />
<?php 
if( VM_CONTENT_PLUGINS_ENABLE == '1' ) { ?>
	...
	<?php } ?>
<option value="<?php echo $parent_id ?>"><?php echo $VM_LANG->_( 'PHPSHOP_SELECT' ) ?></option>
<?php 
