...
$listObj->writeSearchHeader($VM_LANG->_('VM_COUPON_LIST'), IMAGEURL."ps_image/percentage.png", $modulename, "coupon_list");
...
$columns = Array(  "#" => "width=\"20\"",
					...
					$VM_LANG->_('VM_COUPON_CODE_HEADER') => '',
					$VM_LANG->_('VM_COUPON_PERCENT_TOTAL') => '',
					$VM_LANG->_('VM_COUPON_TYPE') => '',
					$VM_LANG->_('VM_COUPON_VALUE_HEADER') => '',
					$VM_LANG->_('VM_COUPON_VALUE_VALID_AT') => '',
...
while ($db->next_record()) {
	...
	$tmp_cell = $db->f("percent_or_total")=='total' ? $VM_LANG->_('VM_COUPON_TOTAL') : $VM_LANG->_('VM_COUPON_PERCENT');
	$listObj->addCell( $tmp_cell );

    $tmp_cell = $db->f("coupon_type")=='gift' ? $VM_LANG->_('VM_COUPON_TYPE_GIFT') : $VM_LANG->_('VM_COUPON_TYPE_PERMANENT');
	$listObj->addCell( $tmp_cell );
