...
$title ='<img src="'. $mosConfig_live_site .'/administrator/images/mediamanager.png" width="48" height="48" align="center" alt="Product List" border="0" />'
		. $VM_LANG->_('VM_FILES_FORM') . ": ". $product_name ;
...
<br />
  ...
  <?php 
  	if( $file_id ) { ?>
    <tr> 
      <td class="labelcell"><?php echo $VM_LANG->_('VM_FILES_FORM_CURRENT_FILE') ?>:</td>
      <td><?php 
    ...
    <tr> 
      <td class="labelcell"><?php echo $VM_LANG->_('VM_FILES_LIST_FILENAME') ?>:</td>
      <td> 
    ...
    <tr> 
      <td class="labelcell"><?php echo $VM_LANG->_('VM_FILES_LIST_FILETYPE') ?>:</td>
      <td> 
        <select name="file_type" onchange="checkThumbnailing();" class="inputbox">
	        ...
	        <option value="product_full_image" <?php echo $selected_type[1] ?>><?php echo $VM_LANG->_('VM_PRODUCT_FORM_FULL_IMAGE') ?></option>
	        <option value="product_thumb_image" <?php echo $selected_type[2] ?>><?php echo $VM_LANG->_('VM_PRODUCT_FORM_THUMB_IMAGE') ?></option>
	        <option value="downloadable_file" <?php echo $selected_type[3] ?>><?php echo $VM_LANG->_('VM_FILES_FORM_DOWNLOADABLE') ?></option>
	        <option value="image" <?php echo $selected_type[4] ?>><?php echo $VM_LANG->_('VM_FILES_FORM_IMAGE') ?></option>
	        <option value="file" <?php echo $selected_type[5] ?>><?php echo $VM_LANG->_('VM_FILES_FORM_FILE') ?></option>
        </select>
      </td>
    </tr>
    <tr> 
      <td class="labelcell"><?php echo $VM_LANG->_('VM_FILES_FORM_UPLOAD_TO') ?>:</td>
      <td> 
        <input type="radio" class="inputbox" name="upload_dir" id="upload_dir0" checked="checked" value="IMAGEPATH" />
        <label for="upload_dir0"><?php echo $VM_LANG->_('VM_FILES_FORM_UPLOAD_IMAGEPATH') ?></label><br/><br/>
        <input type="radio" class="inputbox" name="upload_dir" id="upload_dir1" value="FILEPATH" />
        <label for="upload_dir1"><?php echo $VM_LANG->_('VM_FILES_FORM_UPLOAD_OWNPATH') ?></label>:
        ...
        <label for="upload_dir2"><?php echo $VM_LANG->_('VM_FILES_FORM_UPLOAD_DOWNLOADPATH') ?></label>
      </td>
    </tr>
    <tr> 
      <td class="labelcell">
      ...
      <td> 
        ...
        <div id="fullsizes">&nbsp;&nbsp;&nbsp;
        <?php echo $VM_LANG->_('VM_PRODUCT_FORM_HEIGHT');?>: <input type="text" name="fullimage_height" value="500" class="inputbox" />&nbsp;&nbsp;&nbsp;
        <?php echo $VM_LANG->_('VM_PRODUCT_FORM_WIDTH');?>: <input type="text" name="fullimage_width" value="500" class="inputbox" /></div>
      </td>
    </tr>
    <tr> 
      <td class="labelcell">
      		<label for="file_create_thumbnail"><?php echo $VM_LANG->_('VM_FILES_FORM_AUTO_THUMBNAIL') ?></label>
      	</td>
      <td> 
        <input type="checkbox" class="inputbox" id="file_create_thumbnail" name="file_create_thumbnail" checked="checked" value="1" />
        <div id="thumbsizes">&nbsp;&nbsp;&nbsp;
        <?php echo $VM_LANG->_('VM_PRODUCT_FORM_HEIGHT');?>: <input type="text" name="thumbimage_height" value="<?php echo PSHOP_IMG_HEIGHT ?>" class="inputbox" />&nbsp;&nbsp;&nbsp;
        <?php echo $VM_LANG->_('VM_PRODUCT_FORM_WIDTH');?>: <input type="text" name="thumbimage_width" value="<?php echo PSHOP_IMG_WIDTH ?>" class="inputbox" /></div>
        </td>
    </tr>

    <tr> 
      <td class="labelcell">
      		<label for="file_published"><?php echo $VM_LANG->_('VM_FILES_FORM_FILE_PUBLISHED') ?></label>
      	</td>
      <td> 
    ...
    <tr> 
      <td class="labelcell"><?php echo $VM_LANG->_('VM_FILES_FORM_FILE_TITLE') ?>:</td>
      <td> 
        <input type="text" class="inputbox" name="file_title" size="32" value="<?php echo shopMakeHtmlSafe( $db->sf("file_title") ) ?>" />
      </td>
    </tr>
    <tr> 
      <td class="labelcell"><?php echo $VM_LANG->_('VM_FILES_FORM_FILE_URL') ?>:</td>
      <td> 
