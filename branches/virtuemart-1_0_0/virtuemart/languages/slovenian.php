...
class vmLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_CHECKOUT_TITLE = 'Košarica';
	...
	var $_PHPSHOP_CART_SHOW = 'Pokazi košarico';
	var $_PHPSHOP_CART_ADD_TO = 'Dodaj v košarico';
	...
	var $_PHPSHOP_ORDER_BUTTON_LABEL = 'Dodaj v košarico';
	...
	var $_PHPSHOP_USER_FORM_BILLTO_LBL = 'Informacije o plaèniku';
	...
	var $_PHPSHOP_MODULE_LIST_ORDER = 'Pregled naroèil';
	...
	var $_PHPSHOP_MODULE_FORM_ORDER = 'Pregled naroèil';
	...
	var $_PHPSHOP_EMPTY_CART = 'Vasa košarica je trenutno prazna.';
	...
	var $_PHPSHOP_ORDER_LIST_ID = 'Številka narocila';
	...
	var $_PHPSHOP_ORDER_PRINT_PO_NUMBER = 'Številka narocila';
	...
	var $_PHPSHOP_ORDER_PRINT_ACCOUNT_NUMBER = 'Številka racuna';
	...
	var $_PHPSHOP_ORDER_STATUS_FORM_MNU = 'Dodaj tip naroèila';
	...
	var $_PHPSHOP_PRODUCT_INVENTORY_STOCK = 'Številka';
	...
	var $_PHPSHOP_ATTRIBUTE_LIST_ORDER = 'Košarica';
	...
	var $_PHPSHOP_ATTRIBUTE_FORM_ORDER = 'Košarica';
	...
	var $_PHPSHOP_PAYMENT_METHOD_LIST_MNU = 'Naèin plaèila';
	var $_PHPSHOP_PAYMENT_METHOD_LIST_LBL = 'Seznam plaèil';
	...
	var $_PHPSHOP_PAYMENT_METHOD_LIST_ENABLE_PROCESSOR = 'Naèin plaèila';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_MNU = 'Dodaj naèin plaèila';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_LBL = 'Obrazec za naèin plaèila';
	...
	var $_PHPSHOP_PAYMENT_METHOD_FORM_LIST_ORDER = 'Seznam naroèil';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_ENABLE_PROCESSOR = 'Tip plaèilnih metod';
	...
	var $_PHPSHOP_MANUFACTURER_FORM_INFO_LBL = 'Proizvajalèeve informacije';
	...
	var $_PHPSHOP_MANUFACTURER_CAT_LIST_MNU = 'Seznam proizvajalèevih kategorij';
	var $_PHPSHOP_MANUFACTURER_CAT_LIST_LBL = 'Preglej proizvajalèev seznam';
	...
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_MNU = 'Dodaj proizvajalèevo kategorijo';
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_LBL = 'Obrazec proizvajalèeve kategorije';
	...
	var $_PHPSHOP_PRODUCT_CALL = 'Poklièi za ceno';
	...
	var $_PHPSHOP_CHECKOUT_CONF_BILLINFO = 'Informacije o plaèniku';
	...
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO = 'Informacije o plaèilu';
	...
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_REQINFO = 'Zahtevane informacije ko je izbran naèin plaèila s kreditno kartico';
	...
	var $_PHPSHOP_RETURN_LOGIN = 'Že obstojeèa stranka: Prsim prijavite se';
	var $_PHPSHOP_NEW_CUSTOMER = 'Nov? Prosimo izpolnite spodnji obrazec';
	var $_PHPSHOP_ACC_CUSTOMER_ACCOUNT = 'Raèun kupca:';
	var $_PHPSHOP_ACC_ORDER_INFO = 'Informacije o naroèilu';
	var $_PHPSHOP_ACC_UPD_BILL = 'Tukaj lahko posodobite vaše podatke.';
	var $_PHPSHOP_ACC_UPD_SHIP = 'Tukaj lahko dodate naslov dostave.';
	var $_PHPSHOP_ACC_ACCOUNT_INFO = 'Informacije o raèunu';
	var $_PHPSHOP_ACC_SHIP_INFO = 'Informacije o dostavi';
	var $_PHPSHOP_ACC_NO_ORDERS = 'Brez naroèil';
	var $_PHPSHOP_ACC_BILL_DEF = '- Enako kot naslov placnika';
	var $_PHPSHOP_SHIPTO_TEXT = 'Lahko dodate naslov dostave k vašem raèunu. Please think of a suitable nickname or code for the shipping location you select below.';
	...
	var $_PHPSHOP_RATE_FORM_COUNTRY = 'Drzava<br>Veèizbor uporabi STRG-tipko ter misko';
	...
	var $_PHPSHOP_PAYMENT_FORM_BANK_DEBIT = 'Banèni depozit';
	var $_PHPSHOP_PAYMENT_FORM_AO = 'Plaèilo po povzetju';
	var $_PHPSHOP_CHECKOUT_MSG_2 = 'Prosimo izberite naslov dostave!';
	var $_PHPSHOP_CHECKOUT_MSG_3 = 'Prosimo izberite naèin dostave!';
	var $_PHPSHOP_CHECKOUT_MSG_4 = 'Prosimo izberite naèin plaèila!';
	var $_PHPSHOP_CHECKOUT_MSG_99 = 'Prosimo preglejte podatke in potrdite naroèilo!';
	var $_PHPSHOP_CHECKOUT_ERR_NO_SHIP = 'Prosim izberite naèin dostave.';
	var $_PHPSHOP_CHECKOUT_ERR_OTHER_SHIP = 'Prosim izberite drug naèin dostave.';
	...
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCDATE = 'Številka kreditne kartice je neveljavna.';
	...
	var $_PHPSHOP_CHECKOUT_ERR_MIN_POV = 'Minimalen znesek naroèila se ni dosezen.';
	var $_PHPSHOP_CHECKOUT_ERR_MIN_POV2 = 'Minimalen znesek naroèila je:';
	...
	var $_PHPSHOP_ORDER_PRINT_CUSTOMER_NOTE = 'Kupèevo sporoèilo';
	var $_PHPSHOP_INCLUDING_TAX = '(Vkljuèen 20% davek)';
	...
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER1 = 'Hvala, ker ste se odloèili za nakup v nasi spletni poslovalnici.  Vasi podatki so naslednji.';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER2 = 'Hvala za nakup! Se priporoèamo.';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER3 = 'Vprasanja? Problemi?';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER4 = 'Naslednje naroèilo je bilo sprejeto.';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER5 = 'Preglejte naroèilo tako, da kliknete na sledeèo povezavo.';
	var $_PHPSHOP_CART_ERROR_NO_NEGATIVE = 'Negativna kolièina ni dovoljena.';
	var $_PHPSHOP_CART_ERROR_NO_VALID_QUANTITY = 'Prosim vnesite veljavno kolièino za ta izdelek.';
	...
	var $_PHPSHOP_CART_STOCK_3 = 'Kliknite tukaj, da vas uvrstimo na èakalno listo.';
	...
	var $_PHPSHOP_AFFILIATE_LIST_ORDERS = 'Preglej naroèila';
	...
	var $_PHPSHOP_AFFILIATE_EMAIL_STATS = 'Vkljuèuje trenutno statistiko';
	...
	var $_PHPSHOP_MORE_CATEGORIES = 'veè kategorij';
