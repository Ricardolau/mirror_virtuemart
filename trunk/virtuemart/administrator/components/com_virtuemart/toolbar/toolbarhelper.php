...
abstract class vToolBarHelper
{
	...
	public static function title($title, $icon = 'generic.png') {
		...
		$doc->setTitle($app->getCfg('sitename'). ' - ' .vmText::_('JADMINISTRATION').' - '.$title);
	}
...
abstract class vSubMenuHelper
{
	...
	{
		$menu = vToolBar::getInstance('submenu');
