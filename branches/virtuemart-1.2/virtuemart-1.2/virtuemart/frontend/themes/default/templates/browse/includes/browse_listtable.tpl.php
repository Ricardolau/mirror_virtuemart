...
// Table header
$tableheader[] = $VM_LANG->_('VM_CART_NAME');
$tableheader[] = $VM_LANG->_('VM_CART_SKU');
if( _SHOW_PRICES && $auth['show_prices'] ) {
	$tableheader[] = $VM_LANG->_('VM_CART_PRICE');
}
$tableheader[] = $VM_LANG->_('VM_PRODUCT_FORM_THUMB_IMAGE');
$tableheader[] = $VM_LANG->_('VM_PRODUCT_DESC_TITLE');
if( _SHOW_PRICES && $auth['show_prices'] && USE_AS_CATALOGUE != '1' ) {
	$tableheader[] = $VM_LANG->_('VM_CART_ACTION');
}
