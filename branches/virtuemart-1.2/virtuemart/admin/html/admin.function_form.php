...
$formObj = &new formFactory( $VM_LANG->_('VM_FUNCTION_FORM_LBL') );
//Then Start the form
$formObj->startForm();
?> 
  <table class="adminform">
    ...
    <tr> 
      <td width="24%" align="right"><?php echo $VM_LANG->_('VM_FUNCTION_FORM_NAME') ?>:</td>
      <td width="76%"> 
        <input type="text" class="inputbox" name="function_name" value="<?php $db->sp("function_name") ?>" />
      </td>
    </tr>
    <tr> 
      <td width="24%" align="right"><?php echo $VM_LANG->_('VM_FUNCTION_FORM_CLASS') ?>:</td>
      <td width="76%"> 
        <?php echo $ps_module->list_classes( 'function_class', $db->sf("function_class") ) ?>
      </td>
    </tr>
    <tr> 
      <td width="24%" align="right"><?php echo $VM_LANG->_('VM_FUNCTION_FORM_METHOD') ?>:</td>
      <td width="76%">
    ...
    <tr> 
      <td width="24%" align="right"><?php echo $VM_LANG->_('VM_FUNCTION_FORM_PERMS') ?>:</td>
      <td width="76%"> 
    ...
    <tr> 
      <td valign="top" align="right"><?php echo $VM_LANG->_('VM_FUNCTION_FORM_DESCRIPTION') ?>:</td>
      <td valign="top">&nbsp;</td>
    </tr>
    <tr align="center"> 
