...
/**
*
* @version $Id: ps_product_category.php 1760 2009-05-03 22:58:57Z Aravot $
* @package VirtueMart
* @subpackage classes
	...
	*/
	...
	function traverse_tree_down($class="",$category_id="0", $level="0") {
		...
		while ($db->next_record()) {
			...
			echo " onclick=\"return confirm('". addslashes($VM_LANG->_('VM_DELETE_MSG')) ."');\" onmouseout=\"MM_swapImgRestore();\"  onmouseover=\"MM_swapImage('Delete$ibg','','". IMAGEURL ."ps_image/delete_f2.gif',1);\">";
	...
	function list_category($product_id="",$category_id="",$name = "category_id") {
		...
		if ($product_id and !$category_id) {
			...
			$db->next_record();
			if (!$db->f("category_id")) {
				echo "<option value=\"0\">".$VM_LANG->_('VM_SELECT')."</option>\n";
			}
