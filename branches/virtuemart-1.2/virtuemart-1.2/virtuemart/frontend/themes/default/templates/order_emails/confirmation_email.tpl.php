...
<html>
<head>
<title><?php echo $VM_LANG->_('VM_ORDER_PRINT_PO_LBL') ?></title>
<style type="text/css">
<!--
.Stil1 {
...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="10">
  ...
  <tr bgcolor="white"> 
    <td colspan="2">
      <h3 class="Stil2"><?php echo $VM_LANG->_('VM_ORDER_PRINT_PO_LBL') ?></h3>
    </td>
  </tr>
</table>
...
<table border=0 cellspacing=0 cellpadding=2 width=100%>
  ...
  <tr bgcolor="#CCCCCC" class="sectiontableheader"> 
    <td colspan="2" class="Stil2"><b><?php echo $VM_LANG->_('VM_ACC_ORDER_INFO') ?></b></td>
  </tr>
  <tr class="Stil1"> 
    <td><?php echo $VM_LANG->_('VM_ORDER_PRINT_PO_NUMBER')?>:</td><td><?php echo $order_id ?></td>
  </tr>
   
  <tr class="Stil1"> 
    <td><?php echo $VM_LANG->_('VM_ORDER_PRINT_PO_DATE') ?>:</td><td><?php echo $order_date ?></td>
  </tr>
  <tr class="Stil1"> 
    <td><?php echo $VM_LANG->_('VM_ORDER_PRINT_PO_STATUS') ?>:</td><td><?php echo $order_status ?></td>
  </tr>
  ...
  <tr bgcolor="#CCCCCC" class="sectiontableheader"> 
    <td colspan="2"><b class="Stil2"><?php echo $VM_LANG->_('VM_ORDER_PRINT_CUST_INFO_LBL') ?></b></td>
  </tr>
  <tr valign=top> 
    ...
    <!-- begin shipto -->  
      <table width=100% border=0 cellpadding=2 cellspacing=0 class="Stil1">
        <tr> 
          <td colspan="2"><b><?php echo $VM_LANG->_('VM_ORDER_PRINT_SHIP_TO_LBL') ?></b></td>
        </tr>
     <?php
  ...
  <tr bgcolor="#CCCCCC" class="Stil2"> 
    <td colspan="2"><b><?php echo $VM_LANG->_('VM_ORDER_ITEM') ?></b></td>
  </tr>
  <tr> 
    <td colspan="2"> 
      <table width=100% cellspacing=0 cellpadding=2 border=0>
...
?> 
		...
		if ( PAYMENT_DISCOUNT_BEFORE == '1') {
			...
			if ($coupon_discount > 0 || $coupon_discount < 0) {
				?>
				<tr class="Stil1">
					<td align="right" colspan="4"><?php echo $VM_LANG->_('VM_COUPON_DISCOUNT') ?>: </td>
		...
		?>
        <tr class="Stil1"> 
          <td colspan=4 align=right><b><?php echo $VM_LANG->_('VM_CART_TOTAL') .": " ?></b></td>
  ...
  <tr bgcolor="#CCCCCC" class="sectiontableheader">
    <td colspan="2"><b class="Stil2"><?php echo $VM_LANG->_('VM_ORDER_PRINT_CUSTOMER_NOTE') ?>:</b></td>
  </tr>
  <tr>
    <td colspan="2">
...
if( $is_email_to_shopper ) {
	$footer_html = "<br /><br />".$VM_LANG->_('VM_CHECKOUT_EMAIL_SHOPPER_HEADER2')."<br />";
	
	if( VM_REGISTRATION_TYPE != 'NO_REGISTRATION' ) {
		$footer_html .= "<br /><a title=\"".$VM_LANG->_('VM_CHECKOUT_EMAIL_SHOPPER_HEADER5')."\" href=\"$order_link\">"
		. $VM_LANG->_('VM_CHECKOUT_EMAIL_SHOPPER_HEADER5')."</a>";
	}
	$footer_html .= "<br /><br />".$VM_LANG->_('VM_CHECKOUT_EMAIL_SHOPPER_HEADER3')."<br />";
	...
	$footer_html = '<br /><br /><a title="'.$VM_LANG->_('VM_CHECKOUT_EMAIL_SHOPPER_HEADER5').'" href="'.$order_link.'">'
		. $VM_LANG->_('VM_CHECKOUT_EMAIL_SHOPPER_HEADER5').'</a>';
}
echo $footer_html;
?>
