...
class vmLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_ADMIN = 'Kerfisstjórn';
	var $_PHPSHOP_PRODUCT = 'Vara';
	var $_PHPSHOP_LIST = 'Sýna';
	var $_PHPSHOP_ALL = 'Allar';
	var $_PHPSHOP_LIST_ALL_PRODUCTS = 'Sýna allar vörur';
	var $_PHPSHOP_VIEW = 'skoða';
	var $_PHPSHOP_SHOW = 'sýna';
	var $_PHPSHOP_ADD = 'bæta við';
	var $_PHPSHOP_UPDATE = 'uppfæra';
	var $_PHPSHOP_DELETE = 'eyða';
	var $_PHPSHOP_SELECT = 'velja';
	var $_PHPSHOP_SUBMIT = 'Submit';
	var $_PHPSHOP_RANDOM = 'Vörur af handahófi';
	var $_PHPSHOP_LATEST = 'Nýjustu vörurnar';
	var $_PHPSHOP_HOME_TITLE = 'Heim';
	var $_PHPSHOP_CART_TITLE = 'Karfa';
	var $_PHPSHOP_CHECKOUT_TITLE = 'Ganga frá';
	var $_PHPSHOP_LOGIN_TITLE = 'Skrá inn';
	var $_PHPSHOP_LOGOUT_TITLE = 'Skrá út';
	var $_PHPSHOP_BROWSE_TITLE = 'Skoða';
	var $_PHPSHOP_SEARCH_TITLE = 'Leita';
	var $_PHPSHOP_ACCOUNT_TITLE = 'Umsjón skráningar';
	var $_PHPSHOP_NAVIGATION_TITLE = 'Stýring';
	var $_PHPSHOP_DEPARTMENT_TITLE = 'Deild';
	var $_PHPSHOP_INFO = 'Upplýsingar';
	var $_PHPSHOP_BROWSE_LBL = 'Browse';
	var $_PHPSHOP_PRODUCTS_LBL = 'Vörur';
	var $_PHPSHOP_PRODUCT_LBL = 'Vara';
	var $_PHPSHOP_SEARCH_LBL = 'Leita';
	var $_PHPSHOP_FLYPAGE_LBL = 'Nánari lýsing';
	var $_PHPSHOP_PRODUCT_SEARCH_LBL = 'Vöruleit';
	var $_PHPSHOP_PRODUCT_NAME_TITLE = 'Vörunafn';
	var $_PHPSHOP_PRODUCT_CATEGORY_TITLE = 'Vöruflokkur';
	var $_PHPSHOP_PRODUCT_DESC_TITLE = 'Lýsing';
	var $_PHPSHOP_CART_SHOW = 'Sýna körfu';
	var $_PHPSHOP_CART_ADD_TO = 'Kaupa';
	var $_PHPSHOP_CART_NAME = 'Nafn';
	var $_PHPSHOP_CART_SKU = 'LagerNR:';
	var $_PHPSHOP_CART_PRICE = 'Verð';
	var $_PHPSHOP_CART_QUANTITY = 'Fjöldi';
	var $_PHPSHOP_CART_SUBTOTAL = 'Samtals';
	var $_PHPSHOP_ADD_SHIPTO_1 = 'Bæta við';
	var $_PHPSHOP_ADD_SHIPTO_2 = 'Móttakandi';
	var $_PHPSHOP_NO_SEARCH_RESULT = 'Leitin skilaði 0 niðurstöðum.<br />';
	var $_PHPSHOP_PRICE_LABEL = 'Verð: ';
	var $_PHPSHOP_ORDER_BUTTON_LABEL = 'Setja í körfu';
	var $_PHPSHOP_NO_CUSTOMER = 'Þú ert ekki skráður notandi. Settu inn upplýsingar fyrir greiðslu.';
	var $_PHPSHOP_DELETE_MSG = 'Ertu viss um að þú viljir eyða þessu?';
	var $_PHPSHOP_THANKYOU = 'þakka þér fyrir að versla við 24/7.';
	var $_PHPSHOP_NOT_SHIPPED = 'Hefur ekki verið sent enþá';
	var $_PHPSHOP_EMAIL_SENDTO = 'Staðfesting hefur verið send á netfangið';
	var $_PHPSHOP_NO_USER_TO_SELECT = 'Því miður er engin MOS - notandi sem þú getur bætt við com_phpshop notendalistann';
	var $_PHPSHOP_ERROR = 'Villa';
	var $_PHPSHOP_MOD_NOT_REG = 'Module Ekki skráð ';
	var $_PHPSHOP_MOD_ISNO_REG = 'er ekki viðurkennt phpShop module.';
	var $_PHPSHOP_MOD_NO_AUTH = 'Þú hefur ekki leyfi til að nota þetta module.';
	var $_PHPSHOP_PAGE_404_1 = 'Síða ekki til';
	var $_PHPSHOP_PAGE_404_2 = 'Skrárnafn ekki til. Finn ekki skránna:';
	var $_PHPSHOP_PAGE_403 = 'Ekki nægileg réttindi';
	var $_PHPSHOP_FUNC_NO_EXEC = 'Þú hefur ekki réttindi til að ræsa ';
	var $_PHPSHOP_FUNC_NOT_REG = 'Aðgerð ekki skráð';
	var $_PHPSHOP_FUNC_ISNO_REG = ' er ekki viðurkennd_com_phpShop aðgerð.';
	var $_PHPSHOP_ADMIN_MOD = 'Kerfisstjórn';
	var $_PHPSHOP_USER_LIST_MNU = 'Sýna notendur';
	...
	var $_PHPSHOP_MODULE_LIST_FUNCTIONS = 'Aðgerðir';
	var $_PHPSHOP_MODULE_LIST_ORDER = 'Lista röð';
	var $_PHPSHOP_MODULE_FORM_MNU = 'Bæta við Module';
	var $_PHPSHOP_MODULE_FORM_LBL = 'Upplýsingar Module';
	...
	var $_PHPSHOP_MODULE_FORM_MENU = 'Sýna Module í valmynd kerfisstjórnar?';
	var $_PHPSHOP_MODULE_FORM_ORDER = 'Röðun glugga';
	var $_PHPSHOP_MODULE_FORM_DESCRIPTION = 'Module Lýsing';
	var $_PHPSHOP_MODULE_FORM_LANGUAGE_CODE = 'Kóði tungumáls';
	var $_PHPSHOP_MODULE_FORM_LANGUAGE_file = 'Tungumála skrá';
	var $_PHPSHOP_FUNCTION_LIST_MNU = 'Sýna aðgerðir';
	var $_PHPSHOP_FUNCTION_LIST_LBL = 'Aðgerðar listi';
	var $_PHPSHOP_FUNCTION_LIST_NAME = 'Function Name';
	var $_PHPSHOP_FUNCTION_LIST_CLASS = 'Class Nafn';
	var $_PHPSHOP_FUNCTION_LIST_METHOD = 'Class Aðferð';
	var $_PHPSHOP_FUNCTION_LIST_PERMS = 'Leyfi';
	var $_PHPSHOP_FUNCTION_FORM_MNU = 'Bæta við aðgerð';
	var $_PHPSHOP_FUNCTION_FORM_LBL = 'Upplýsingar um aðgerð';
	var $_PHPSHOP_FUNCTION_FORM_NAME = 'Nafn aðgerðar';
	var $_PHPSHOP_FUNCTION_FORM_CLASS = 'Class Nafn';
	var $_PHPSHOP_FUNCTION_FORM_METHOD = 'Class aðferð';
	var $_PHPSHOP_FUNCTION_FORM_PERMS = 'Function leyfi';
	var $_PHPSHOP_FUNCTION_FORM_DESCRIPTION = 'aðgerð';
	var $_PHPSHOP_CURRENCY_LIST_MNU = 'Sýna gjaldmiðla';
	var $_PHPSHOP_CURRENCY_LIST_LBL = 'Listi yfir gjaldmiðla';
	var $_PHPSHOP_CURRENCY_LIST_ADD = 'Bæta við gjaldmiðli';
	var $_PHPSHOP_CURRENCY_LIST_NAME = 'Nafn gjaldmiðils';
	var $_PHPSHOP_CURRENCY_LIST_CODE = 'Kóði fyrir gjaldmiðil';
	var $_PHPSHOP_COUNTRY_LIST_MNU = 'Sýna lönd';
	var $_PHPSHOP_COUNTRY_LIST_LBL = 'Listi yfir lönd';
	var $_PHPSHOP_COUNTRY_LIST_ADD = 'Bæta við landi';
	...
	var $_PHPSHOP_CONTINUE = 'Áfram';
	var $_PHPSHOP_EMPTY_CART = 'Karfan þín er tóm.';
	...
	var $_PHPSHOP_ISSHIP_LIST_MNU = 'Sýna afhendingarmáta';
	var $_PHPSHOP_ISSHIP_LIST_LBL = 'Virkar afhendingar';
	var $_PHPSHOP_ISSHIP_LIST_CARRIER_LBL = 'Afhendingarmátar';
	var $_PHPSHOP_ISSHIP_LIST_PUBLISH_LBL = 'Virkur';
	var $_PHPSHOP_ISSHIP_LIST_RATE_LBL = 'Sendingarkostnaður';
	var $_PHPSHOP_ISSHIP_LIST_LEAD_LBL = 'Afhendingartími';
	...
	var $_PHPSHOP_ISSHIP_LIST_HEAVY_LBL = 'Þyngri vörur';
	var $_PHPSHOP_ISSHIP_FORM_MNU = 'Stilla afhendingarmáta';
	var $_PHPSHOP_ISSHIP_FORM_ADD_LBL = 'Bæta við afhendingarmáta';
	var $_PHPSHOP_ISSHIP_FORM_UPDATE_LBL = 'Stilla afhendingarmáta';
	var $_PHPSHOP_ISSHIP_FORM_REFRESH_LBL = 'Endurraða';
	var $_PHPSHOP_ISSHIP_FORM_CARRIER_LBL = 'Afhendingarmáti';
	var $_PHPSHOP_ISSHIP_FORM_PUBLISH_LBL = 'Virkja';
	var $_PHPSHOP_ISSHIP_FORM_HANDLING_LBL = 'Sendingarkostnaður';
	var $_PHPSHOP_ISSHIP_FORM_LEAD_LBL = 'Afhendingartími';
	...
	var $_PHPSHOP_ISSHIP_FORM_HEAVY_LBL = 'Þyngri vörur';
	var $_PHPSHOP_ORDER_MOD = 'Pantanir';
	var $_PHPSHOP_ORDER_CONFIRM_MNU = 'Staðfesta pöntun';
	var $_PHPSHOP_ORDER_CANCEL_MNU = 'Hætta við pöntun';
	var $_PHPSHOP_ORDER_PRINT_MNU = 'Prenta';
	var $_PHPSHOP_ORDER_DELETE_MNU = 'Eyða pöntun';
	var $_PHPSHOP_ORDER_LIST_MNU = 'Sýna pantanir';
	var $_PHPSHOP_ORDER_LIST_LBL = 'Listi yfir pantanir';
	var $_PHPSHOP_ORDER_LIST_ID = 'Pöntun NR:';
	var $_PHPSHOP_ORDER_LIST_CDATE = 'Dags pöntunar';
	var $_PHPSHOP_ORDER_LIST_MDATE = 'Síðast breytt';
	var $_PHPSHOP_ORDER_LIST_STATUS = 'Staða';
	var $_PHPSHOP_ORDER_LIST_TOTAL = 'Samtals';
	var $_PHPSHOP_ORDER_ITEM = 'Pöntun';
	var $_PHPSHOP_ORDER_PRINT_PO_LBL = 'Pöntun';
	var $_PHPSHOP_ORDER_PRINT_PO_NUMBER = 'Pöntun NR:';
	var $_PHPSHOP_ORDER_PRINT_PO_DATE = 'Dags pöntunar';
	var $_PHPSHOP_ORDER_PRINT_PO_STATUS = 'Staða pöntunar';
	var $_PHPSHOP_ORDER_PRINT_CUST_INFO_LBL = 'Upplýsingar um viðskiptamann';
	var $_PHPSHOP_ORDER_PRINT_CUST_BILLING_LBL = 'Upplýsingar um greiðslu';
	var $_PHPSHOP_ORDER_PRINT_CUST_SHIPPING_LBL = 'Upplýsingar um afhendingu';
	var $_PHPSHOP_ORDER_PRINT_BILL_TO_LBL = 'Greiðist af';
	var $_PHPSHOP_ORDER_PRINT_SHIP_TO_LBL = 'Sendist til';
	var $_PHPSHOP_ORDER_PRINT_NAME = 'Nafn';
	var $_PHPSHOP_ORDER_PRINT_COMPANY = 'Fyrirtæki';
	var $_PHPSHOP_ORDER_PRINT_ADDRESS_1 = 'Heimilisfang 1';
	var $_PHPSHOP_ORDER_PRINT_ADDRESS_2 = 'Heimilisfang 2';
	var $_PHPSHOP_ORDER_PRINT_CITY = 'Staður';
	var $_PHPSHOP_ORDER_PRINT_STATE = 'State/Province/Region';
	var $_PHPSHOP_ORDER_PRINT_ZIP = 'Póstnúmer';
	var $_PHPSHOP_ORDER_PRINT_COUNTRY = 'Land';
	var $_PHPSHOP_ORDER_PRINT_PHONE = 'Sími';
	var $_PHPSHOP_ORDER_PRINT_FAX = 'Fax';
	var $_PHPSHOP_ORDER_PRINT_EMAIL = 'Netfang';
	var $_PHPSHOP_ORDER_PRINT_ITEMS_LBL = 'Hlutir á pöntun';
	var $_PHPSHOP_ORDER_PRINT_QUANTITY = 'Fjöldi';
	var $_PHPSHOP_ORDER_PRINT_QTY = 'Fjöldi';
	var $_PHPSHOP_ORDER_PRINT_SKU = 'LagerNR:';
	var $_PHPSHOP_ORDER_PRINT_PRICE = 'Verð';
	var $_PHPSHOP_ORDER_PRINT_TOTAL = 'Alls';
	var $_PHPSHOP_ORDER_PRINT_SUBTOTAL = 'Samtals';
	var $_PHPSHOP_ORDER_PRINT_TOTAL_TAX = 'VSK';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING = 'Sendingarkostnaður';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_TAX = 'VSK sending';
	var $_PHPSHOP_ORDER_PRINT_PAYMENT_LBL = 'Greiðslumáti';
	...
	var $_PHPSHOP_ORDER_PRINT_PAYMENT_LOG_LBL = 'Greiðslu yfirlit';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_LBL = 'Yfirlit sendingar';
	var $_PHPSHOP_ORDER_PRINT_PAYINFO_LBL = 'Upplýsingar um greiðslu';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_CARRIER_LBL = 'Sent með';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_MODE_LBL = 'Afhendingarmáti';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_DATE_LBL = 'Dags afhendingar';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_PRICE_LBL = 'Afhendingarkostnaður';
	var $_PHPSHOP_ORDER_STATUS_LIST_MNU = 'Sýna virkar stöður pöntunar';
	var $_PHPSHOP_ORDER_STATUS_FORM_MNU = 'Bæta við virkri stöðu';
	var $_PHPSHOP_ORDER_STATUS_LIST_CODE = 'Kóði stöðu';
	var $_PHPSHOP_ORDER_STATUS_LIST_NAME = 'Nafn stöðu';
	var $_PHPSHOP_ORDER_STATUS_FORM_LBL = 'Staða pöntunar';
	var $_PHPSHOP_ORDER_STATUS_FORM_CODE = 'Kóði stöðu';
	var $_PHPSHOP_ORDER_STATUS_FORM_NAME = 'Nafn stöðu';
	var $_PHPSHOP_ORDER_STATUS_FORM_LIST_ORDER = 'Sýna röð';
	var $_PHPSHOP_PRODUCT_MOD = 'Vörur';
	var $_PHPSHOP_CURRENT_PRODUCT = 'Valin vara';
	var $_PHPSHOP_CURRENT_ITEM = 'hlutur';
	var $_PHPSHOP_PRODUCT_INVENTORY_LBL = 'Birgðastaða';
	var $_PHPSHOP_PRODUCT_INVENTORY_MNU = 'Skoða byrgðastöðu';
	var $_PHPSHOP_PRODUCT_INVENTORY_PRICE = 'Verð';
	var $_PHPSHOP_PRODUCT_INVENTORY_STOCK = 'Númer';
	var $_PHPSHOP_PRODUCT_INVENTORY_WEIGHT = 'Þyngd';
	var $_PHPSHOP_PRODUCT_LIST_MNU = 'Sýna vörur';
	var $_PHPSHOP_PRODUCT_LIST_LBL = 'Vörulisti';
	var $_PHPSHOP_PRODUCT_LIST_NAME = 'Nafn vöru';
	var $_PHPSHOP_PRODUCT_LIST_SKU = 'LagerNR:';
	var $_PHPSHOP_PRODUCT_LIST_PUBLISH = 'Sýna';
	...
	var $_PHPSHOP_PRODUCT_FORM_MNU = 'Bæta við vöru';
	var $_PHPSHOP_PRODUCT_FORM_EDIT_PRODUCT = 'Breyta vöru';
	var $_PHPSHOP_PRODUCT_FORM_SHOW_FLYPAGE = 'Forskoða í verslun';
	var $_PHPSHOP_PRODUCT_FORM_ADD_ITEM_MNU = 'Bæta við';
	var $_PHPSHOP_PRODUCT_FORM_ADD_ANOTHER_ITEM_MNU = 'Bæta við aftur';
	var $_PHPSHOP_PRODUCT_FORM_NEW_PRODUCT_LBL = 'Ný vara';
	var $_PHPSHOP_PRODUCT_FORM_UPDATE_PRODUCT_LBL = 'Uppfæra vöru';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_INFO_LBL = 'Upplýsingar um vöru';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_STATUS_LBL = 'Staða vöru';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_DIM_WEIGHT_LBL = 'Stærð og þyngd vöru';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_IMAGES_LBL = 'Myndir fyrir vöru';
	var $_PHPSHOP_PRODUCT_FORM_NEW_ITEM_LBL = 'Nýr hlutur';
	var $_PHPSHOP_PRODUCT_FORM_UPDATE_ITEM_LBL = 'Uppfæra hlut';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_INFO_LBL = 'Upplýsingar um hlut';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_STATUS_LBL = 'Staða';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_DIM_WEIGHT_LBL = 'Stærð og þyngd';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_IMAGES_LBL = 'Myndir';
	var $_PHPSHOP_PRODUCT_FORM_RETURN_LBL = 'Bakka til vöru';
	var $_PHPSHOP_PRODUCT_FORM_IMAGE_UPDATE_LBL = 'Til að uppfæra myndina, sláðu inn slóðina að myndinni.';
	var $_PHPSHOP_PRODUCT_FORM_IMAGE_DELETE_LBL = 'Skrifaðu ';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_ITEMS_LBL = 'Fylgihlutir';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_ATTRIBUTES_LBL = 'Stillingar vöru';
	var $_PHPSHOP_PRODUCT_FORM_DELETE_PRODUCT_MSG = 'Ertu viss um að vilja eyða þssari vöru\\nog hlutunum sem fylgja henni?';
	var $_PHPSHOP_PRODUCT_FORM_DELETE_ITEM_MSG = 'Ertu viss um að vilja eyða myndinni?';
	var $_PHPSHOP_PRODUCT_FORM_VENDOR = 'Söluaðili';
	var $_PHPSHOP_PRODUCT_FORM_MANUFACTURER = 'Framleiðandi';
	var $_PHPSHOP_PRODUCT_FORM_SKU = 'LagerNR:';
	var $_PHPSHOP_PRODUCT_FORM_NAME = 'Nafn';
	var $_PHPSHOP_PRODUCT_FORM_URL = 'Slóð';
	...
	var $_PHPSHOP_PRODUCT_FORM_DESCRIPTION = 'Lýsing á síðu';
	var $_PHPSHOP_PRODUCT_FORM_S_DESC = 'Stutt lýsing';
	var $_PHPSHOP_PRODUCT_FORM_IN_STOCK = 'Á lager';
	var $_PHPSHOP_PRODUCT_FORM_ON_ORDER = 'Í pöntun';
	var $_PHPSHOP_PRODUCT_FORM_AVAILABLE_DATE = 'Verður til þann';
	var $_PHPSHOP_PRODUCT_FORM_SPECIAL = 'Á tilboði';
	var $_PHPSHOP_PRODUCT_FORM_DISCOUNT_TYPE = 'Afláttur gerð';
	var $_PHPSHOP_PRODUCT_FORM_PUBLISH = 'Sýna?';
	var $_PHPSHOP_PRODUCT_FORM_LENGTH = 'Lengd';
	var $_PHPSHOP_PRODUCT_FORM_WIDTH = 'Breidd';
	var $_PHPSHOP_PRODUCT_FORM_HEIGHT = 'Hæð';
	var $_PHPSHOP_PRODUCT_FORM_DIMENSION_UOM = 'Mælieining';
	var $_PHPSHOP_PRODUCT_FORM_WEIGHT = 'Þyngd';
	var $_PHPSHOP_PRODUCT_FORM_WEIGHT_UOM = 'Mælieining';
	var $_PHPSHOP_PRODUCT_FORM_THUMB_IMAGE = 'Smá mynd';
	var $_PHPSHOP_PRODUCT_FORM_FULL_IMAGE = 'Stór mynd';
	...
	var $_PHPSHOP_PRODUCT_DISPLAY_ADD_PRODUCT_LBL = 'Vöru var bætt inn';
	var $_PHPSHOP_PRODUCT_DISPLAY_UPDATE_PRODUCT_LBL = 'Staða uppfærslu';
	var $_PHPSHOP_PRODUCT_DISPLAY_ADD_ITEM_LBL = 'Staða uppfærslu';
	var $_PHPSHOP_PRODUCT_DISPLAY_UPDATE_ITEM_LBL = 'Staða uppfærslu';
	var $_PHPSHOP_PRODUCT_CSV_UPLOAD = 'Upphala CSV';
	var $_PHPSHOP_PRODUCT_FOLDERS = 'Mappa vöru';
	var $_PHPSHOP_CATEGORY_LIST_MNU = 'Sýna flokka';
	var $_PHPSHOP_CATEGORY_LIST_LBL = 'Tré flokka';
	var $_PHPSHOP_CATEGORY_FORM_MNU = 'Bæta inn flokk';
	var $_PHPSHOP_CATEGORY_FORM_LBL = 'Upplýsingar um flokk';
	var $_PHPSHOP_CATEGORY_FORM_NAME = 'Nafn flokks';
	var $_PHPSHOP_CATEGORY_FORM_PARENT = 'Fyrir neðan';
	var $_PHPSHOP_CATEGORY_FORM_DESCRIPTION = 'Lýsing flokks';
	var $_PHPSHOP_CATEGORY_FORM_PUBLISH = 'Sýna?';
	var $_PHPSHOP_CATEGORY_FORM_FLYPAGE = 'Sýða flokks';
	var $_PHPSHOP_ATTRIBUTE_LIST_MNU = 'Sýna merki';
	var $_PHPSHOP_ATTRIBUTE_LIST_LBL = 'Listi yfir merki';
	var $_PHPSHOP_ATTRIBUTE_LIST_NAME = 'Nafn merkis';
	var $_PHPSHOP_ATTRIBUTE_LIST_ORDER = 'Sýna eftir';
	var $_PHPSHOP_ATTRIBUTE_FORM_MNU = 'Bæta við merki';
	var $_PHPSHOP_ATTRIBUTE_FORM_LBL = 'Merki forms';
	var $_PHPSHOP_ATTRIBUTE_FORM_NEW_FOR_PRODUCT = 'Nýtt merki fyrir vöru';
	var $_PHPSHOP_ATTRIBUTE_FORM_UPDATE_FOR_PRODUCT = 'Uppfæra merki';
	var $_PHPSHOP_ATTRIBUTE_FORM_NEW_FOR_ITEM = 'Nýtt merki fyrir vöru';
	var $_PHPSHOP_ATTRIBUTE_FORM_UPDATE_FOR_ITEM = 'Uppfæra merki';
	var $_PHPSHOP_ATTRIBUTE_FORM_NAME = 'Nafn merkis';
	var $_PHPSHOP_ATTRIBUTE_FORM_ORDER = 'Sýna eftir';
	var $_PHPSHOP_PRICE_LIST_MNU = 'Sýna flokka';
	var $_PHPSHOP_PRICE_LIST_LBL = 'Verð tré';
	var $_PHPSHOP_PRICE_LIST_FOR_LBL = 'Verð fyrir';
	var $_PHPSHOP_PRICE_LIST_GROUP_NAME = 'Nafn hóps';
	var $_PHPSHOP_PRICE_LIST_PRICE = 'Verð';
	var $_PHPSHOP_PRODUCT_LIST_CURRENCY = 'Gjaldmiðill';
	var $_PHPSHOP_PRICE_FORM_MNU = 'Bæta við verði';
	var $_PHPSHOP_PRICE_FORM_LBL = 'PUpplýsingar um verð';
	var $_PHPSHOP_PRICE_FORM_NEW_FOR_PRODUCT = 'Nýtt verð fyrir vöru';
	var $_PHPSHOP_PRICE_FORM_UPDATE_FOR_PRODUCT = 'Uppfæra verð fyrir vöru';
	var $_PHPSHOP_PRICE_FORM_NEW_FOR_ITEM = 'Nýtt verð fyrir hlut';
	var $_PHPSHOP_PRICE_FORM_UPDATE_FOR_ITEM = 'Uppfæra verð fyrir hlut';
	var $_PHPSHOP_PRICE_FORM_PRICE = 'Verð';
	var $_PHPSHOP_PRICE_FORM_CURRENCY = 'Gjaldmiðill';
	var $_PHPSHOP_PRICE_FORM_GROUP = 'Hópur notenda';
	var $_PHPSHOP_REPORTBASIC_MOD = 'Yfirlit';
	var $_PHPSHOP_RB_INDIVIDUAL = 'Sýna einstakar vörur';
	var $_PHPSHOP_RB_SALE_TITLE = 'Sölu yfirlit';
	var $_PHPSHOP_RB_SALES_PAGE_TITLE = 'Yfirlit sölu';
	var $_PHPSHOP_RB_INTERVAL_TITLE = 'Stilla tíðni';
	var $_PHPSHOP_RB_INTERVAL_MONTHLY_TITLE = 'Mánaðarlega';
	var $_PHPSHOP_RB_INTERVAL_WEEKLY_TITLE = 'Vikulega';
	var $_PHPSHOP_RB_INTERVAL_DAILY_TITLE = 'Daglega';
	var $_PHPSHOP_RB_THISMONTH_BUTTON = 'Þessi mánuður';
	var $_PHPSHOP_RB_LASTMONTH_BUTTON = 'Síðasti mánuður';
	var $_PHPSHOP_RB_LAST60_BUTTON = 'Síðustu 60 dagar';
	var $_PHPSHOP_RB_LAST90_BUTTON = 'Síðustu 90 dagar';
	var $_PHPSHOP_RB_START_DATE_TITLE = 'Byrja þann';
	var $_PHPSHOP_RB_END_DATE_TITLE = 'Endar þann';
	var $_PHPSHOP_RB_SHOW_SEL_RANGE = 'Sýna valið';
	var $_PHPSHOP_RB_REPORT_FOR = 'Yfirlit fyrir ';
	var $_PHPSHOP_RB_DATE = 'Dags';
	var $_PHPSHOP_RB_ORDERS = 'Pantanir';
	var $_PHPSHOP_RB_TOTAL_ITEMS = 'Fjöldi seldra hluta';
	var $_PHPSHOP_RB_REVENUE = 'Innkoma';
	var $_PHPSHOP_RB_PRODLIST = 'Vöru listi';
	var $_PHPSHOP_SHOP_MOD = 'Verslun';
	var $_PHPSHOP_PRODUCT_THUMB_TITLE = 'Mynd';
	var $_PHPSHOP_PRODUCT_PRICE_TITLE = 'Verð';
	var $_PHPSHOP_ORDER_STATUS_P = 'Í bið';
	var $_PHPSHOP_ORDER_STATUS_C = 'Staðfest';
	var $_PHPSHOP_ORDER_STATUS_X = 'Hætt við';
	var $_PHPSHOP_ORDER_BUTTON = 'Pöntun';
	var $_PHPSHOP_SHOPPER_MOD = 'Notendur';
	var $_PHPSHOP_SHOPPER_LIST_MNU = 'Sýna rápara';
	var $_PHPSHOP_SHOPPER_LIST_LBL = 'Listi yfir rápara';
	var $_PHPSHOP_SHOPPER_LIST_USERNAME = 'Notendanafn';
	var $_PHPSHOP_SHOPPER_LIST_NAME = 'Fullt nafn';
	var $_PHPSHOP_SHOPPER_LIST_GROUP = 'Hópur';
	var $_PHPSHOP_SHOPPER_FORM_MNU = 'Bæta við notanda';
	var $_PHPSHOP_SHOPPER_FORM_LBL = 'Upplýsingar um notanda';
	var $_PHPSHOP_SHOPPER_FORM_BILLTO_LBL = 'Greiðist af:';
	var $_PHPSHOP_SHOPPER_FORM_ADDRESS_INFO_LBL = 'Upplýsingar';
	var $_PHPSHOP_SHOPPER_FORM_SHIPTO_LBL = 'Afhendist til, upplýsingar';
	var $_PHPSHOP_SHOPPER_FORM_ADD_SHIPTO_LBL = 'Bæta við heimilisfangi';
	...
	var $_PHPSHOP_SHOPPER_FORM_PASSWORD_1 = 'Lykilorð';
	var $_PHPSHOP_SHOPPER_FORM_PASSWORD_2 = 'Staðfesta lykilorð';
	var $_PHPSHOP_SHOPPER_FORM_GROUP = 'Hópur rápara';
	var $_PHPSHOP_SHOPPER_FORM_COMPANY_NAME = 'Nafn fyrirtækis';
	var $_PHPSHOP_SHOPPER_FORM_ADDRESS_1 = 'Heimilisfang 1';
	var $_PHPSHOP_SHOPPER_FORM_ADDRESS_2 = 'Heimilisfang 2';
	var $_PHPSHOP_SHOPPER_FORM_CITY = 'Staður';
	var $_PHPSHOP_SHOPPER_FORM_STATE = 'State/Province/Region';
	var $_PHPSHOP_SHOPPER_FORM_ZIP = 'Póstnúmer';
	var $_PHPSHOP_SHOPPER_FORM_COUNTRY = 'Land';
	var $_PHPSHOP_SHOPPER_FORM_PHONE = 'Sími';
	...
	var $_PHPSHOP_SHOPPER_GROUP_LIST_MNU = 'Sýna hópa';
	var $_PHPSHOP_SHOPPER_GROUP_LIST_LBL = 'Notendalisti';
	var $_PHPSHOP_SHOPPER_GROUP_LIST_NAME = 'Nafn hóps';
	var $_PHPSHOP_SHOPPER_GROUP_LIST_DESCRIPTION = 'Lýsing hóps';
	var $_PHPSHOP_SHOPPER_GROUP_FORM_LBL = 'Form hóps';
	var $_PHPSHOP_SHOPPER_GROUP_FORM_MNU = 'Bæta við hóp';
	var $_PHPSHOP_SHOPPER_GROUP_FORM_NAME = 'Nafn hóps';
	var $_PHPSHOP_SHOPPER_GROUP_FORM_DESC = 'Lýsing hóps';
	var $_PHPSHOP_STORE_MOD = 'Verslun';
	var $_PHPSHOP_STORE_FORM_MNU = 'Breyta verslun';
	var $_PHPSHOP_STORE_FORM_LBL = 'Upplýsingar um verslun';
	var $_PHPSHOP_STORE_FORM_CONTACT_LBL = 'Upplýsingar um tengiliði';
	var $_PHPSHOP_STORE_FORM_FULL_IMAGE = 'Stór mynd';
	var $_PHPSHOP_STORE_FORM_UPLOAD = 'Niðurhala mynd';
	var $_PHPSHOP_STORE_FORM_STORE_NAME = 'Nafn verslunar';
	var $_PHPSHOP_STORE_FORM_COMPANY_NAME = 'Nafn fyrirtækis';
	var $_PHPSHOP_STORE_FORM_ADDRESS_1 = 'Heimilisfang 1';
	var $_PHPSHOP_STORE_FORM_ADDRESS_2 = 'Heimilisfang 2';
	var $_PHPSHOP_STORE_FORM_CITY = 'Staður';
	var $_PHPSHOP_STORE_FORM_STATE = 'State/Province/Region';
	var $_PHPSHOP_STORE_FORM_COUNTRY = 'Land';
	var $_PHPSHOP_STORE_FORM_ZIP = 'Póstnúmer';
	var $_PHPSHOP_STORE_FORM_PHONE = 'Sími';
	var $_PHPSHOP_STORE_FORM_CURRENCY = 'Gjaldmiðill';
	...
	var $_PHPSHOP_STORE_FORM_MIDDLE_NAME = 'Miðnafn';
	var $_PHPSHOP_STORE_FORM_TITLE = 'Titill';
	var $_PHPSHOP_STORE_FORM_PHONE_1 = 'Sími 1';
	var $_PHPSHOP_STORE_FORM_PHONE_2 = 'Sími 2';
	var $_PHPSHOP_STORE_FORM_FAX = 'Fax';
	var $_PHPSHOP_STORE_FORM_EMAIL = 'Netfang';
	var $_PHPSHOP_STORE_FORM_IMAGE_PATH = 'Slóð fyrir myndir';
	var $_PHPSHOP_STORE_FORM_DESCRIPTION = 'Lýsing';
	var $_PHPSHOP_PAYMENT = 'GGreiðslur';
	var $_PHPSHOP_PAYMENT_METHOD_LIST_MNU = 'Sýna greiðslumáta';
	var $_PHPSHOP_PAYMENT_METHOD_LIST_LBL = 'Listi yfir greiðslumáta';
	var $_PHPSHOP_PAYMENT_METHOD_LIST_NAME = 'Nafn';
	var $_PHPSHOP_PAYMENT_METHOD_LIST_CODE = 'Kóði';
	var $_PHPSHOP_PAYMENT_METHOD_LIST_DISCOUNT = 'Afsláttur';
	var $_PHPSHOP_PAYMENT_METHOD_LIST_SHOPPER_GROUP = 'Hópur';
	var $_PHPSHOP_PAYMENT_METHOD_LIST_ENABLE_PROCESSOR = 'Gerð greiðslu';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_MNU = 'Bæta við greiðslumáta';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_LBL = 'Gerð greiðslu';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_NAME = 'Nafn greiðslu';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_SHOPPER_GROUP = 'Notenda hópur';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_DISCOUNT = 'Afsláttur';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_CODE = 'Kóði';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_LIST_ORDER = 'Sýna eftir';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_ENABLE_PROCESSOR = 'Gerð greiðslu';
	var $_PHPSHOP_TAX_MOD = 'VSK';
	var $_PHPSHOP_TAX_RATE = 'VSK hlutfall';
	var $_PHPSHOP_TAX_LIST_MNU = 'Sýna hlutföll VSK';
	var $_PHPSHOP_TAX_LIST_LBL = 'Listi yfir VSK hlutföll';
	...
	var $_PHPSHOP_TAX_FORM_MNU = 'Bæta við VSK hlutfalli';
	var $_PHPSHOP_TAX_FORM_LBL = 'Bæta við upplýsingum um VSK hlutfall';
	var $_PHPSHOP_TAX_FORM_STATE = 'Tax State or Region';
	var $_PHPSHOP_TAX_FORM_COUNTRY = 'VSK eftir landi';
	var $_PHPSHOP_TAX_FORM_RATE = 'VSK hlutfall (fyrir 16% => settu þá inn 0.16)';
	var $_PHPSHOP_VENDOR_MOD = 'Söluaðili';
	var $_PHPSHOP_VENDOR_ADMIN = 'Söluaðilar';
	var $_PHPSHOP_VENDOR_LIST_MNU = 'Sýna söluaðila';
	var $_PHPSHOP_VENDOR_LIST_LBL = 'Listi yfir söluaðila';
	var $_PHPSHOP_VENDOR_LIST_VENDOR_NAME = 'Nafn söluaðila';
	var $_PHPSHOP_VENDOR_LIST_ADMIN = 'Stjórnandi';
	var $_PHPSHOP_VENDOR_FORM_MNU = 'Bæta við söluaðila';
	var $_PHPSHOP_VENDOR_FORM_LBL = 'Bæta inn upplýsingum';
	var $_PHPSHOP_VENDOR_FORM_INFO_LBL = 'Upplýsingar um söluaðila';
	var $_PHPSHOP_VENDOR_FORM_CONTACT_LBL = 'Upplýsingar um tengla';
	var $_PHPSHOP_VENDOR_FORM_FULL_IMAGE = 'Stór mynd';
	var $_PHPSHOP_VENDOR_FORM_UPLOAD = 'Upphala mynd';
	var $_PHPSHOP_VENDOR_FORM_STORE_NAME = 'Nafn verslunar';
	var $_PHPSHOP_VENDOR_FORM_COMPANY_NAME = 'Nafn fyrirtækis';
	var $_PHPSHOP_VENDOR_FORM_ADDRESS_1 = 'Heimilisfang 1';
	var $_PHPSHOP_VENDOR_FORM_ADDRESS_2 = 'Heimilisfang 2';
	var $_PHPSHOP_VENDOR_FORM_CITY = 'Staður';
	var $_PHPSHOP_VENDOR_FORM_STATE = 'State/Province/Region';
	var $_PHPSHOP_VENDOR_FORM_COUNTRY = 'Land';
	var $_PHPSHOP_VENDOR_FORM_ZIP = 'Póstnúmer';
	var $_PHPSHOP_VENDOR_FORM_PHONE = 'Sími';
	var $_PHPSHOP_VENDOR_FORM_CURRENCY = 'Gjaldmiðill';
	var $_PHPSHOP_VENDOR_FORM_CATEGORY = 'Flokkur söluaðila';
	...
	var $_PHPSHOP_VENDOR_FORM_PHONE_1 = 'Sími 1';
	var $_PHPSHOP_VENDOR_FORM_PHONE_2 = 'Sími 2';
	var $_PHPSHOP_VENDOR_FORM_FAX = 'Fax';
	var $_PHPSHOP_VENDOR_FORM_EMAIL = 'Netfang';
	var $_PHPSHOP_VENDOR_FORM_IMAGE_PATH = 'Slóð fyrir mynd';
	var $_PHPSHOP_VENDOR_FORM_DESCRIPTION = 'Lýsing';
	var $_PHPSHOP_VENDOR_CAT_LIST_MNU = 'Sýna söluaðila (flokka)';
	var $_PHPSHOP_VENDOR_CAT_LIST_LBL = 'Vendor listi';
	var $_PHPSHOP_VENDOR_CAT_NAME = 'Flokkur';
	var $_PHPSHOP_VENDOR_CAT_DESCRIPTION = 'Lýsing';
	...
	var $_PHPSHOP_MANUFACTURER_MOD = 'Famleiðandi';
	var $_PHPSHOP_MANUFACTURER_ADMIN = 'Framleiðendur';
	var $_PHPSHOP_MANUFACTURER_LIST_MNU = 'Sýna framleiðendur';
	var $_PHPSHOP_MANUFACTURER_LIST_LBL = 'Listi yfir framleiðendur';
	var $_PHPSHOP_MANUFACTURER_LIST_MANUFACTURER_NAME = 'Nafn framleiðanda';
	var $_PHPSHOP_MANUFACTURER_LIST_ADMIN = 'Admin';
	var $_PHPSHOP_MANUFACTURER_FORM_MNU = 'Bæta við framleiðanda';
	var $_PHPSHOP_MANUFACTURER_FORM_LBL = 'Bæta við upplýsingum';
	var $_PHPSHOP_MANUFACTURER_FORM_INFO_LBL = 'Upplýsingar um framleiðanda';
	var $_PHPSHOP_MANUFACTURER_FORM_NAME = 'Nafn framleiðanda';
	var $_PHPSHOP_MANUFACTURER_FORM_CATEGORY = 'Flokkur framleiðanda';
	var $_PHPSHOP_MANUFACTURER_FORM_EMAIL = 'Netfang';
	var $_PHPSHOP_MANUFACTURER_FORM_URL = 'Slóð á heimasíðu framleiðanda';
	var $_PHPSHOP_MANUFACTURER_FORM_DESCRIPTION = 'Lýsing';
	var $_PHPSHOP_MANUFACTURER_CAT_LIST_MNU = 'Sýna flokka yfir framleiðendur';
	var $_PHPSHOP_MANUFACTURER_CAT_LIST_LBL = 'Flokkar framleiðenda';
	var $_PHPSHOP_MANUFACTURER_CAT_NAME = 'Nafn flokks';
	var $_PHPSHOP_MANUFACTURER_CAT_DESCRIPTION = 'Lýsing flokks';
	var $_PHPSHOP_MANUFACTURER_CAT_MANUFACTURERS = 'Framleiðendur';
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_MNU = 'Bæta við flokk framleiðenda';
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_LBL = 'Flokkur framleiðenda form';
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_INFO_LBL = 'Upplýsingar um flokk';
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_NAME = 'Nafn flokks';
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_DESCRIPTION = 'Lýsing flokks';
	var $_PHPSHOP_HELP_MOD = 'Hjálp';
	var $_PHPSHOP_CART_ACTION = 'Uppfæra';
	var $_PHPSHOP_CART_UPDATE = 'Uppfæra fjölda í körfu';
	var $_PHPSHOP_CART_DELETE = 'Eyða vöru úr körfu';
	var $_PHPSHOP_PRODUCT_PRICETAG = 'Verð';
	var $_PHPSHOP_PRODUCT_CALL = 'Hringja eftir verði';
	var $_PHPSHOP_PRODUCT_PREVIOUS = 'Bakka';
	var $_PHPSHOP_PRODUCT_NEXT = 'Áfram';
	var $_PHPSHOP_CART_TAX = 'VSK';
	var $_PHPSHOP_CART_SHIPPING = 'Sendingarkostnaður';
	var $_PHPSHOP_CART_TOTAL = 'Samtals';
	var $_PHPSHOP_CHECKOUT_NEXT = 'Næst';
	var $_PHPSHOP_CHECKOUT_REGISTER = 'SKRÁ';
	var $_PHPSHOP_CHECKOUT_CONF_BILLINFO = 'Upplýsingar um greiðslu';
	var $_PHPSHOP_CHECKOUT_CONF_COMPANY = 'Fyrirtæki';
	var $_PHPSHOP_CHECKOUT_CONF_NAME = 'Nafn';
	var $_PHPSHOP_CHECKOUT_CONF_ADDRESS = 'Heimilisfang';
	var $_PHPSHOP_CHECKOUT_CONF_PHONE = 'Sími';
	var $_PHPSHOP_CHECKOUT_CONF_FAX = 'Fax';
	var $_PHPSHOP_CHECKOUT_CONF_EMAIL = 'Netfang';
	var $_PHPSHOP_CHECKOUT_CONF_SHIPINFO = 'Upplýsingar um afhendingu';
	var $_PHPSHOP_CHECKOUT_CONF_SHIPINFO_COMPANY = 'Fyrirtæki';
	var $_PHPSHOP_CHECKOUT_CONF_SHIPINFO_NAME = 'Nafn';
	var $_PHPSHOP_CHECKOUT_CONF_SHIPINFO_ADDRESS = 'Heimilisfang';
	var $_PHPSHOP_CHECKOUT_CONF_SHIPINFO_PHONE = 'Sími';
	var $_PHPSHOP_CHECKOUT_CONF_SHIPINFO_FAX = 'Fax';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO = 'Upplýsingar um greiðslu';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_NAMECARD = 'Nafn á korti';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_METHOD = 'Greiðslumáti';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_CCNUM = 'Kortanúmer';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_EXDATE = 'Gildistími';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_COMPORDER = 'Klára pöntun';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_REQINFO = 'nauðsynlegar upplýsingar ef greitt er með kreditkorti';
	...
	var $_PHPSHOP_ZONE_FORM_NAME_LBL = 'Nafn staðar';
	var $_PHPSHOP_ZONE_FORM_DESC_LBL = 'Lýsing';
	var $_PHPSHOP_ZONE_FORM_COST_PER_LBL = 'Kostnaður á hvern hlut';
	var $_PHPSHOP_ZONE_FORM_COST_LIMIT_LBL = 'Hámarks kostnaður';
	var $_PHPSHOP_ZONE_LIST_LBL = 'Nafn staðar';
	var $_PHPSHOP_ZONE_LIST_NAME_LBL = 'Nafn staðar';
	var $_PHPSHOP_ZONE_LIST_DESC_LBL = 'Lýsing';
	var $_PHPSHOP_ZONE_LIST_COST_PER_LBL = 'Kostnaður á hvern hlut';
	var $_PHPSHOP_ZONE_LIST_COST_LIMIT_LBL = 'Hámarks kostnaður';
	var $_PHPSHOP_LOGIN_FIRST = 'Vinsamlegast skráðu inn eða stofnaðu aðgang (use the Login module) fyrst.<br>Takk fyrir.';
	var $_PHPSHOP_STORE_FORM_TOS = 'Skilmálar';
	var $_PHPSHOP_AGREE_TO_TOS = 'Vinsamlegast samþykkið skilmálana fyrst.';
	var $_PHPSHOP_I_AGREE_TO_TOS = 'Ég samþykki skilmálana';
	var $_PHPSHOP_LEAVE_BLANK = '(leave BLANK if you have <br />no individual php-file for it!)';
	var $_PHPSHOP_RETURN_LOGIN = 'Skráðir notendur: Vinsamlegast skráið ykkur inn';
	var $_PHPSHOP_NEW_CUSTOMER = 'Nýr notandi? Vinsamlegast skráðu upplýsingar fyrir greiðslu';
	var $_PHPSHOP_ACC_CUSTOMER_ACCOUNT = 'Reikningur notanda:';
	var $_PHPSHOP_ACC_ORDER_INFO = 'upplýsingar um pöntun';
	var $_PHPSHOP_ACC_UPD_BILL = 'Hér geturðu uppfært upplýsingar um greiðslumáta.';
	var $_PHPSHOP_ACC_UPD_SHIP = 'Hér geturðu uppfært upplýsingar um afhendingarstað.';
	var $_PHPSHOP_ACC_ACCOUNT_INFO = 'Upplýsingar um reikning';
	var $_PHPSHOP_ACC_SHIP_INFO = 'Upplýsingar um afhendingu';
	var $_PHPSHOP_ACC_NO_ORDERS = 'Engar pantanir til að sýna';
	var $_PHPSHOP_ACC_BILL_DEF = ' Sjálfvalið (Sama og hjá greiðanda)';
	var $_PHPSHOP_SHIPTO_TEXT = 'Þú getur bætt við afhendingarstöðum hér. Vinsamlegast búðu til styttingu á staðarnafninu.';
	var $_PHPSHOP_CONFIG = 'Stillingar';
	var $_PHPSHOP_USERS = 'Notendur';
	var $_PHPSHOP_IS_CC_PAYMENT = 'er kreditkorta greiðsla?';
	var $_PHPSHOP_SHIPPING_MOD = 'Sendingar';
	var $_PHPSHOP_SHIPPING_MENU_LABEL = 'Sendingar';
	var $_PHPSHOP_CARRIER_LIST_MNU = 'Flutningsaðili';
	var $_PHPSHOP_CARRIER_LIST_LBL = 'Listi yfir flutningsaðila';
	var $_PHPSHOP_RATE_LIST_MNU = 'Gjaldskrá';
	var $_PHPSHOP_RATE_LIST_LBL = 'Listi yfir gjaldskrár';
	var $_PHPSHOP_CARRIER_LIST_NAME_LBL = 'Nafn';
	var $_PHPSHOP_CARRIER_LIST_ORDER_LBL = 'Sýna eftir';
	...
	var $_PHPSHOP_RATE_FORM_CARRIER = 'Flutningsaðili';
	...
	var $_PHPSHOP_SHIPPING_RATE_LIST_CARRIER_LBL = 'Flutningsaðili';
	...
	var $_PHPSHOP_INFO_MSG_SHIPPING_PRICE = 'Verð';
	...
	var $_PHPSHOP_CHECKOUT_MSG_2 = 'Vinsamlegast heimilisfang fyrir afhendingu (ef það á við)!';
	var $_PHPSHOP_CHECKOUT_MSG_3 = 'Vinsamlegast veldu afhendingarmáta!';
	var $_PHPSHOP_CHECKOUT_MSG_4 = 'Vinsamlegast veldu greiðslumáta!';
	var $_PHPSHOP_CHECKOUT_MSG_99 = 'Vinsamlegast gangtu úr skugga um að pöntunin sé rétt og staðfestu hana!';
	...
	var $_PHPSHOP_CHECKOUT_ERR_NO_PAYM = 'Vinsamlegast veldu greiðslumáta.';
	...
	var $_PHPSHOP_CHECKOUT_PAYMENT_OTHER = 'Greiðslumáti';
	var $_PHPSHOP_CHECKOUT_PAYMENT_SELECT = 'Vinsamlegast veldu greiðslumáta:';
	var $_PHPSHOP_STORE_FORM_MPOV = 'Lágmarks kaupverð í vefverslun';
	var $_PHPSHOP_ACCOUNT_BANK_TITLE = 'Banka upplýsingar';
	var $_PHPSHOP_ACCOUNT_LBL_BANK_ACCOUNT_NR = 'Reikningur NR:';
	var $_PHPSHOP_ACCOUNT_LBL_BANK_SORT_CODE = 'Bankanúmer röðun';
	...
	var $_PHPSHOP_FUNCTIONS = 'Aðgerðir';
	var $_PHPSHOP_SPECIAL_PRODUCTS = 'Vörur á tilboði';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_NOTE = 'Vinsamlegast skrifaðu athugasemdir ef einhverjar eru';
	var $_PHPSHOP_ORDER_PRINT_CUSTOMER_NOTE = 'Athugasemdir kaupanda';
	var $_PHPSHOP_INCLUDING_TAX = '(Með VSK $tax % tax)';
	var $_PHPSHOP_PLEASE_SEL_ITEM = 'Vinsamlegast veldu';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_LBL = 'Hlutur';
	var $_PHPSHOP_DOWNLOADS_TITLE = 'Niðurhal';
	var $_PHPSHOP_DOWNLOADS_START = 'Byrja niðurhal';
	var $_PHPSHOP_DOWNLOADS_INFO = 'Vinsamlegast sláðu inn kenni fyrir niðurhalið og smelltu svo á \'Start Download\'.';
	var $_PHPSHOP_DOWNLOADS_ERR_EXP = 'Því miður er þetta niðurhal útrunnið';
	var $_PHPSHOP_DOWNLOADS_ERR_MAX = 'heildar fjölda niðurhala fyrir þessa vöru hefur verið náð';
	var $_PHPSHOP_DOWNLOADS_ERR_INV = 'Rangt kenni fyrir niðurhal!';
	var $_PHPSHOP_DOWNLOADS_ERR_SEND = 'Gat ekki sent skilaboð til ';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG = 'Skilaboð send til ';
	var $_PHPSHOP_DOWNLOADS_SEND_SUBJ = 'Upplýsingar um niðurhal';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_1 = 'skrárnar sem þú panntaðir eru tilbúnar til niðurhals';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_2 = 'Sláðu inn kenni niðurhals á niðurhalssvæðinu þínu: ';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_3 = 'heildarfjöldi niðurhala fyrir þessa vöru er: ';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_4 = 'Niðurhal til {expire} eftir fyrsta niðurhal';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_5 = 'Spurningar? Vandamál?';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_6 = 'Upplýsingar um niðurhal frá ';
	var $_PHPSHOP_PRODUCT_FORM_DOWNLOADABLE = 'Hægt að niðurhala?';
	var $_PHPSHOP_PAYPAL_THANKYOU = 'Takk fyrir greiðsluna. 
	...
	var $_PHPSHOP_PAYPAL_ERROR = 'Villa kom upp við aðgerðina. Ekki var hægt að uppfæra stöðu pöntunarinnar.';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER1 = 'Takk fyrir að versla við 24/7.  Staðan á pöntuninni er:.';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER2 = 'Thank you for your patronage.';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER3 = 'Spurningar? Vandamál?';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER4 = 'Eftirfarandi pöntun var gerð.';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER5 = 'Skoðaðu pöntunina hér >>>.';
	var $_PHPSHOP_CART_ERROR_NO_NEGATIVE = 'Neikvæður fjöldi er ekki leyfður.';
	var $_PHPSHOP_CART_ERROR_NO_VALID_QUANTITY = 'Vinsamlega sláðu inn réttan fjölda.';
	var $_PHPSHOP_CART_STOCK_1 = 'Ekki er til nægilegt magn á lager. ';
	var $_PHPSHOP_CART_STOCK_2 = 'Við eigum til $product_in_stock hluti á lager. ';
	var $_PHPSHOP_CART_STOCK_3 = 'Smelltu hér ef þú vilt vera á biðlista.';
	var $_PHPSHOP_CART_SELECT_ITEM = 'Veldu hlut!';
	var $_PHPSHOP_REGISTRATION_FORM_NONE = 'engin';
	var $_PHPSHOP_REGISTRATION_FORM_MR = 'Hr.';
	var $_PHPSHOP_REGISTRATION_FORM_MRS = 'Frú.';
	var $_PHPSHOP_REGISTRATION_FORM_DR = 'Dr.';
	var $_PHPSHOP_REGISTRATION_FORM_PROF = 'Prof.';
	var $_PHPSHOP_DEFAULT = 'Sjálfvalið';
	...
	var $_PHPSHOP_MORE_CATEGORIES = 'Aðrir flokkar';
	...
	var $_PHPSHOP_STATISTIC_STATISTICS = 'Staða';
	var $_PHPSHOP_STATISTIC_CUSTOMERS = 'Notendur';
	var $_PHPSHOP_STATISTIC_ACTIVE_PRODUCTS = 'virkar vörur';
	var $_PHPSHOP_STATISTIC_INACTIVE_PRODUCTS = 'óvirkar vörur';
	var $_PHPSHOP_STATISTIC_SUM = 'Samtals';
	var $_PHPSHOP_STATISTIC_NEW_ORDERS = 'Nýjar pantanir';
	var $_PHPSHOP_STATISTIC_NEW_CUSTOMERS = 'Nýir notendur';
	...
	var $_PHPSHOP_ADMIN_CFG_FILE_STATUS = ' Staða kerfisskráa:';
	var $_PHPSHOP_ADMIN_CFG_FILE_STATUS_WRITEABLE = 'er skrifanleg';
	var $_PHPSHOP_ADMIN_CFG_FILE_STATUS_UNWRITEABLE = 'er óskrifanleg';
	var $_PHPSHOP_ADMIN_CFG_GLOBAL = 'Global';
	var $_PHPSHOP_ADMIN_CFG_PATHANDURL = 'Slóðir';
	var $_PHPSHOP_ADMIN_CFG_SITE = 'Síða';
	var $_PHPSHOP_ADMIN_CFG_SHIPPING = 'Sendingar';
	var $_PHPSHOP_ADMIN_CFG_CHECKOUT = 'Frágangur';
	var $_PHPSHOP_ADMIN_CFG_DOWNLOADABLEGOODS = 'Niðurhal';
	var $_PHPSHOP_ADMIN_CFG_PAYEMENTOPTIONS = 'greiðslur';
	var $_PHPSHOP_ADMIN_CFG_USE_ONLY_AS_CATALOGUE = 'Nota einungis sem vörulista';
	var $_PHPSHOP_ADMIN_CFG_USE_ONLY_AS_CATALOGUE_EXPLAIN = 'If you check this, you disable all cart functionalities.';
	var $_PHPSHOP_ADMIN_CFG_SHOW_PRICES = 'Sýna verð';
	var $_PHPSHOP_ADMIN_CFG_PRICES_INCLUDE_TAX = 'Sýna verð með skatti?';
  ...
  select the status which enables the download (then the customer is instantly notified about the download via e-mail).';
	...
	var $_PHPSHOP_ADVANCED_SEARCH = 'Nánari leit';
	var $_PHPSHOP_SEARCH_ALL_CATEGORIES = 'Leita í öllum flokkum';
	var $_PHPSHOP_SEARCH_ALL_PRODINFO = 'Leita í upplýsingum um vörur';
	var $_PHPSHOP_SEARCH_PRODNAME = 'Leita eftir vörunafni';
	var $_PHPSHOP_SEARCH_MANU_VENDOR = 'Framleiðandi';
	var $_PHPSHOP_SEARCH_DESCRIPTION = 'Lýsing vöru';
	var $_PHPSHOP_SEARCH_AND = 'og';
	var $_PHPSHOP_SEARCH_NOT = 'ekki';
	var $_PHPSHOP_SEARCH_TEXT1 = 'Fyrsti niðurfelldi listinn gefur þér tækifæri til að velja flokk til að leita í. 
	...
	var $_PHPSHOP_SEARCH_TEXT2 = ' Þú getur þrengt leitina enn frekar með þvi að nota OG eða EKKI. 
	...
	var $_PHPSHOP_CUSTOMER_RATING = 'Dómar notenda';
	var $_PHPSHOP_TOTAL_VOTES = 'Atkæði';
	var $_PHPSHOP_CAST_VOTE = 'Kjósa';
	var $_PHPSHOP_RATE_BUTTON = 'Rate';
	var $_PHPSHOP_RATE_NOM = 'Vinsældir';
	var $_PHPSHOP_REVIEWS = 'Umsagnir';
	var $_PHPSHOP_NO_REVIEWS = 'Það eru engar umsagnir um vöruna enn.';
	var $_PHPSHOP_WRITE_FIRST_REVIEW = 'Vertu firstur til að skrifa umsögn...';
	var $_PHPSHOP_REVIEW_LOGIN = 'Vinsamlegast skráðu þig inn e.';
	...
	var $_PHPSHOP_CONTINUE_SHOPPING = 'Halda áfram að versla';
	var $_PHPSHOP_THANKYOU_SUCCESS = 'Pöntunin þín var send!';
	var $_PHPSHOP_ORDER_LINK = 'Nánari upplýsingar um pöntunina hér.';
	...
	var $_PHPSHOP_PRODUCT_DISCOUNT_SAVE = 'Afsláttur';
	var $_PHPSHOP_FLYPAGE_ENLARGE_IMAGE = 'Sjá stóra mynd';
