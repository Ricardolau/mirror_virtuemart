...
<div class="uk-card uk-card-small uk-card-vm">
	...
	<div class="uk-card-body">
		...
		echo VmuikitHtml::row('input', 'COM_VIRTUEMART_ADMIN_CFG_FEED_LATEST_NB', 'feed_latest_nb', VmConfig::get('feed_latest_nb', 5), '', 10, 10);
		...
		echo VmuikitHtml::row('input', 'COM_VIRTUEMART_ADMIN_CFG_FEED_TOPTEN_NB', 'feed_topten_nb', VmConfig::get('feed_topten_nb', 5), '', 10, 10);
		...
		echo VmuikitHtml::row('input', 'COM_VIRTUEMART_ADMIN_CFG_FEED_FEATURED_NB', 'feed_featured_nb', VmConfig::get('feed_featured_nb', 5), '', 10, 10);
		...
		echo VmuikitHtml::row('input', 'COM_VIRTUEMART_ADMIN_CFG_FEED_MAX_TEXT_LENGTH', 'feed_home_max_text_length', VmConfig::get('feed_home_max_text_length', 500), '', 10, 10);
		?>
