...
class vmLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_PRODUCT = 'ZboûÌ';
	var $_PHPSHOP_LIST = 'Seznam';
	var $_PHPSHOP_ALL = 'Vöe';
	var $_PHPSHOP_LIST_ALL_PRODUCTS = 'Seznam veökerÈho zboûÌ';
	...
	var $_PHPSHOP_RANDOM = 'N·hodnÈ zboûÌ';
	var $_PHPSHOP_LATEST = 'PoslednÌ zboûÌ';
	var $_PHPSHOP_HOME_TITLE = 'Dom˘';
	var $_PHPSHOP_CART_TITLE = 'KoöÌk';
	var $_PHPSHOP_CHECKOUT_TITLE = 'Zaplatit';
	var $_PHPSHOP_LOGIN_TITLE = 'P¯ihl·sit se';
	var $_PHPSHOP_LOGOUT_TITLE = 'Odhl·sit se';
	var $_PHPSHOP_BROWSE_TITLE = 'ProhlÌûet';
	var $_PHPSHOP_SEARCH_TITLE = 'Hledat';
	var $_PHPSHOP_ACCOUNT_TITLE = 'Vaöe ˙daje';
	var $_PHPSHOP_NAVIGATION_TITLE = 'Navigace';
	var $_PHPSHOP_DEPARTMENT_TITLE = 'OddÏlenÌ';
	var $_PHPSHOP_INFO = 'Informace';
	var $_PHPSHOP_BROWSE_LBL = 'ProhlÌûet';
	var $_PHPSHOP_PRODUCTS_LBL = 'ZboûÌ';
	var $_PHPSHOP_PRODUCT_LBL = 'ZboûÌ';
	var $_PHPSHOP_SEARCH_LBL = 'Hledat';
	var $_PHPSHOP_FLYPAGE_LBL = 'Detaily o zboûÌ';
	var $_PHPSHOP_PRODUCT_SEARCH_LBL = 'Hledat zboûÌ';
	var $_PHPSHOP_PRODUCT_NAME_TITLE = 'N·zev zboûÌ';
	var $_PHPSHOP_PRODUCT_CATEGORY_TITLE = 'Kategorie zboûÌ';
	var $_PHPSHOP_PRODUCT_DESC_TITLE = 'Popis';
	var $_PHPSHOP_CART_SHOW = 'Obsah koöÌku';
	var $_PHPSHOP_CART_ADD_TO = 'P¯idat do koöÌku';
	var $_PHPSHOP_CART_NAME = 'JmÈno';
	var $_PHPSHOP_CART_SKU = 'KÛd zboûÌ';
	var $_PHPSHOP_CART_PRICE = 'Cena';
	var $_PHPSHOP_CART_QUANTITY = 'MnoûstvÌ';
	var $_PHPSHOP_CART_SUBTOTAL = 'MezisouËet';
	var $_PHPSHOP_ADD_SHIPTO_1 = 'P¯idat';
	var $_PHPSHOP_ADD_SHIPTO_2 = 'DodacÌ adresa';
	var $_PHPSHOP_NO_SEARCH_RESULT = 'Nic nebylo nalezeno.<br />';
	var $_PHPSHOP_PRICE_LABEL = 'Cena: ';
	var $_PHPSHOP_ORDER_BUTTON_LABEL = 'Vloûit do koöÌku';
	var $_PHPSHOP_NO_CUSTOMER = 'Nejste jeötÏ registrovan˝ z·kaznÌk, zadejte prosÌm fakturaËnÌ ˙daje.';
	var $_PHPSHOP_DELETE_MSG = 'Opravdu chcete smazat tuto poloûku?';
	var $_PHPSHOP_THANKYOU = 'DÏkujeme v·m za vaöi objedn·vku.';
	var $_PHPSHOP_NOT_SHIPPED = 'JeötÏ neodesl·no';
	var $_PHPSHOP_EMAIL_SENDTO = 'E-mail s potvrzenÌm byl zasl·n na adresu';
	var $_PHPSHOP_NO_USER_TO_SELECT = 'Lituji, neexistuje uûivatel MamboOS, kterÈho byste mohli p¯idat do seznamu uûivatel˘ com_phpshop';
	var $_PHPSHOP_ERROR = 'Chyba';
	var $_PHPSHOP_MOD_NOT_REG = 'Modul nenÌ registrov·n.';
	var $_PHPSHOP_MOD_ISNO_REG = 'nenÌ platn˝ modul phpShop.';
	var $_PHPSHOP_MOD_NO_AUTH = ' Nem·te opr·vnÏnÌ pracovat s poûadovan˝m modulem.';
	var $_PHPSHOP_PAGE_404_1 = 'Str·nka neexistuje';
	var $_PHPSHOP_PAGE_404_2 = 'ZadanÈ jmÈno souboru neexistuje. Nelze nalÈzt soubor:';
	var $_PHPSHOP_PAGE_403 = 'NedostateËn· pr·va';
	var $_PHPSHOP_FUNC_NO_EXEC = 'Nem·te  opr·vnÏnÌ na vykon·nÌ ';
	var $_PHPSHOP_FUNC_NOT_REG = 'Funkce nenÌ registrov·na';
	var $_PHPSHOP_FUNC_ISNO_REG = ' nenÌ platn· funkce MOS_com_phpShop.';
	var $_PHPSHOP_ADMIN_MOD = 'Administrace';
	var $_PHPSHOP_USER_LIST_MNU = 'Seznam uûivatel˘';
	var $_PHPSHOP_USER_LIST_LBL = 'UûivatelÈ';
	var $_PHPSHOP_USER_LIST_USERNAME = 'Uûivatel. jmÈno';
	var $_PHPSHOP_USER_LIST_FULL_NAME = 'PlnÈ jmÈno';
	var $_PHPSHOP_USER_LIST_GROUP = 'Skupina';
	var $_PHPSHOP_USER_FORM_MNU = 'P¯idat uûivatele';
	var $_PHPSHOP_USER_FORM_LBL = 'P¯idat/zmÏnit informaci o uûivateli';
	var $_PHPSHOP_USER_FORM_BILLTO_LBL = 'Informace o pl·tci';
	var $_PHPSHOP_USER_FORM_SHIPTO_LBL = 'DodacÌ adresa';
	var $_PHPSHOP_USER_FORM_ADD_SHIPTO_LBL = 'P¯idat adresu';
	var $_PHPSHOP_USER_FORM_NO_SHIPPING_ADDRESSES = 'é·dn· dodacÌ adresa.';
	var $_PHPSHOP_USER_FORM_ADDRESS_LABEL = 'Zkratka adresy';
	var $_PHPSHOP_USER_FORM_FIRST_NAME = 'K¯estnÌ jmÈno';
	var $_PHPSHOP_USER_FORM_LAST_NAME = 'P¯ÌjmenÌ';
	var $_PHPSHOP_USER_FORM_MIDDLE_NAME = 'Prost¯ednÌ jmÈno';
	var $_PHPSHOP_USER_FORM_TITLE = 'Titul';
	var $_PHPSHOP_USER_FORM_USERNAME = 'UûivatelskÈ jmÈno';
	var $_PHPSHOP_USER_FORM_PASSWORD_1 = 'Heslo';
	var $_PHPSHOP_USER_FORM_PASSWORD_2 = 'Potvrdit heslo';
	var $_PHPSHOP_USER_FORM_PERMS = 'Opr·vnÏnÌ';
	var $_PHPSHOP_USER_FORM_CUSTOMER_NUMBER = '»Ìslo z·kaznÌka / ID';
	...
	var $_PHPSHOP_USER_FORM_CITY = 'MÏsto';
	...
	var $_PHPSHOP_USER_FORM_PHONE2 = 'MobilnÌ telefon';
	...
	var $_PHPSHOP_MODULE_LIST_NAME = 'JmÈno modulu';
	var $_PHPSHOP_MODULE_LIST_PERMS = 'Opr·vnÏnÌ modulu';
	var $_PHPSHOP_MODULE_LIST_FUNCTIONS = 'Funkce';
	var $_PHPSHOP_MODULE_LIST_ORDER = 'Po¯adÌ';
	var $_PHPSHOP_MODULE_FORM_MNU = 'P¯idat modul';
	var $_PHPSHOP_MODULE_FORM_LBL = 'Informace o modulu';
	var $_PHPSHOP_MODULE_FORM_MODULE_LABEL = 'N·zev modulu (pro hornÌ menu)';
	var $_PHPSHOP_MODULE_FORM_NAME = 'JmÈno modulu';
	var $_PHPSHOP_MODULE_FORM_PERMS = 'Pr·va modulu';
	var $_PHPSHOP_MODULE_FORM_HEADER = 'Z·hlavÌ modulu';
	var $_PHPSHOP_MODULE_FORM_FOOTER = 'Z·patÌ modulu';
	var $_PHPSHOP_MODULE_FORM_MENU = 'Zobrazit modul v menu Administrace?';
	var $_PHPSHOP_MODULE_FORM_ORDER = 'Po¯adÌ zobrazenÌ';
	var $_PHPSHOP_MODULE_FORM_DESCRIPTION = 'Popis modulu';
	var $_PHPSHOP_MODULE_FORM_LANGUAGE_CODE = 'KÛd jazyka';
	var $_PHPSHOP_MODULE_FORM_LANGUAGE_file = 'Soubor s jazykem';
	var $_PHPSHOP_FUNCTION_LIST_MNU = 'Seznam funkcÌ';
	var $_PHPSHOP_FUNCTION_LIST_LBL = 'Funkce';
	var $_PHPSHOP_FUNCTION_LIST_NAME = 'JmÈno funkce';
	var $_PHPSHOP_FUNCTION_LIST_CLASS = 'JmÈno t¯Ìdy';
	var $_PHPSHOP_FUNCTION_LIST_METHOD = 'Metoda t¯Ìdy';
	var $_PHPSHOP_FUNCTION_LIST_PERMS = 'Opr·vnÏnÌ';
	var $_PHPSHOP_FUNCTION_FORM_MNU = 'P¯idat funkci';
	var $_PHPSHOP_FUNCTION_FORM_LBL = 'Informace o funkci';
	var $_PHPSHOP_FUNCTION_FORM_NAME = 'JmÈno funkce';
	var $_PHPSHOP_FUNCTION_FORM_CLASS = 'JmÈno t¯Ìdy';
	var $_PHPSHOP_FUNCTION_FORM_METHOD = 'Metoda t¯Ìdy';
	var $_PHPSHOP_FUNCTION_FORM_PERMS = 'Opr·vnÏnÌ funkce';
	var $_PHPSHOP_FUNCTION_FORM_DESCRIPTION = 'Popis funkce';
	var $_PHPSHOP_CURRENCY_LIST_MNU = 'Seznam mÏn';
	var $_PHPSHOP_CURRENCY_LIST_LBL = 'MÏny';
	var $_PHPSHOP_CURRENCY_LIST_ADD = 'P¯idat mÏnu';
	var $_PHPSHOP_CURRENCY_LIST_NAME = 'N·zev mÏny';
	var $_PHPSHOP_CURRENCY_LIST_CODE = 'KÛd mÏny';
	var $_PHPSHOP_COUNTRY_LIST_MNU = 'Seznam zemÌ';
	var $_PHPSHOP_COUNTRY_LIST_LBL = 'ZemÏ';
	var $_PHPSHOP_COUNTRY_LIST_ADD = 'P¯idat zemi';
	var $_PHPSHOP_COUNTRY_LIST_NAME = 'JmÈno zemÏ';
	var $_PHPSHOP_COUNTRY_LIST_3_CODE = 'KÛd zemÏ (3)';
	var $_PHPSHOP_COUNTRY_LIST_2_CODE = 'KÛd zemÏ (2)';
	...
	var $_PHPSHOP_STATE_LIST_NAME = 'JmÈno st·tu';
	var $_PHPSHOP_STATE_LIST_3_CODE = 'KÛd st·tu (3)';
	var $_PHPSHOP_STATE_LIST_2_CODE = 'KÛd st·tu (2)';
	var $_PHPSHOP_ADDRESS = 'Adresa';
	var $_PHPSHOP_CONTINUE = 'PokraËovat';
	var $_PHPSHOP_EMPTY_CART = 'V·ö koöÌk je pr·zdn˝';
	...
	var $_PHPSHOP_ISSHIP_LIST_LBL = 'AktivnÌ zp˘sob dopravy';
	var $_PHPSHOP_ISSHIP_LIST_CARRIER_LBL = 'Zp˘sob dopravy';
	var $_PHPSHOP_ISSHIP_LIST_PUBLISH_LBL = 'AktivnÌ';
	var $_PHPSHOP_ISSHIP_LIST_RATE_LBL = 'BalnÈ';
	var $_PHPSHOP_ISSHIP_LIST_LEAD_LBL = 'Lead Time';
	var $_PHPSHOP_ISSHIP_LIST_CHARGE_F_LBL = 'fixnÌ sazba';
	var $_PHPSHOP_ISSHIP_LIST_CHARGE_P_LBL = 'procenta';
	var $_PHPSHOP_ISSHIP_LIST_DAYS_LBL = 'dny';
	var $_PHPSHOP_ISSHIP_LIST_HEAVY_LBL = 'NadmÏrnÈ z·silky';
	...
	var $_PHPSHOP_ISSHIP_FORM_HANDLING_LBL = 'BalnÈ';
	...
	var $_PHPSHOP_ISSHIP_FORM_HEAVY_LBL = 'NadmÏrnÈ z·silky';
	var $_PHPSHOP_ORDER_MOD = 'Objedn·vky';
	var $_PHPSHOP_ORDER_CONFIRM_MNU = 'Potvrdit objedn·vku';
	var $_PHPSHOP_ORDER_CANCEL_MNU = 'Zruöit objedn·vku';
	...
	var $_PHPSHOP_ORDER_LIST_ID = '»Ìslo objedn·vky';
	var $_PHPSHOP_ORDER_LIST_CDATE = 'Datum objedn·vky';
	var $_PHPSHOP_ORDER_LIST_MDATE = 'Naposledy zmÏnÏno';
	var $_PHPSHOP_ORDER_LIST_STATUS = 'Stav';
	var $_PHPSHOP_ORDER_LIST_TOTAL = 'MezisouËet';
	var $_PHPSHOP_ORDER_ITEM = 'ObjednanÈ zboûÌ';
	var $_PHPSHOP_ORDER_PRINT_PO_LBL = 'Objedn·vka';
	var $_PHPSHOP_ORDER_PRINT_PO_NUMBER = '»Ìslo objedn·vky';
	var $_PHPSHOP_ORDER_PRINT_PO_DATE = 'Datum objedn·vky';
	var $_PHPSHOP_ORDER_PRINT_PO_STATUS = 'Stav objedn·vky';
	var $_PHPSHOP_ORDER_PRINT_CUST_INFO_LBL = '⁄daje o z·kaznÌkovi';
	var $_PHPSHOP_ORDER_PRINT_CUST_BILLING_LBL = 'FakturaËnÌ ˙daje';
	...
	var $_PHPSHOP_ORDER_PRINT_NAME = 'JmÈno';
	...
	var $_PHPSHOP_ORDER_PRINT_CITY = 'MÏsto';
	...
	var $_PHPSHOP_ORDER_PRINT_ITEMS_LBL = 'ObjednanÈ zboûÌ';
	var $_PHPSHOP_ORDER_PRINT_QUANTITY = 'MnoûstvÌ';
	var $_PHPSHOP_ORDER_PRINT_QTY = 'ks';
	var $_PHPSHOP_ORDER_PRINT_SKU = 'KÛd';
	var $_PHPSHOP_ORDER_PRINT_PRICE = 'Cena';
	var $_PHPSHOP_ORDER_PRINT_TOTAL = 'Celkem';
	var $_PHPSHOP_ORDER_PRINT_SUBTOTAL = 'MezisouËet';
	var $_PHPSHOP_ORDER_PRINT_TOTAL_TAX = 'DPH celkem';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING = 'DopravnÈ a balnÈ';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_TAX = 'DPH pro dopravnÈ a balnÈ';
	var $_PHPSHOP_ORDER_PRINT_PAYMENT_LBL = 'Zp˘sob platby';
	var $_PHPSHOP_ORDER_PRINT_ACCOUNT_NAME = 'JmÈno ˙Ëtu';
	var $_PHPSHOP_ORDER_PRINT_ACCOUNT_NUMBER = '»Ìslo ˙Ëtu';
	var $_PHPSHOP_ORDER_PRINT_EXPIRE_DATE = 'Platnost do';
	var $_PHPSHOP_ORDER_PRINT_PAYMENT_LOG_LBL = 'Z·znam plateb';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_LBL = 'Informace o dod·nÌ';
	var $_PHPSHOP_ORDER_PRINT_PAYINFO_LBL = 'Informace o platbÏ';
	...
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_PRICE_LBL = 'DopravnÈ';
	var $_PHPSHOP_ORDER_STATUS_LIST_MNU = 'Seznam stav˘ objedn·vky';
	var $_PHPSHOP_ORDER_STATUS_FORM_MNU = 'P¯idat stav objedn·vky';
	var $_PHPSHOP_ORDER_STATUS_LIST_CODE = 'KÛd stavu objedn·vky';
	var $_PHPSHOP_ORDER_STATUS_LIST_NAME = 'N·zev stavu objedn·vky';
	var $_PHPSHOP_ORDER_STATUS_FORM_LBL = 'Stav objedn·vky';
	var $_PHPSHOP_ORDER_STATUS_FORM_CODE = 'KÛd stavu objedn·vky';
	var $_PHPSHOP_ORDER_STATUS_FORM_NAME = 'N·zev stavu objedn·vky';
	var $_PHPSHOP_ORDER_STATUS_FORM_LIST_ORDER = 'Po¯adÌ';
	var $_PHPSHOP_PRODUCT_MOD = 'ZboûÌ';
	var $_PHPSHOP_CURRENT_PRODUCT = 'Aktu·lnÌ zboûÌ';
	var $_PHPSHOP_CURRENT_ITEM = 'Aktu·lnÌ poloûka';
	var $_PHPSHOP_PRODUCT_INVENTORY_LBL = 'Seznam zboûÌ';
	var $_PHPSHOP_PRODUCT_INVENTORY_MNU = 'Zobrazit seznam';
	var $_PHPSHOP_PRODUCT_INVENTORY_PRICE = 'Cena';
	var $_PHPSHOP_PRODUCT_INVENTORY_STOCK = 'PoËet';
	var $_PHPSHOP_PRODUCT_INVENTORY_WEIGHT = 'Hmotnost';
	var $_PHPSHOP_PRODUCT_LIST_MNU = 'Seznam zboûÌ';
	var $_PHPSHOP_PRODUCT_LIST_LBL = 'Seznam zboûÌ';
	var $_PHPSHOP_PRODUCT_LIST_NAME = 'N·zev zboûÌ';
	var $_PHPSHOP_PRODUCT_LIST_SKU = 'KÛd';
	var $_PHPSHOP_PRODUCT_LIST_PUBLISH = 'Publikovat';
	var $_PHPSHOP_PRODUCT_LIST_SEARCH_BY_DATE = 'Vyhledej zboûÌ';
	...
	var $_PHPSHOP_PRODUCT_LIST_SEARCH_BY_DATE_TYPE_WITHOUTPRICE = 'bez zadanÈ ceny';
	var $_PHPSHOP_PRODUCT_LIST_SEARCH_BY_DATE_AFTER = 'po';
	var $_PHPSHOP_PRODUCT_LIST_SEARCH_BY_DATE_BEFORE = 'p¯ed';
	var $_PHPSHOP_PRODUCT_FORM_MNU = 'P¯idat zboûÌ';
	var $_PHPSHOP_PRODUCT_FORM_EDIT_PRODUCT = 'Editovat toto zboûÌ';
	var $_PHPSHOP_PRODUCT_FORM_SHOW_FLYPAGE = 'N·hled str·nky zboûÌ v obchodÏ';
	var $_PHPSHOP_PRODUCT_FORM_ADD_ITEM_MNU = 'P¯idat poloûku';
	var $_PHPSHOP_PRODUCT_FORM_ADD_ANOTHER_ITEM_MNU = 'P¯idat dalöÌ poloûku';
	var $_PHPSHOP_PRODUCT_FORM_NEW_PRODUCT_LBL = 'NovÈ zboûÌ';
	var $_PHPSHOP_PRODUCT_FORM_UPDATE_PRODUCT_LBL = 'Upravit zboûÌ';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_INFO_LBL = 'Informace o zboûÌ';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_STATUS_LBL = 'Stav  zboûÌ';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_DIM_WEIGHT_LBL = 'RozmÏry a hmotnost zboûÌ';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_IMAGES_LBL = 'Obr·zky zboûÌ';
	var $_PHPSHOP_PRODUCT_FORM_NEW_ITEM_LBL = 'Nov· poloûka';
	var $_PHPSHOP_PRODUCT_FORM_UPDATE_ITEM_LBL = 'Upravit poloûku';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_INFO_LBL = 'Informace o poloûce';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_STATUS_LBL = 'Stav poloûky';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_DIM_WEIGHT_LBL = 'RozmÏry a hmotnost poloûky';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_IMAGES_LBL = 'Obr·zky poloûky';
	var $_PHPSHOP_PRODUCT_FORM_RETURN_LBL = 'N·vrat k nad¯azenÈmu zboûÌ';
	var $_PHPSHOP_PRODUCT_FORM_IMAGE_UPDATE_LBL = 'Pro aktualizaci obr·zku zadejte cestu k novÈmu obr·zku.';
	var $_PHPSHOP_PRODUCT_FORM_IMAGE_DELETE_LBL = 'Napiöte ';
	var $_PHPSHOP_PRODUCT_FORM_PRODUCT_ITEMS_LBL = 'Poloûky zboûÌ';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_ATTRIBUTES_LBL = 'Vlastnosti poloûky';
	var $_PHPSHOP_PRODUCT_FORM_DELETE_PRODUCT_MSG = 'Jste si jist ûe chcete smazat toto zboûÌ\\na poloûky k nÏmu p¯ipojenÈ?';
	var $_PHPSHOP_PRODUCT_FORM_DELETE_ITEM_MSG = 'Jste si jist ûe chcete smazat tuto poloûku?';
	var $_PHPSHOP_PRODUCT_FORM_VENDOR = 'Prodejce';
	var $_PHPSHOP_PRODUCT_FORM_MANUFACTURER = 'V˝robce';
	var $_PHPSHOP_PRODUCT_FORM_SKU = 'KÛd';
	var $_PHPSHOP_PRODUCT_FORM_NAME = 'JmÈno';
	...
	var $_PHPSHOP_PRODUCT_FORM_DESCRIPTION = 'Popis str·nky zboûÌ';
	var $_PHPSHOP_PRODUCT_FORM_S_DESC = 'Kr·tk˝ popis';
	var $_PHPSHOP_PRODUCT_FORM_IN_STOCK = 'Na skladÏ';
	...
	var $_PHPSHOP_PRODUCT_FORM_LENGTH = 'DÈlka';
	var $_PHPSHOP_PRODUCT_FORM_WIDTH = 'äÌ¯ka';
	var $_PHPSHOP_PRODUCT_FORM_HEIGHT = 'V˝öka';
	var $_PHPSHOP_PRODUCT_FORM_DIMENSION_UOM = 'Jednotka dÈlky';
	...
	var $_PHPSHOP_PRODUCT_FORM_PACKAGING = 'Jednotek v balenÌ';
	var $_PHPSHOP_PRODUCT_FORM_PACKAGING_DESCRIPTION = 'Zde m˘ûete vyplnit poËet jednotek v balenÌ. (max. 65535)';
	var $_PHPSHOP_PRODUCT_FORM_BOX = 'Jednotek v krabici';
	var $_PHPSHOP_PRODUCT_FORM_BOX_DESCRIPTION = 'Zde m˘ûete vyplnit poËet jednotek v krabici. (max. 65535)';
	var $_PHPSHOP_PRODUCT_DISPLAY_ADD_PRODUCT_LBL = 'V˝sledek p¯id·nÌ zboûÌ';
	var $_PHPSHOP_PRODUCT_DISPLAY_UPDATE_PRODUCT_LBL = 'V˝sledek ˙pravy zboûÌ';
	var $_PHPSHOP_PRODUCT_DISPLAY_ADD_ITEM_LBL = 'V˝sledek p¯id·nÌ poloûky';
	var $_PHPSHOP_PRODUCT_DISPLAY_UPDATE_ITEM_LBL = 'V˝sledek ˙pravy poloûky';
	var $_PHPSHOP_PRODUCT_CSV_UPLOAD = 'PouûÌt upload CSV';
	var $_PHPSHOP_PRODUCT_FOLDERS = 'Sloûky zboûÌ';
	var $_PHPSHOP_CATEGORY_LIST_MNU = 'Seznam kategoriÌ';
	var $_PHPSHOP_CATEGORY_LIST_LBL = 'Strom kategoriÌ';
	...
	var $_PHPSHOP_ATTRIBUTE_LIST_ORDER = 'Po¯adÌ seznamu (list order)';
	var $_PHPSHOP_ATTRIBUTE_FORM_MNU = 'P¯idat atribut';
	var $_PHPSHOP_ATTRIBUTE_FORM_LBL = 'Formul·¯ atributu';
	var $_PHPSHOP_ATTRIBUTE_FORM_NEW_FOR_PRODUCT = 'Nov˝ atribut pro zboûÌ';
	var $_PHPSHOP_ATTRIBUTE_FORM_UPDATE_FOR_PRODUCT = 'Upravit atribut zboûÌ';
	var $_PHPSHOP_ATTRIBUTE_FORM_NEW_FOR_ITEM = 'Nov˝ atribut pro poloûku';
	var $_PHPSHOP_ATTRIBUTE_FORM_UPDATE_FOR_ITEM = 'Upravit atribut pro poloûku';
	var $_PHPSHOP_ATTRIBUTE_FORM_NAME = 'N·zev atributu';
	var $_PHPSHOP_ATTRIBUTE_FORM_ORDER = 'Po¯adÌ';
	var $_PHPSHOP_PRICE_LIST_MNU = 'Seznam kategoriÌ';
	...
	var $_PHPSHOP_PRODUCT_LIST_CURRENCY = 'MÏna';
	var $_PHPSHOP_PRICE_FORM_MNU = 'P¯idat cenu';
	var $_PHPSHOP_PRICE_FORM_LBL = 'Informace o cenÏ';
	var $_PHPSHOP_PRICE_FORM_NEW_FOR_PRODUCT = 'Nov· cena zboûÌ';
	var $_PHPSHOP_PRICE_FORM_UPDATE_FOR_PRODUCT = 'Upravit cenu zboûÌ';
	var $_PHPSHOP_PRICE_FORM_NEW_FOR_ITEM = 'Nov· cena poloûky';
	var $_PHPSHOP_PRICE_FORM_UPDATE_FOR_ITEM = 'Upravit cenu poloûky';
	var $_PHPSHOP_PRICE_FORM_PRICE = 'Cena';
	var $_PHPSHOP_PRICE_FORM_CURRENCY = 'MÏna';
	var $_PHPSHOP_PRICE_FORM_GROUP = 'Skupina z·kaznÌk˘';
	var $_PHPSHOP_REPORTBASIC_MOD = 'Sestavy';
	var $_PHPSHOP_RB_INDIVIDUAL = 'Individu·lnÌ v˝pis zboûÌ';
	...
	var $_PHPSHOP_RB_INTERVAL_MONTHLY_TITLE = 'MÏsÌËnÌ';
	var $_PHPSHOP_RB_INTERVAL_WEEKLY_TITLE = 'T˝dennÌ';
	var $_PHPSHOP_RB_INTERVAL_DAILY_TITLE = 'DennÌ';
	var $_PHPSHOP_RB_THISMONTH_BUTTON = 'Tento mÏsÌc';
	var $_PHPSHOP_RB_LASTMONTH_BUTTON = 'Minul˝ mÏsÌc';
	var $_PHPSHOP_RB_LAST60_BUTTON = 'PoslednÌch 60 dnÌ';
	var $_PHPSHOP_RB_LAST90_BUTTON = 'PoslednÌch 90 dnÌ';
	var $_PHPSHOP_RB_START_DATE_TITLE = 'ZaË·tek';
	var $_PHPSHOP_RB_END_DATE_TITLE = 'Konec';
	var $_PHPSHOP_RB_SHOW_SEL_RANGE = 'Zobrazit vybranÈ obdobÌ ';
	var $_PHPSHOP_RB_REPORT_FOR = 'Sestava pro ';
	var $_PHPSHOP_RB_DATE = 'Datum';
	var $_PHPSHOP_RB_ORDERS = 'Objedn·vky';
	var $_PHPSHOP_RB_TOTAL_ITEMS = 'Celkem prod·no poloûek';
	var $_PHPSHOP_RB_REVENUE = 'Trûba';
	var $_PHPSHOP_RB_PRODLIST = 'V˝pis zboûÌ';
	var $_PHPSHOP_SHOP_MOD = 'Obchod';
	var $_PHPSHOP_PRODUCT_THUMB_TITLE = 'Obr·zek';
	var $_PHPSHOP_PRODUCT_PRICE_TITLE = 'Cena';
	var $_PHPSHOP_ORDER_STATUS_P = 'Nevy¯Ìzeno';
	var $_PHPSHOP_ORDER_STATUS_C = 'Potvrzeno';
	var $_PHPSHOP_ORDER_STATUS_X = 'Zruöeno';
	var $_PHPSHOP_ORDER_BUTTON = 'Objednat';
	var $_PHPSHOP_SHOPPER_MOD = 'Z·kaznÌci';
	var $_PHPSHOP_SHOPPER_LIST_MNU = 'Seznam z·kaznÌk˘';
	var $_PHPSHOP_SHOPPER_LIST_LBL = 'Seznam z·kaznÌk˘';
	var $_PHPSHOP_SHOPPER_LIST_USERNAME = 'UûivatelskÈ jmÈno';
	var $_PHPSHOP_SHOPPER_LIST_NAME = 'PlnÈ jmÈno';
	var $_PHPSHOP_SHOPPER_LIST_GROUP = 'Skupina';
	var $_PHPSHOP_SHOPPER_FORM_MNU = 'P¯idat z·kaznÌka';
	var $_PHPSHOP_SHOPPER_FORM_LBL = 'Informace o z·kaznÌkovi';
	var $_PHPSHOP_SHOPPER_FORM_BILLTO_LBL = 'FakturaËnÌ informace';
	var $_PHPSHOP_SHOPPER_FORM_ADDRESS_INFO_LBL = 'Informace';
	var $_PHPSHOP_SHOPPER_FORM_SHIPTO_LBL = 'Informace o dopravÏ';
	var $_PHPSHOP_SHOPPER_FORM_ADD_SHIPTO_LBL = 'P¯idat adresu';
	var $_PHPSHOP_SHOPPER_FORM_ADDRESS_LABEL = 'Zkratka adresy';
	var $_PHPSHOP_SHOPPER_FORM_USERNAME = 'UûivatelskÈ jmÈno';
	var $_PHPSHOP_SHOPPER_FORM_FIRST_NAME = 'K¯estnÌ jmÈno';
	var $_PHPSHOP_SHOPPER_FORM_LAST_NAME = 'P¯ÌjmenÌ';
	var $_PHPSHOP_SHOPPER_FORM_MIDDLE_NAME = 'Prost¯ednÌ jmÈno';
	var $_PHPSHOP_SHOPPER_FORM_TITLE = 'Titul';
	var $_PHPSHOP_SHOPPER_FORM_SHOPPERNAME = 'JmÈno z·kaznÌka';
	var $_PHPSHOP_SHOPPER_FORM_PASSWORD_1 = 'Heslo';
	var $_PHPSHOP_SHOPPER_FORM_PASSWORD_2 = 'Potvrdit heslo';
	var $_PHPSHOP_SHOPPER_FORM_GROUP = 'Skupina z·kaznÌk˘';
	...
	var $_PHPSHOP_SHOPPER_FORM_CITY = 'MÏsto';
	...
	var $_PHPSHOP_SHOPPER_FORM_PHONE2 = 'MobilnÌ telefon';
	...
	var $_PHPSHOP_SHOPPER_GROUP_LIST_MNU = 'Seznam skupin z·kaznÌk˘';
	var $_PHPSHOP_SHOPPER_GROUP_LIST_LBL = 'Seznam skupin z·kaznÌk˘';
	var $_PHPSHOP_SHOPPER_GROUP_LIST_NAME = 'N·zev skupiny';
	var $_PHPSHOP_SHOPPER_GROUP_LIST_DESCRIPTION = 'Popis skupiny';
	var $_PHPSHOP_SHOPPER_GROUP_FORM_LBL = 'Formul·¯ skupiny z·kaznÌk˘';
	var $_PHPSHOP_SHOPPER_GROUP_FORM_MNU = 'P¯idat skupinu z·kaznÌk˘';
	...
	var $_PHPSHOP_STORE_FORM_MNU = 'NastavenÌ obchodu';
	var $_PHPSHOP_STORE_FORM_LBL = 'Informace o obchodÏ';
	var $_PHPSHOP_STORE_FORM_CONTACT_LBL = 'KontaktnÌ informace';
	var $_PHPSHOP_STORE_FORM_FULL_IMAGE = 'Logo firmy v plnÈ velikosti';
	...
	var $_PHPSHOP_STORE_FORM_CITY = 'MÏsto';
	...
	var $_PHPSHOP_STORE_FORM_CURRENCY = 'MÏna';
	var $_PHPSHOP_STORE_FORM_CATEGORY = 'Kategorie obchodu';
	var $_PHPSHOP_STORE_FORM_LAST_NAME = 'P¯ÌjmenÌ';
	var $_PHPSHOP_STORE_FORM_FIRST_NAME = 'K¯estnÌ jmÈno';
	var $_PHPSHOP_STORE_FORM_MIDDLE_NAME = 'Prost¯ednÌ jmÈno';
	...
	var $_PHPSHOP_PAYMENT_METHOD_LIST_CODE = 'KÛd';
	var $_PHPSHOP_PAYMENT_METHOD_LIST_DISCOUNT = 'Sleva';
	var $_PHPSHOP_PAYMENT_METHOD_LIST_SHOPPER_GROUP = 'Skupina z·kaznÌk˘';
	...
	var $_PHPSHOP_PAYMENT_METHOD_FORM_SHOPPER_GROUP = 'Skupina z·kaznÌk˘';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_DISCOUNT = 'Sleva';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_CODE = 'KÛd';
	var $_PHPSHOP_PAYMENT_METHOD_FORM_LIST_ORDER = 'Po¯adÌ';
	...
	var $_PHPSHOP_TAX_LIST_COUNTRY = 'Sazba DPH ve st·tÏ';
	...
	var $_PHPSHOP_TAX_FORM_COUNTRY = 'Sazba DPH ve st·tÏ';
	var $_PHPSHOP_TAX_FORM_RATE = 'Sazba danÏ (pro 19% => vloûte 0.19)';
	...
	var $_PHPSHOP_VENDOR_FORM_CONTACT_LBL = 'KontaktnÌ ˙daje';
	var $_PHPSHOP_VENDOR_FORM_FULL_IMAGE = 'Logo v plnÈ velikosti';
	...
	var $_PHPSHOP_VENDOR_FORM_CITY = 'MÏsto';
	...
	var $_PHPSHOP_VENDOR_FORM_CURRENCY = 'MÏna';
	var $_PHPSHOP_VENDOR_FORM_CATEGORY = 'Kategorie prodejce';
	var $_PHPSHOP_VENDOR_FORM_LAST_NAME = 'P¯ÌjmenÌ';
	var $_PHPSHOP_VENDOR_FORM_FIRST_NAME = 'K¯estnÌ jmÈno';
	var $_PHPSHOP_VENDOR_FORM_MIDDLE_NAME = 'Prost¯ednÌ jmÈno';
	...
	var $_PHPSHOP_VENDOR_CAT_LIST_MNU = 'Seznam kategoriÌ prodejc˘';
	var $_PHPSHOP_VENDOR_CAT_LIST_LBL = 'Seznam kategoriÌ prodejc˘';
	...
	var $_PHPSHOP_MANUFACTURER_CAT_LIST_MNU = 'Seznam kategoriÌ v˝robc˘';
	...
	var $_PHPSHOP_MANUFACTURER_CAT_FORM_LBL = 'Formul·¯ kategoriÌ v˝robc˘';
	...
	var $_PHPSHOP_HELP_MOD = 'N·povÏda';
	var $_PHPSHOP_CART_ACTION = 'Aktualizovat';
	var $_PHPSHOP_CART_UPDATE = 'Aktualizovat mnoûstvÌ v koöÌku';
	var $_PHPSHOP_CART_DELETE = 'Vyjmout zboûÌ z koöÌku';
	var $_PHPSHOP_PRODUCT_PRICETAG = 'Cena';
	var $_PHPSHOP_PRODUCT_CALL = 'Cena na zavol·nÌ';
	var $_PHPSHOP_PRODUCT_PREVIOUS = 'P¯edchozÌ';
	var $_PHPSHOP_PRODUCT_NEXT = 'DalöÌ';
	var $_PHPSHOP_CART_TAX = 'DPH';
	var $_PHPSHOP_CART_SHIPPING = 'DopravnÈ a balnÈ';
	var $_PHPSHOP_CART_TOTAL = 'Celkem';
	var $_PHPSHOP_CHECKOUT_NEXT = 'DalöÌ';
	var $_PHPSHOP_CHECKOUT_REGISTER = 'Registrovat';
	var $_PHPSHOP_CHECKOUT_CONF_BILLINFO = 'FakturaËnÌ ˙daje';
	var $_PHPSHOP_CHECKOUT_CONF_COMPANY = 'Firma';
	var $_PHPSHOP_CHECKOUT_CONF_NAME = 'JmÈno';
	...
	var $_PHPSHOP_CHECKOUT_CONF_SHIPINFO = '⁄daje pro dod·nÌ';
	var $_PHPSHOP_CHECKOUT_CONF_SHIPINFO_COMPANY = 'Firma';
	var $_PHPSHOP_CHECKOUT_CONF_SHIPINFO_NAME = 'JmÈno';
	...
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_NAMECARD = 'JmÈno na kartÏ';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_METHOD = 'Zp˘sob platby';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_CCNUM = '»Ìslo kreditnÌ karty';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_EXDATE = 'PlatÌ do';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_COMPORDER = 'DokonËit objedn·vku';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_REQINFO = 'poûadovanÈ ˙daje p¯i platbÏ kreditnÌ kartou';
	var $_PHPSHOP_ZONE_MOD = 'Dod·vka podle zÛn';
	var $_PHPSHOP_ZONE_LIST_MNU = 'V˝pis zÛn';
	var $_PHPSHOP_ZONE_FORM_MNU = 'P¯idat zÛnu';
	var $_PHPSHOP_ZONE_ASSIGN_MNU = 'P¯i¯adit zÛny';
	var $_PHPSHOP_ZONE_ASSIGN_COUNTRY_LBL = 'ZemÏ';
	var $_PHPSHOP_ZONE_ASSIGN_CURRENT_LBL = 'Vybran· zÛna';
	var $_PHPSHOP_ZONE_ASSIGN_ASSIGN_LBL = 'P¯i¯adit do zÛny';
	var $_PHPSHOP_ZONE_ASSIGN_UPDATE_LBL = 'Aktualizovat';
	var $_PHPSHOP_ASSIGN_ZONE_PG_LBL = 'P¯i¯adit zÛny';
	var $_PHPSHOP_ZONE_FORM_NAME_LBL = 'N·zev zÛny';
	var $_PHPSHOP_ZONE_FORM_DESC_LBL = 'Popis zÛny';
	var $_PHPSHOP_ZONE_FORM_COST_PER_LBL = 'Cena za poloûku pro zÛnu';
	var $_PHPSHOP_ZONE_FORM_COST_LIMIT_LBL = 'Limit ceny pro zÛnu';
	var $_PHPSHOP_ZONE_LIST_LBL = 'Seznam zÛn';
	var $_PHPSHOP_ZONE_LIST_NAME_LBL = 'N·zev zÛny';
	var $_PHPSHOP_ZONE_LIST_DESC_LBL = 'Popis zÛny';
	var $_PHPSHOP_ZONE_LIST_COST_PER_LBL = 'Cena za poloûku pro zÛnu';
	var $_PHPSHOP_ZONE_LIST_COST_LIMIT_LBL = 'Limit ceny pro zÛnu';
	var $_PHPSHOP_LOGIN_FIRST = 'Nejd¯Ìve se prosÌm p¯ihlate.<br>DÏkujeme.';
	var $_PHPSHOP_STORE_FORM_TOS = 'ObchodnÌ podmÌnky';
	var $_PHPSHOP_AGREE_TO_TOS = 'Nejd¯Ìve musÌte souhlasit s naöimi obchodnÌmi podmÌnkami.';
	var $_PHPSHOP_I_AGREE_TO_TOS = 'SouhlasnÌm s obchodnÌmi podmÌnkami';
	var $_PHPSHOP_LEAVE_BLANK = '(nechte PR¡ZDN… pokud <br /> pro to nem·te û·dn˝ individu·lnÌ php soubor!)';
	var $_PHPSHOP_RETURN_LOGIN = 'M·te jiû ˙Ëet: P¯ihlaöte se prosÌm';
	var $_PHPSHOP_NEW_CUSTOMER = 'Nov˝ z·kaznÌk? PoskytnÏte prosÌm vaöe fakturaËnÌ ˙daje';
	var $_PHPSHOP_ACC_CUSTOMER_ACCOUNT = '⁄Ëet z·kaznÌka:';
	var $_PHPSHOP_ACC_ORDER_INFO = 'Objedn·vky';
	var $_PHPSHOP_ACC_UPD_BILL = 'Zde m˘ûete upravit vaöe fakturaËnÌ ˙daje.';
	var $_PHPSHOP_ACC_UPD_SHIP = 'Zde m˘ûete p¯idat Ëi upravit vaöe dodacÌ adresy.';
	var $_PHPSHOP_ACC_ACCOUNT_INFO = 'V·ö ˙Ëet';
	var $_PHPSHOP_ACC_SHIP_INFO = 'Informace o dod·nÌ';
	var $_PHPSHOP_ACC_NO_ORDERS = 'Nejsou zde û·dnÈ objedn·vky k zobrazenÌ';
	var $_PHPSHOP_ACC_BILL_DEF = '- StandardnÌ (Stejn· jako fakturaËnÌ)';
	var $_PHPSHOP_SHIPTO_TEXT = 'M˘ûete k vaöemu ˙Ëtu p¯idat dalöÌ mÌsta pro dopravu zboûÌ. Zvolte si prosÌm kÛd nebo zkratku dle vaöeho uv·ûenÌ.';
	var $_PHPSHOP_CONFIG = 'NastavenÌ PHPShopu';
	var $_PHPSHOP_USERS = 'UûivatelÈ';
	var $_PHPSHOP_IS_CC_PAYMENT = 'je platba kreditnÌ kartou?';
	...
	var $_PHPSHOP_RATE_LIST_MNU = 'Seznam dopravnÈho';
	var $_PHPSHOP_RATE_LIST_LBL = 'DopravnÈ';
	var $_PHPSHOP_CARRIER_LIST_NAME_LBL = 'N·zev';
	var $_PHPSHOP_CARRIER_LIST_ORDER_LBL = 'Po¯adÌ';
	var $_PHPSHOP_CARRIER_FORM_MNU = 'Vytvo¯it dopravce';
	var $_PHPSHOP_CARRIER_FORM_LBL = 'Vytvo¯enÌ nebo ˙prava dopravce';
	var $_PHPSHOP_RATE_FORM_MNU = 'Vytvo¯it dopravnÈ';
	var $_PHPSHOP_RATE_FORM_LBL = 'Vytvo¯enÌ nebo ˙prava dopravnÈho';
	var $_PHPSHOP_RATE_FORM_NAME = 'Detaily dopravnÈho';
	var $_PHPSHOP_RATE_FORM_CARRIER = 'Dopravce';
	var $_PHPSHOP_RATE_FORM_COUNTRY = 'St·t:<br /><br /><i>Pro v˝bÏr vÌce st·t˘: pouûijte CTRL a myö</i>';
	...
	var $_PHPSHOP_RATE_FORM_VALUE = 'DopravnÈ';
	var $_PHPSHOP_RATE_FORM_PACKAGE_FEE = 'Vaöe balnÈ';
	var $_PHPSHOP_RATE_FORM_CURRENCY = 'MÏna';
	var $_PHPSHOP_RATE_FORM_VAT_ID = 'DPH';
	var $_PHPSHOP_RATE_FORM_LIST_ORDER = 'Po¯adÌ';
	var $_PHPSHOP_SHIPPING_RATE_LIST_CARRIER_LBL = 'Dopravce';
	var $_PHPSHOP_SHIPPING_RATE_LIST_RATE_NAME = 'Popis dopravnÈho';
	...
	var $_PHPSHOP_CARRIER_FORM_LIST_ORDER = 'Po¯adÌ';
	var $_PHPSHOP_ERR_MSG_CARRIER_EXIST = 'CHYBA: ID dopravce jiû existuje.';
	var $_PHPSHOP_ERR_MSG_CARRIER_ID_REQ = 'CHYBA: Vyberte dopravce.';
	var $_PHPSHOP_ERR_MSG_CARRIER_INUSE = 'CHYBA: NejmÈnÏ jedno dopravnÈ tohoto doprace existuje, smaûte je p¯ed odstranÏnÌm dopravce';
	var $_PHPSHOP_ERR_MSG_CARRIER_NOTFOUND = 'CHYBA: Nelze nalÈzt dopravce s tÌmto ID.';
	var $_PHPSHOP_ERR_MSG_RATE_CARRIER_ID_REQ = 'CHYBA: Vyberte dopravce.';
	var $_PHPSHOP_ERR_MSG_RATE_CARRIER_ID_INV = 'CHYBA: Nelze nalÈzt dopravce s tÌmto ID.';
	var $_PHPSHOP_ERR_MSG_RATE_NAME_REQ = 'CHYBA: Je poûadov·n popisek dopravnÈho.';
	var $_PHPSHOP_ERR_MSG_RATE_COUNTRY_CODE_INV = 'CHYBA: CÌlov˝ st·t je neplatn˝. VÌce st·t˘ oddÏlujte ';
	var $_PHPSHOP_ERR_MSG_RATE_WEIGHT_START_REQ = 'CHYBA: Je poûadov·na minim·lnÌ hmotnost';
	var $_PHPSHOP_ERR_MSG_RATE_WEIGHT_END_REQ = 'CHYBA: Je poûadov·na maxim·lnÌ hmotnost';
	var $_PHPSHOP_ERR_MSG_RATE_WEIGHT_STARTEND_INV = 'CHYBA: Minim·lnÌ hmotnost musÌ b˝t niûöÌ neû maxim·lnÌ';
	var $_PHPSHOP_ERR_MSG_RATE_WEIGHT_VALUE_REQ = 'CHYBA: Zadejte poplatek za dopravnÈ';
	var $_PHPSHOP_ERR_MSG_RATE_CURRENCY_ID_INV = 'CHYBA: Vyberte mÏnu';
	var $_PHPSHOP_ERR_MSG_RATE_ID_REQ = 'CHYBA: DopravnÈ je vyûadov·no';
	var $_PHPSHOP_INFO_MSG_PLEASE_SELECT = 'Vyberte prosÌm';
	var $_PHPSHOP_INFO_MSG_CARRIER = 'Dopravce';
	var $_PHPSHOP_INFO_MSG_SHIPPING_METHOD = 'DopravnÈ';
	var $_PHPSHOP_INFO_MSG_SHIPPING_PRICE = 'Cena';
	var $_PHPSHOP_INFO_MSG_VAT_ZERO_LBL = '0 (-bez DPH-)';
	var $_PHPSHOP_PAYMENT_FORM_CC = 'KreditnÌ karta';
	var $_PHPSHOP_PAYMENT_FORM_USE_PP = 'PouûÌt prost¯ednÌka platby';
	var $_PHPSHOP_PAYMENT_FORM_BANK_DEBIT = 'BankovnÌ pûevod/platba p¯edem';
	var $_PHPSHOP_PAYMENT_FORM_AO = 'HotovÏ / dobÌrkou';
	var $_PHPSHOP_CHECKOUT_MSG_2 = 'Vyberte dodacÌ adresu!';
	var $_PHPSHOP_CHECKOUT_MSG_3 = 'Vyberte zp˘sob dopravy!';
	var $_PHPSHOP_CHECKOUT_MSG_4 = 'Vyberte zp˘sob platby!';
	var $_PHPSHOP_CHECKOUT_MSG_99 = 'Zkontrolujte zadanÈ ˙daje a potvrÔte objedn·vku!';
	...
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCNR = 'Zadejte ËÌslo vaöÌ kreditnÌ karty.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCNAME = 'Zadejte jmÈno na kreditnÌ kartÏ.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCDATE = '»Ìslo kreditnÌ karty je neplatnÈ.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCMON = 'Zadejte mÏsÌc konce platnosti kreditnÌ karty.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCYEAR = 'Zadejte rok konce platnosti kreditnÌ karty.';
	var $_PHPSHOP_CHECKOUT_ERR_CCDATE_INV = 'Datum platnosti je neplatnÈ.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_SHIPTO = 'Vyberte dodejte na adresu.';
	var $_PHPSHOP_CHECKOUT_ERR_CCNUM_INV = 'NeplatnÈ ËÌslo ˙Ëtu.';
	var $_PHPSHOP_CHECKOUT_ERR_EMPTY_CART = 'Nem·te nic v koöÌku!';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CARR = 'CHYBA: Vyberte dopravce!';
	var $_PHPSHOP_CHECKOUT_ERR_RATE_NOT_FOUND = 'CHYBA: VybranÈ dopravnÈ nebylo nalezeno!';
	var $_PHPSHOP_CHECKOUT_ERR_SHIPTO_NOT_FOUND = 'CHYBA: Vaöe dodacÌ adresa nebyla nalezena!';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCDATA = 'CHYBA: ChybÌ ˙daje o kreditnÌ kartÏ...';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCNR_FOUND = 'CHYBA: ChybÌ ËÌslo kreditnÌ karty!';
	var $_PHPSHOP_CHECKOUT_ERR_TEST = '»Ìslo kreditnÌ karty je testovacÌ ËÌslo!';
	var $_PHPSHOP_CHECKOUT_ERR_NO_USER_DATA = 'Uûivatel nebyl nalezen v datab·zi!';
	var $_PHPSHOP_CHECKOUT_ERR_NO_BA_HOLDER_NAME = 'Dosud jste nezadal vlastnÌka bankovnÌho ˙Ëtu.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_IBAN = 'ZatÌm jste nezadal IBAN kÛd svÈ banky.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_BA_NUM = 'ZatÌm jste nezadal ËÌslo ˙Ëtu.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_BANK_SORT = 'ZatÌm jste nezadal kÛd banky.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_BANK_NAME = 'ZatÌm jste nezadal n·zev banky.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_VALID_STEP = 'Pro platbu je nutno zadat poûadovanÈ ˙daje!';
	var $_PHPSHOP_CHECKOUT_MSG_LOG = 'Informace o platbÏ byla uloûena pro pozdÏjöÌ zpracov·nÌ.<br />';
	var $_PHPSHOP_CHECKOUT_ERR_MIN_POV = 'Minim·lnÌ v˝öe objedn·vky nebyla splnÏna.';
	var $_PHPSHOP_CHECKOUT_ERR_MIN_POV2 = 'Naöe minim·lnÌ v˝öe objedn·vky je:';
	var $_PHPSHOP_CHECKOUT_PAYMENT_CC = 'Platba kreditnÌ kartou';
	var $_PHPSHOP_CHECKOUT_PAYMENT_OTHER = 'dalöÌ metody platby';
	var $_PHPSHOP_CHECKOUT_PAYMENT_SELECT = 'Vyberte metodu platby:';
	var $_PHPSHOP_STORE_FORM_MPOV = 'Minim·lnÌ hodnota objedn·vky v naöem obchodÏ';
	var $_PHPSHOP_ACCOUNT_BANK_TITLE = '⁄daje o bankovnÌm ˙Ëtu';
	var $_PHPSHOP_ACCOUNT_LBL_BANK_ACCOUNT_NR = '»Ìslo ˙Ëtu';
	var $_PHPSHOP_ACCOUNT_LBL_BANK_SORT_CODE = 'KÛd banky';
	var $_PHPSHOP_ACCOUNT_LBL_BANK_NAME = 'N·zev banky';
	var $_PHPSHOP_ACCOUNT_LBL_BANK_IBAN = 'IBAN';
	var $_PHPSHOP_ACCOUNT_LBL_BANK_ACCOUNT_HOLDER = 'VlastnÌk ˙Ëtu';
	var $_PHPSHOP_MODULES = 'Moduly';
	var $_PHPSHOP_FUNCTIONS = 'Funkce';
	var $_PHPSHOP_SPECIAL_PRODUCTS = 'Zvl·ötnÌ zboûÌ';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_NOTE = 'Napiöte n·m vaöi pozn·mku k objedn·vce pokud pot¯ebujete.';
	var $_PHPSHOP_ORDER_PRINT_CUSTOMER_NOTE = 'Pozn·mka z·kaznÌka';
	var $_PHPSHOP_INCLUDING_TAX = '(vËetnÏ DPH $tax %)';
	var $_PHPSHOP_PLEASE_SEL_ITEM = 'Vyberte poloûku';
	var $_PHPSHOP_PRODUCT_FORM_ITEM_LBL = 'Poloûka';
	var $_PHPSHOP_DOWNLOADS_TITLE = 'Ke staûenÌ';
	var $_PHPSHOP_DOWNLOADS_START = 'St·hnout';
	var $_PHPSHOP_DOWNLOADS_INFO = 'ProsÌme vloûte kÛd souboru pro staûenÌ, kter˝ jste obdrûeli e-mailem a kliknÏte na \'St·hnout\'.';
	var $_PHPSHOP_DOWNLOADS_ERR_EXP = 'Litujeme, ale pro staûenÌ vaöich soubor˘ uplynula vymezen· lh˘ta';
	var $_PHPSHOP_DOWNLOADS_ERR_MAX = 'Litujeme, ale byl dosaûen maxim·lnÌ poËet staûenÌ';
	var $_PHPSHOP_DOWNLOADS_ERR_INV = 'Neplatn˝ kÛd souboru pro staûenÌ!';
	var $_PHPSHOP_DOWNLOADS_ERR_SEND = 'Nemohu poslat zpr·vu na ';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG = 'Zpr·va odesl·na na ';
	var $_PHPSHOP_DOWNLOADS_SEND_SUBJ = 'Informace o stahov·nÌ';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_1 = 'soubor(y), kterÈ jste objednali jsou p¯ipraveny ke staûenÌ';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_2 = 'ProsÌme zadejte n·sledujÌcÌ kÛd(y) soubor˘ v naöÌ sekci \'Ke staûenÌ\' ';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_3 = 'maxim·lnÌ poËet staûenÌ pro kaûd˝ soubor je: ';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_4 = 'St·hnÏte dokud neuplyne lh˘ta  {expire} dn˘ po staûenÌ prvnÌho souboru';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_5 = 'Dotazy? ProblÈmy?';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG_6 = 'Informace o souborech ke staûenÌ od ';
	var $_PHPSHOP_PRODUCT_FORM_DOWNLOADABLE = 'zboûÌ ke staûenÌ?';
	var $_PHPSHOP_PAYPAL_THANKYOU = 'DÏkujeme V·m za Vaöi platbu. 
	...
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER1 = 'DÏkujeme za V·ö n·kup. N·sleduje rekapitulace vaöÌ objedn·vky.';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER2 = 'DÏkujeme V·m za p¯ÌzeÚ a tÏöÌme se na dalöÌ spolupr·ci.';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER3 = 'M·te dotazy? ProblÈmy?';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER4 = 'Byla p¯ijata n·sledujÌcÌ objedn·vka.';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER5 = 'M˘ûete ji zobrazit kliknutÌm na odkaz.';
	var $_PHPSHOP_CART_ERROR_NO_NEGATIVE = 'Z·pornÈ mnoûstvÌ nenÌ povoleno.';
	var $_PHPSHOP_CART_ERROR_NO_VALID_QUANTITY = 'Vloûte prosÌm platnÈ mnoûstvÌ pro toto zboûÌ.';
	var $_PHPSHOP_CART_STOCK_1 = '0bjednali jste si vÌce zboûÌ neû m·me na skladÏ. ';
	var $_PHPSHOP_CART_STOCK_2 = 'NynÌ m·me $product_in_stock kus˘ zboûÌ skladem. ';
	var $_PHPSHOP_CART_STOCK_3 = 'KliknÏte zde pro umÌstÏnÌ na seznam nevy¯Ìzen˝ch objedn·vek.';
	...
	var $_PHPSHOP_REGISTRATION_FORM_MRS = 'PanÌ.';
	var $_PHPSHOP_REGISTRATION_FORM_DR = 'Ing.';
	var $_PHPSHOP_REGISTRATION_FORM_PROF = 'Mgr.';
	var $_PHPSHOP_DEFAULT = 'V˝chozÌ';
	var $_PHPSHOP_AFFILIATE_MOD = 'Adminjistrace poboËek';
	var $_PHPSHOP_AFFILIATE_LIST_MNU = 'Seznam poboËek';
	var $_PHPSHOP_AFFILIATE_LIST_LBL = 'PoboËky';
	var $_PHPSHOP_AFFILIATE_LIST_AFFILIATE_NAME = 'N·zev poboËky';
	var $_PHPSHOP_AFFILIATE_LIST_AFFILIATE_ACTIVE = 'AktivnÌ';
	var $_PHPSHOP_AFFILIATE_LIST_RATE = 'Sazba';
	var $_PHPSHOP_AFFILIATE_LIST_MONTH_TOTAL = 'Celkem za mÏsÌc';
	var $_PHPSHOP_AFFILIATE_LIST_MONTH_COMMISSION = 'MÏsÌËnÌ provize';
	var $_PHPSHOP_AFFILIATE_LIST_ORDERS = 'Seznam objedn·vek';
	var $_PHPSHOP_AFFILIATE_EMAIL_MNU = 'Poslat e-mail poboËk·m';
	var $_PHPSHOP_AFFILIATE_EMAIL_LBL = 'E-mail poboËk·m';
	var $_PHPSHOP_AFFILIATE_EMAIL_WHO = 'Komu(* = vöem)';
	var $_PHPSHOP_AFFILIATE_EMAIL_CONTENT = 'Text zpr·vy';
	var $_PHPSHOP_AFFILIATE_EMAIL_SUBJECT = 'P¯edmÏt';
	var $_PHPSHOP_AFFILIATE_EMAIL_STATS = 'Vloûit souËasnou statistiku';
	var $_PHPSHOP_AFFILIATE_FORM_RATE = 'Provize (%)';
	var $_PHPSHOP_AFFILIATE_FORM_ACTIVE = 'AktivnÌ?';
	var $_PHPSHOP_DELIVERY_TIME = 'Dod·v·me bÏhem';
	var $_PHPSHOP_DELIVERY_INFORMATION = 'Informace o dod·vce';
	var $_PHPSHOP_MORE_CATEGORIES = 'dalöÌ kategorie';
	var $_PHPSHOP_AVAILABILITY = 'Dostupnost';
	var $_PHPSHOP_CURRENTLY_NOT_AVAILABLE = 'Toto tzboûÌ nenÌ v souËasnÈ dobÏ k dispozici.';
	var $_PHPSHOP_PRODUCT_AVAILABLE_AGAIN = 'Bude opÏt k dispozici: ';
	var $_PHPSHOP_STATISTIC_SUMMARY = 'Ovl·dacÌ panel';
	var $_PHPSHOP_STATISTIC_STATISTICS = 'Statistika';
	var $_PHPSHOP_STATISTIC_CUSTOMERS = 'Z·kaznÌci';
	var $_PHPSHOP_STATISTIC_ACTIVE_PRODUCTS = 'AktivnÌ zboûÌ';
	var $_PHPSHOP_STATISTIC_INACTIVE_PRODUCTS = 'NeaktivnÌ zboûÌ';
	var $_PHPSHOP_STATISTIC_SUM = 'Celkem';
	var $_PHPSHOP_STATISTIC_NEW_ORDERS = 'NovÈ objedn·vky';
	var $_PHPSHOP_STATISTIC_NEW_CUSTOMERS = 'NovÌ z·kaznÌci';
	var $_PHPSHOP_WAITING_LIST_MESSAGE = 'ProsÌme zadejte Vaöi e-mailovou adresu - zaöleme V·m upozornÏnÌ, aû bude zboûÌ opÏt k dispozici. 
                                        Ochrana Vaöich osobnÌch ˙daj˘ vËetnÏ e-mailovÈ adresy podlÈh· platn˝m z·konn˝m ustanovenÌm - Vaöe 
                                        e-mailov· adresa bude pouûita pouze pro v˝öe uveden˝ ˙Ëel. <br /><br />DÏkujeme!';
	var $_PHPSHOP_WAITING_LIST_THANKS = 'DÏkujeme za Ëek·nÌ! <br />D·me V·m vÏdÏt, jakmile p¯ijde zboûÌ.';
	var $_PHPSHOP_WAITING_LIST_NOTIFY_ME = 'UpozornÏte mÏ!';
	...
	var $_PHPSHOP_ADMIN_CFG_DOWNLOADABLEGOODS = 'Stahov·nÌ';
	var $_PHPSHOP_ADMIN_CFG_PAYEMENTOPTIONS = 'Platby';
	var $_PHPSHOP_ADMIN_CFG_USE_ONLY_AS_CATALOGUE = 'PouûÌt pouze jako katalog';
	var $_PHPSHOP_ADMIN_CFG_USE_ONLY_AS_CATALOGUE_EXPLAIN = 'Pokud zaöktnete, vypnete veökerÈ funkce koöÌku.';
	var $_PHPSHOP_ADMIN_CFG_SHOW_PRICES = 'Zobrazit ceny';
	var $_PHPSHOP_ADMIN_CFG_PRICES_INCLUDE_TAX = 'Zobrazit ceny vËetnÏ DPH?';
	var $_PHPSHOP_ADMIN_CFG_PRICES_INCLUDE_TAX_EXPLAIN = 'NastavenÌ, zda kupujÌcÌ vidÌ ceny vËetnÏ nebo bez DPH.';
	var $_PHPSHOP_ADMIN_CFG_SHOW_PRICES_EXPLAIN = 'ZaökrtnÏte pro zobrazenÌ cen. Pokud pouûÌv·te phpshop jako katalog, nemusÌte chtÌt aby se ceny zobrazily.';
	var $_PHPSHOP_ADMIN_CFG_VIRTUAL_TAX = 'Virtu·lnÌ daÚ';
	var $_PHPSHOP_ADMIN_CFG_VIRTUAL_TAX_EXPLAIN = 'NastavenÌ, zda poloûky s nulovou hmotnostÌ jsou zdanÏny (Pozn: v »R ano -> nechte nezaökrtnutÈ). Upravte p¯ÌpadnÏ ps_checkout.php->calc_order_taxable().';
	var $_PHPSHOP_ADMIN_CFG_TAX_MODE = 'Volby sazby DPH:';
	var $_PHPSHOP_ADMIN_CFG_TAX_MODE_SHIP = 'Na z·kladÏ adresy dod·nÌ';
	var $_PHPSHOP_ADMIN_CFG_TAX_MODE_VENDOR = 'Na z·kladÏ adresy prodejce';
	var $_PHPSHOP_ADMIN_CFG_TAX_MODE_EXPLAIN = 'NastavenÌ, jak· sazba DPH se pouûije v p¯ÌpadÏ, ûe:<br />
                                                <ul><li>sazba st·tu, odkud poch·zÌ prodejce</li><br/>
                                                <li>sazba st·tu, odkud poch·zÌ z·kaznÌk.</li></ul>';
	var $_PHPSHOP_ADMIN_CFG_MULTI_TAX_RATE = 'Umoûnit vÌce sazeb DPH?';
	var $_PHPSHOP_ADMIN_CFG_MULTI_TAX_RATE_EXPLAIN = 'ZaökrtnÏte, pokud se pouûÌv· vÌce sazeb DPH (tj. nap¯. 5% na z·kladnÌ potraviny a 19% na ostatnÌ zboûÌ)';
	var $_PHPSHOP_ADMIN_CFG_SUBSTRACT_PAYEMENT_BEFORE = 'OdeËÌst slevu slevu z ceny BEZ DPH/balnÈho/dopravnÈho?';
	var $_PHPSHOP_ADMIN_CFG_REVIEW = 'Povolit koment·¯e / hodnocenÌ';
	var $_PHPSHOP_ADMIN_CFG_REVIEW_EXPLAIN = 'Jestliûe je zaökrtnuto, povolÌte z·kaznÌk˘m <strong>hodnotit zboûÌ</strong> a <strong>ps·t koment·¯e</strong> ke zboûÌ, <br />   
                                                                           takûe z·kaznÌci mohou ps·t koment·¯e o sv˝ch zkuöenostech se zboûÌm pro ostatnÌ z·kaznÌky.<br />';
	var $_PHPSHOP_ADMIN_CFG_SUBSTRACT_PAYEMENT_BEFORE_EXPLAIN = 'NastavenÌ, zda odeËÌst slevu z ceny BEZ DPH/balnÈho/dopravnÈho (zaökrtnuto) nebo V»ETNÃ DPH/balnÈho/dopravnÈho.';
	var $_PHPSHOP_ADMIN_CFG_ACCOUNT_CAN_BE_BLANK = 'Z·kaznÌci mohou zadat svÈ bankovnÌ spojenÌ?';
	var $_PHPSHOP_ADMIN_CFG_ACCOUNT_CAN_BE_BLANK_EXPLAIN = 'Jestliûe je zaökrtnuto, majÌ z·kaznÌci p¯i registraci moûnost zadat svÈ banovnÌ spojenÌ.';
	var $_PHPSHOP_ADMIN_CFG_CAN_SELECT_STATE = 'Z·kaznÌci mohou zadat st·t/region?';
	var $_PHPSHOP_ADMIN_CFG_CAN_SELECT_STATE_EXPLAIN = 'Jestliûe je zaökrtnuto, majÌ z·kaznÌcÌ p¯i registraci moûnost zadat st·t/region. (pozn.: pro »R/SR nechte nezaökrtnutÈ)';
	var $_PHPSHOP_ADMIN_CFG_AGREE_TERMS = 'Vyûadovat souhlas s obchodnÌmi podmÌnkami?';
	var $_PHPSHOP_ADMIN_CFG_AGREE_TERMS_EXPLAIN = 'Jestliûe je zaökrtnuto, z·kaznÌcÌ musÌ odsouhlasit obchodnÌ podmÌnky p¯ed registracÌ.';
	var $_PHPSHOP_ADMIN_CFG_CHECK_STOCK = 'Kontrolovat sklad?';
	var $_PHPSHOP_ADMIN_CFG_CHECK_STOCK_EXPLAIN = 'NastavenÌ, zda kontrolovat mnoûstvÌ zboûÌ na skladÏ p¯i p¯id·nÌ poloûky z·kaznÌkem do koöÌku. 
                                                                                          Pokud je ZAäKRTNUTO, nedovolÌ z·kaznÌkovi p¯idat vÌce poloûek, neû je k dispozici na skladÏ.';
	var $_PHPSHOP_ADMIN_CFG_ENABLE_AFFILIATE = 'Povolit program poboËek?';
	var $_PHPSHOP_ADMIN_CFG_ENABLE_AFFILIATE_EXPLAIN = 'TÌmto umoûnÌte sledov·nÌ poboËek ve frontendu. ZaökrtnÏte, opkud jste zadali poboËky v backendu..';
	var $_PHPSHOP_ADMIN_CFG_MAIL_FORMAT = 'Form·t e-mailovÈ objedn·vky:';
	var $_PHPSHOP_ADMIN_CFG_MAIL_FORMAT_TEXT = 'Textov˝';
	var $_PHPSHOP_ADMIN_CFG_MAIL_FORMAT_HTML = 'HTML';
	var $_PHPSHOP_ADMIN_CFG_MAIL_FORMAT_EXPLAIN = 'TÌmto se nastavÌ, v jakÈm form·tu jsou odesÌl·na e-mailov· potvrzenÌ objedn·vek:<br />
                                                                                        <ul><li>jako prost˝ text</li>
                                                                                        <li>jako form·tovan˝ text (HTML s obr·zky).</li></ul>';
	var $_PHPSHOP_ADMIN_CFG_FRONTENDAMDIN = 'Povolit administraci z frontendu pro uûivatele, kte¯Ì nemajÌ p¯Ìstup do backendu?';
	var $_PHPSHOP_ADMIN_CFG_FRONTENDAMDIN_EXPLAIN = 'TÌmto nastavenÌm umoûnÌte administraci z frontendu pro uûivatele, kte¯Ì 
                                                                                              jsou administr·to¯i obchodu, ale nemajÌ p¯Ìstup do backenu Mamba (tj uûivatelÈ ze skupin Registered / Editor).';
	var $_PHPSHOP_ADMIN_CFG_URL = 'URL';
	var $_PHPSHOP_ADMIN_CFG_URL_EXPLAIN = 'URL Vaöeho webu. Obvykle stejnÈ jako URL Mamba (s lomÌtkem na konci!)';
	var $_PHPSHOP_ADMIN_CFG_URLSECURE = 'SECUREURL';
	var $_PHPSHOP_ADMIN_CFG_URLSECURE_EXPLAIN = 'URL Vaöeho zabezpeËenÈho webu. (https - s lomÌtkem na konci!)';
	var $_PHPSHOP_ADMIN_CFG_URLCOMPONENT = 'COMPONENTURL';
	var $_PHPSHOP_ADMIN_CFG_URLCOMPONENT_EXPLAIN = 'URL komponenty mambo-phpShop. (s lomÌtkem na konci!)';
	var $_PHPSHOP_ADMIN_CFG_URLIMAGE = 'IMAGEURL';
	var $_PHPSHOP_ADMIN_CFG_URLIMAGE_EXPLAIN = 'URL adres·¯e s obr·zky komponenty mambo-phpShop.(s lomÌtkem na konci!)';
	...
	var $_PHPSHOP_ADMIN_CFG_HOMEPAGE_EXPLAIN = 'Str·nka, kter· bude nahr·na jako v˝chozÌ.';
	var $_PHPSHOP_ADMIN_CFG_ERRORPAGE = 'ERRORPAGE';
	var $_PHPSHOP_ADMIN_CFG_ERRORPAGE_EXPLAIN = 'V˝chozÌ str·nka pro zobrazenÌ chybov˝ch zpr·v.';
	var $_PHPSHOP_ADMIN_CFG_DEBUGPAGE = 'DEBUGPAGE';
	var $_PHPSHOP_ADMIN_CFG_DEBUGPAGE_EXPLAIN = 'V˝chozÌ str·nka pro zobrazenÌ ladÌcÌch zpr·v.';
	var $_PHPSHOP_ADMIN_CFG_DEBUG = 'LADÃNÕ ?';
	var $_PHPSHOP_ADMIN_CFG_DEBUG_EXPLAIN = 'LADÃNÕ?  	   	Zapne v˝stup ladÏnÌ. Zp˘sobÌ, ûe se na dolnÌ Ë·sti kaûdÈ str·nky zobrazÌ ladÌcÌ informace. Velmi uûiteËnÈ p¯i v˝voji shopu, protoûe ukazuje obsah koöÌku, hodnoty polÌ ve formul·¯Ìch, atd.';
	var $_PHPSHOP_ADMIN_CFG_FLYPAGE = 'FLYPAGE';
	var $_PHPSHOP_ADMIN_CFG_FLYPAGE_EXPLAIN = 'Toto je v˝chozÌ str·nka pro zobrazenÌ podrobnostÌ o zboûÌ.';
	var $_PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE = 'äablona kategorie';
	var $_PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE_EXPLAIN = 'Definuje v˝chozÌ öablonu kategoriepro zobrazenÌ zboûÌ v kategorii.<br />
                                                                                                      m˘ûete si vytvo¯it novÈ öablony ˙pravou existujÌcÌch soubor˘ öablon,<br />
                                                                                                      (umÌstÏn˝ch v adres·¯i <strong>COMPONENTPATH/html/templates/</strong> a zaËÌnajÌcÌch browse_)';
	var $_PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW = 'V˝chozÌ poËet poloûek na ¯·dku';
	var $_PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW_EXPLAIN = 'Definuje poËet poloûek zboûÌ na ¯·dku. <br />
                                                                                                      Nap¯.: Pokud nastavÌte 4, öablona kategorie zobrazÌ 4 poloûky na ¯·dek';
	var $_PHPSHOP_ADMIN_CFG_NOIMAGEPAGE = 'Obr·zek ';
	var $_PHPSHOP_ADMIN_CFG_NOIMAGEPAGE_EXPLAIN = 'Tento obr·zek bude zobrazen, pokud obr·zek zboûÌ nenÌ k dispozici.';
	var $_PHPSHOP_ADMIN_CFG_SEARCHROWS = 'PoËet ¯·dk˘ v˝sledk˘ hled·nÌ';
	var $_PHPSHOP_ADMIN_CFG_SEARCHROWS_EXPLAIN = 'Definuje poËet ¯·dk˘ v˝sledk˘ hled·nÌ na str·nku.';
	var $_PHPSHOP_ADMIN_CFG_SEARCHCOLOR1 = 'SEARCH COLOR 1';
	var $_PHPSHOP_ADMIN_CFG_SEARCHCOLOR1_EXPLAIN = 'Definuje barvu lich˝ch ¯·dk˘ v˝sledk˘ hled·nÌ.';
	var $_PHPSHOP_ADMIN_CFG_SEARCHCOLOR2 = 'SEARCH COLOR 2';
	var $_PHPSHOP_ADMIN_CFG_SEARCHCOLOR2_EXPLAIN = 'Definuje barvu sud˝ch ¯·dk˘ v˝sledk˘ hled·nÌ.';
	var $_PHPSHOP_ADMIN_CFG_MAXIMUMROWS = 'Max. ¯·dk˘';
	var $_PHPSHOP_ADMIN_CFG_MAXIMUMROWS_EXPLAIN = 'Definuje poËet zobrazen˝ch ¯·dk˘ v seznamu objedn·vek (? order list select box).';
	var $_PHPSHOP_ADMIN_CFG_SHOWPHPSHOP_VERSION = 'Zobrazit ';
	var $_PHPSHOP_ADMIN_CFG_SHOWPHPSHOP_VERSION_EXPLAIN = 'ZobrazÌ obr·zek powered-by-mambo-phpShop v z·patÌ.';
	var $_PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD = 'Vyberte metodu dopravy zboûÌ pouûitou pro V·ö obchod';
	var $_PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_STANDARD = 'StandardnÌ modul dopravy zboûÌ s indiviu·lnÌm nastavenÌm dopravc˘ a sazeb. <strong>DOPORU»ENO !</strong>';
	...
	var $_PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_DISABLE = 'Vypnout v˝bÏr zp˘sobu dopravy. Vyberte, pokud z·kaznÌci kupujÌ zboûÌ ke staûenÌ, kterÈ k nim nemusÌ b˝t dopraveno.';
	...
	var $_PHPSHOP_ADMIN_CFG_STORE_ENCODEKEY = 'äifrovacÌ klÌË';
	var $_PHPSHOP_ADMIN_CFG_STORE_ENCODEKEY_EXPLAIN = 'PoûÌv· se k zaöifrov·nÌ dat v datab·zi. Znamen· to, ûe tento soubor by mÏl nastavena p¯Ìstupov· pr·va, aby nemohl b˝t zobrazen nik˝m nepovolan˝m.';
	var $_PHPSHOP_ADMIN_CFG_ENABLE_CHECKOUTBAR = 'Zobrazit postup odbavenÌ objedn·vky?';
	var $_PHPSHOP_ADMIN_CFG_ENABLE_CHECKOUTBAR_EXPLAIN = 'ZaökrtnÏte, pokud chcete zobrazit  postup odbavenÌ objedn·vky ( 1 - 2 - 3 - 4 s obr·zky).';
	var $_PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS = 'Vyberte postup odbavenÌ objedn·vky';
	var $_PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS_STANDARD = '<strong>StandardnÌ :</strong><br/>
               1. Zad·nÌ dodacÌ adresy<br />
              2. Zad·nÌ zp˘sobu dopravy<br />
              3. Zad·nÌ zp˘sobu platby<br />
              4. PotvrzenÌ objedn·vky';
	var $_PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS_2 = '<strong>Postup 2:</strong><br/>
               1. Zad·nÌ dodacÌ adresy<br />
              2. Zad·nÌ zp˘sobu platby<br />
              3. PotvrzenÌ objedn·vky';
	var $_PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS_3 = '<strong>Postup 3:</strong><br/>
               1. Zad·nÌ zp˘sobu dopravy<br />
              2. Zad·nÌ zp˘sobu platby<br />
              3. PotvrzenÌ objedn·vky';
	var $_PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS_4 = '<strong>Postup 4:</strong><br/>
               1. Zad·nÌ zp˘sobu platby<br />
              2. PotvrzenÌ objedn·vky';
	var $_PHPSHOP_ADMIN_CFG_ENABLE_DOWNLOADS = 'Umoûnit stahov·nÌ zboûÌ';
	var $_PHPSHOP_ADMIN_CFG_ENABLE_DOWNLOADS_EXPLAIN = 'PovolÌ moûnost stahov·nÌ zboûÌ. Pouûijte pouze opkud chcete prod·vat zboûÌ ke staûenÌ.';
	var $_PHPSHOP_ADMIN_CFG_ORDER_ENABLE_DOWNLOADS = 'Stav objedn·vky umoûÚujÌcÌ staûenÌ';
	var $_PHPSHOP_ADMIN_CFG_ORDER_ENABLE_DOWNLOADS_EXPLAIN = 'Vyberte stav objedn·vky p¯i kterÈm je z·kaznÌk e-mailem upozornÏn, ûe je zboûÌ ke staûenÌ.';
	var $_PHPSHOP_ADMIN_CFG_ORDER_DISABLE_DOWNLOADS = 'Stav objedn·vky znemoûÚujÌcÌ staûenÌ';
	var $_PHPSHOP_ADMIN_CFG_ORDER_DISABLE_DOWNLOADS_EXPLAIN = 'Vyberte stav objedn·vky p¯i kterÈm je staûenÌ z·kaznÌkovi znemoûnÏno.';
	var $_PHPSHOP_ADMIN_CFG_DOWNLOADROOT = 'DOWNLOADROOT';
	var $_PHPSHOP_ADMIN_CFG_DOWNLOADROOT_EXPLAIN = 'Fyzick· cesta k soubor˘m ke staûenÌ z·kaznÌky. (lomÌtko na konci!)<br>
        <span class="message">V z·jmu zabezpeËenÌ vaöeho obchodu: Pokud m˘ûete, pouûijte adres·¯ KDEKOLIV MIMO KOÿENOV…HO ADRES¡ÿE VAäEHO WEBU </span>';
	var $_PHPSHOP_ADMIN_CFG_DOWNLOAD_MAX = 'Maximum staûenÌ';
	var $_PHPSHOP_ADMIN_CFG_DOWNLOAD_MAX_EXPLAIN = 'NastavÌ max. op¯et staûenÌ z·kaznÌkem na z·kladÏ jednoho kÛdu zboûÌ ke staûenÌ (na jednu objedn·vku)';
	var $_PHPSHOP_ADMIN_CFG_DOWNLOAD_EXPIRE = 'Lh˘ta pro staûenÌ';
	var $_PHPSHOP_ADMIN_CFG_DOWNLOAD_EXPIRE_EXPLAIN = 'NastavÌ Ëasov˝ interval <strong>v sekund·ch</strong> po kter˝ je z·kaznÌkovi umoûnÏno staûenÌ zboûÌ. 
  Tento interval zaËÌn· prvnÌm staûenÌm! Pokud lh˘ta uplyne, kÛd zboûÌ ke staûenÌ ja zablokov·n.<br />Pozn·mka: 86400s=24h.';
  ...
  select the status which enables the download (then the customer is instantly notified about the download via e-mail).';
	...
	var $_PHPSHOP_ADVANCED_SEARCH = 'RozöÌ¯enÈ vyhled·v·nÌ';
	var $_PHPSHOP_SEARCH_ALL_CATEGORIES = 'Prohled·vat vöechny kategorie';
	var $_PHPSHOP_SEARCH_ALL_PRODINFO = 'Prohled·vat veökerÈ informace o zboûÌ';
	var $_PHPSHOP_SEARCH_PRODNAME = 'Jen n·zvy zboûÌ';
	var $_PHPSHOP_SEARCH_MANU_VENDOR = 'Jen v˝robce Ëi prodejce';
	var $_PHPSHOP_SEARCH_DESCRIPTION = 'Jen popis zboûÌ';
	var $_PHPSHOP_SEARCH_AND = 'and';
	var $_PHPSHOP_SEARCH_NOT = 'not';
	var $_PHPSHOP_SEARCH_TEXT1 = 'Nejd¯Ìve vyberte z rozbalovacÌho seznamu kategorii pro omezenÌ vyhled·v·nÌ. 
        Druh˝ rozbalovacÌ seznam umoûÚuje omezit vyhled·v·nÌ na urËitou Ë·st informace o zboûÌ (nap¯. N·zev).
        Po vybr·nÌ tÏchto doplÚujÌcÌch ˙daj˘ (m˘ûete je ovöem ponechat na standardnÌm nastavenÌ pro hled·nÌ ve vöech ˙dajÌch) vloûte slovo, kterÈ chcete vyhledat.';
	var $_PHPSHOP_SEARCH_TEXT2 = ' M˘ûete d·le zp¯esÚit v·ö v˝bÏr p¯id·nÌm druhÈho klÌËovÈho slova a v˝bÏru logickÈho oper·toru AND, NOT. 
        A znamen· ûe musÌ b˝t obÏ slova v ˙dajÌch vyhledanÈho zboûÌ p¯Ìtomna. 
        Ne znamen· ûe zboûÌ bude vyhled·no, pokud v ˙dajÌch bude p¯Ìtomno prvnÌ slovo a druhÈ ne.';
	var $_PHPSHOP_ORDERBY = 'Se¯adit podle';
	var $_PHPSHOP_CUSTOMER_RATING = 'Pr˘mÏrnÈ hodnocenÌ';
	var $_PHPSHOP_TOTAL_VOTES = 'Celkem hlas˘';
	var $_PHPSHOP_CAST_VOTE = 'ProsÌm hodnoùte';
	var $_PHPSHOP_RATE_BUTTON = 'Hodnotit';
	var $_PHPSHOP_RATE_NOM = 'HodnocenÌ';
	var $_PHPSHOP_REVIEWS = 'HodnocenÌ z·kaznÌk˘';
	var $_PHPSHOP_NO_REVIEWS = 'ZatÌm zde nenÌ û·dnÈ hodnocenÌ.';
	var $_PHPSHOP_WRITE_FIRST_REVIEW = 'Napiöte prvnÌ hodnocenÌ...';
	var $_PHPSHOP_REVIEW_LOGIN = 'MusÌte se p¯ihl·sit, abyste mohlI hodnotit.';
	var $_PHPSHOP_REVIEW_ERR_RATE = 'Ohodnoùte prosÌm poloûku!';
	var $_PHPSHOP_REVIEW_ERR_COMMENT1 = 'Napiöte delöÌ hodnocenÌ, minim·lnÏ 100 znak˘';
	var $_PHPSHOP_REVIEW_ERR_COMMENT2 = 'HodnocenÌ je p¯Ìliö dlouhÈ, povoleno je maxim·lnÏ 2000 znak˘';
	var $_PHPSHOP_WRITE_REVIEW = 'Napiöte vaöe hodnocenÌ tohoto zboûÌ!';
	var $_PHPSHOP_REVIEW_RATE = 'Nejd¯Ìve zboûÌ ohodnoùte. Vyberte mezi 0 (nejhoröÌ) a 5 (nejlepöÌ) hvÏzdiËkama.';
	var $_PHPSHOP_REVIEW_COMMENT = 'NynÌ napiöte hodnocenÌ ....(min. 100, max. 2000 znak˘) ';
	var $_PHPSHOP_REVIEW_COUNT = 'Znak˘ naps·no: ';
	var $_PHPSHOP_REVIEW_SUBMIT = 'Odeslat hodnocenÌ';
	var $_PHPSHOP_REVIEW_ALREADYDONE = 'HodnocenÌ tohoto zboûÌ jste uû napsal. DÏkujeme v·m.';
	var $_PHPSHOP_REVIEW_THANKYOU = 'DÏkujeme v·m za ohodnocenÌ.';
	var $_PHPSHOP_COMMENT = 'Koment·¯';
	var $_PHPSHOP_CREDITCARD_FORM_LBL = 'P¯idat/Upravit typy kreditnÌch karet';
	var $_PHPSHOP_CREDITCARD_NAME = 'N·zev kreditnÌ karty';
	var $_PHPSHOP_CREDITCARD_CODE = 'KÛd kreditnÌ karty';
	var $_PHPSHOP_CREDITCARD_TYPE = 'Typ kreditnÌ karty';
	var $_PHPSHOP_CREDITCARD_LIST_LBL = 'Seznam kreditnÌch karet';
	var $_PHPSHOP_UDATE_ADDRESS = 'Upravit adresu';
	var $_PHPSHOP_CONTINUE_SHOPPING = 'PokraËovat v nakupov·nÌ';
	var $_PHPSHOP_THANKYOU_SUCCESS = 'Vaöe objedn·vka byla ˙spÏönÏ p¯ijata!';
	var $_PHPSHOP_ORDER_LINK = 'KliknÏte zde pro zobrazenÌ detail˘ o objedn·vce.';
	var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_1 = 'stav vaöÌ objedn·vky ËÌslo {order_id} byl zmÏnÏn.';
	var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_2 = 'Nov˝ stav je:';
	var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_3 = 'Pro zobrazenÌ detail˘ o objedn·vce kliknÏte zde nebo zkopÌrujte odkaz do vaöeho prohlÌûeËe:';
	var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_SUBJ = 'ZmÏna stavu objedn·vky: {order_id}';
	var $_PHPSHOP_ORDER_LIST_NOTIFY = 'Informovat z·kaznÌka?';
	var $_PHPSHOP_ORDER_LIST_NOTIFY_ERR = 'Vyberte nejd¯Ìve zmÏnu stavu!';
	var $_PHPSHOP_SHOPPER_GROUP_FORM_DISCOUNT = 'Sleva pro v˝chozÌ skupinu z·kaznÌk˘ (v %)';
	var $_PHPSHOP_SHOPPER_GROUP_FORM_DISCOUNT_TIP = 'Kladn· hodnota X znamen·: Pokud nem· p¯i¯azenu cenu pro TUTO skupinu z·kaznÌk˘, v˝chozÌ cena je snÌûena o X %. Z·porn· hodnota m· opaËn˝ efekt.';
	var $_PHPSHOP_PRODUCT_DISCOUNT_LBL = 'Sleva';
	var $_PHPSHOP_PRODUCT_DISCOUNT_LIST_LBL = 'Seznam slev na zboûÌ';
	var $_PHPSHOP_PRODUCT_DISCOUNT_ADDEDIT = 'P¯idat/upravit slevu';
	var $_PHPSHOP_PRODUCT_DISCOUNT_AMOUNT = '»·stka';
	var $_PHPSHOP_PRODUCT_DISCOUNT_AMOUNT_TIP = 'Zadejte Ë·stku';
	...
	var $_PHPSHOP_PRODUCT_DISCOUNT_ISPERCENT_TIP = 'Je cena ud·v·na jako procento nebo Ë·stka?';
	var $_PHPSHOP_PRODUCT_DISCOUNT_STARTDATE = 'ZaË·tek obdobÌ slevy';
	var $_PHPSHOP_PRODUCT_DISCOUNT_STARTDATE_TIP = 'Ud·v· den, kdy sleva zaËÌn·';
	var $_PHPSHOP_PRODUCT_DISCOUNT_ENDDATE = 'Konec obdobÌ slevy';
	var $_PHPSHOP_PRODUCT_DISCOUNT_ENDDATE_TIP = 'Ud·v· den, kdy sleva konËÌ';
	var $_PHPSHOP_PRODUCT_DISCOUNT_ADDDISCOUNT_TIP = 'K p¯id·nÌ slevy pouûijte formul·¯ slevy danÈho zboûÌ!';
	var $_PHPSHOP_PRODUCT_DISCOUNT_SAVE = 'Uöet¯Ìte';
	var $_PHPSHOP_FLYPAGE_ENLARGE_IMAGE = 'Zobrazit v plnÈ velikosti';
	var $_PHPSHOP_CURRENCY_DISPLAY = 'ZobrazenÌ mÏny';
	var $_PHPSHOP_CURRENCY_SYMBOL = 'Symbol mÏny';
	var $_PHPSHOP_CURRENCY_SYMBOL_TOOLTIP = 'M˘ûet zde pouûÌt i HTML entity  (tj. &euro;,&pound;,&yen;,...)';
	var $_PHPSHOP_CURRENCY_DECIMALS = 'Desetinn· mÌsty';
	var $_PHPSHOP_CURRENCY_DECIMALS_TOOLTIP = 'PoËet desetinn˝ch mÌst (m˘ûe b˝t 0)<br><b>Prov·dÌ se zaokrouhlenÌ, pokud m· hodnota vyööÌ poËet desetinn˝ch mÌst.</b>';
	var $_PHPSHOP_CURRENCY_DECIMALSYMBOL = 'OddÏlovaË desetinn˝ch mÌst';
	var $_PHPSHOP_CURRENCY_DECIMALSYMBOL_TOOLTIP = 'Symbol pro oddÏlenÌ desetinn˝ch mÌst (obvykle \',\') symbol';
	var $_PHPSHOP_CURRENCY_THOUSANDS = 'OddÏlovaË tisÌc˘';
	var $_PHPSHOP_CURRENCY_THOUSANDS_TOOLTIP = 'Symbol pro oddÏlenÌ tisÌc˘  (obvykle mezera nabo m˘ûe b˝t pr·zdn˝)';
	var $_PHPSHOP_CURRENCY_POSITIVE_DISPLAY = 'Form·t kladnÈho ËÌsla';
	var $_PHPSHOP_CURRENCY_POSITIVE_DISPLAY_TOOLTIP = 'Form·t pro zobrazenÌ kladn˝ch ËÌsel.<br>(Symb = symbol mÏny)';
	var $_PHPSHOP_CURRENCY_NEGATIVE_DISPLAY = 'Form·t z·pornÈho ËÌsla';
	var $_PHPSHOP_CURRENCY_NEGATIVE_DISPLAY_TOOLTIP = 'Form·t pro zobrazenÌ z·porn˝ch ËÌsel.<br>(Symb = symbol mÏny)';
	var $_PHPSHOP_OTHER_LISTS = 'DalöÌ seznamy zboûÌ';
	var $_PHPSHOP_MORE_IMAGES = 'Zobrazit vÌce obr·zk˘';
	var $_PHPSHOP_AVAILABLE_IMAGES = 'DostupnÈ obr·zky pro';
	var $_PHPSHOP_BACK_TO_DETAILS = 'ZpÏt k detail˘m o zboûÌ';
	var $_PHPSHOP_FILEMANAGER = 'Spr·vce soubor˘';
	var $_PHPSHOP_FILEMANAGER_LIST = 'Spr·vce soubor˘::Seznam zboûÌ';
	var $_PHPSHOP_FILEMANAGER_ADD = 'P¯idat obr·zek/soubor';
	var $_PHPSHOP_FILEMANAGER_IMAGES = 'P¯i¯azenÈ obr·zky';
	var $_PHPSHOP_FILEMANAGER_DOWNLOADABLE = 'Ke staûenÌ?';
	var $_PHPSHOP_FILEMANAGER_FILES = 'P¯i¯azenÈ soubory (katalog. listy,...)';
	...
	var $_PHPSHOP_FILES_FORM_UPLOAD_IMAGEPATH = 'v˝chozÌho umÌstÏnÌ obr·zk˘';
	var $_PHPSHOP_FILES_FORM_UPLOAD_OWNPATH = 'Zadejte umÌstÏnÌ';
	var $_PHPSHOP_FILES_FORM_UPLOAD_DOWNLOADPATH = 'UmÌstÏnÌ soubor˘ ke staûenÌ (P¯i prodeji zboûÌ ke staûenÌ!)';
	...
	var $_PHPSHOP_FILES_FORM_FILE_TITLE = 'Titulek souboru (co vidÌ z·kaznÌk)';
	var $_PHPSHOP_FILES_FORM_FILE_DESC = 'Popis souboru';
	var $_PHPSHOP_FILES_FORM_FILE_URL = 'URL souboru (volitelnÈ)';
	var $_PHPSHOP_FILES_PATH_ERROR = 'Zadejte platnou cestu!';
	var $_PHPSHOP_FILES_IMAGE_RESIZE_SUCCESS = 'N·hled byl ˙spÏönÏ vytvo¯en!';
	var $_PHPSHOP_FILES_IMAGE_RESIZE_FAILURE = 'Nemohu vytvo¯it n·hled!';
	var $_PHPSHOP_FILES_UPLOAD_FAILURE = 'CHYBA p¯i nahr·v·nÌ souboru/obr·zku';
	var $_PHPSHOP_FILES_FULLIMG_DELETE_FAILURE = 'Nemohu smazat soubor obr·zku v plnÈ velikosti.';
	var $_PHPSHOP_FILES_FULLIMG_DELETE_SUCCESS = 'Soubor obr·zku v plnÈ velikosti ˙spÏönÏ smaz·n.';
	var $_PHPSHOP_FILES_THUMBIMG_DELETE_FAILURE = 'Nemohu smazat soubor n·hledu obr·zku (moûn· neexistuje): ';
	var $_PHPSHOP_FILES_THUMBIMG_DELETE_SUCCESS = 'Soubor n·hledu obr·zku ˙spÏönÏ smaz·n.';
	var $_PHPSHOP_FILES_FILE_DELETE_FAILURE = 'Nemohu smazat soubor.';
	var $_PHPSHOP_FILES_FILE_DELETE_SUCCESS = 'Soubor ˙spÏönÏ smaz·n.';
	var $_PHPSHOP_FILES_NOT_FOUND = 'Poûadovan˝ soubor nebyl nalezen!';
	var $_PHPSHOP_IMAGE_NOT_FOUND = 'Obr·zek nebyl nalezen!';
	var $_PHPSHOP_COUPON_MOD = 'SlevovÈ kupÛny';
	var $_PHPSHOP_COUPONS = 'SlevovÈ kupÛny';
	var $_PHPSHOP_COUPON_LIST = 'Seznam slevov˝ch kupÛn˘';
	var $_PHPSHOP_COUPON_ALREADY_REDEEMED = 'V·ö kupÛn byl uû pouûit.';
	var $_PHPSHOP_COUPON_REDEEMED = 'Slevov˝ kupÛn byl p¯ijat! DÏkujeme.';
	var $_PHPSHOP_COUPON_ENTER_HERE = 'Jestliûe m·te kÛd ke slevovÈmu kupÛnu, vloûte jej nÌûe:';
	var $_PHPSHOP_COUPON_SUBMIT_BUTTON = 'Odeslat';
	var $_PHPSHOP_COUPON_CODE_EXISTS = 'Tento kÛd kupÛnu uû existuje. Zkuste znova.';
	var $_PHPSHOP_COUPON_EDIT_HEADER = 'Upravit slevov˝ kupÛn';
	var $_PHPSHOP_COUPON_EDIT_HELP_TEXT = 'KliknÏte na kÛd kupÛnu pro editaci, pro smaz·nÌ na nÏj kliknÏte a vyberte Smazat:';
	var $_PHPSHOP_COUPON_CODE_HEADER = 'KÛd';
	var $_PHPSHOP_COUPON_PERCENT_TOTAL = 'Procenta nebo Ë·stka';
	var $_PHPSHOP_COUPON_TYPE = 'Typ kupÛnu';
	var $_PHPSHOP_COUPON_TYPE_TOOLTIP = 'Jednor·zov˝ kupÛn je vymaz·n po pouûitÌ a p¯izn·nÌ slevy. Trval˝ kupÛn m˘ûe b˝t pouûÌv·n neomezenÏ.';
	var $_PHPSHOP_COUPON_TYPE_GIFT = 'Jednor·zov˝ kupÛn';
	var $_PHPSHOP_COUPON_TYPE_PERMANENT = 'Trval˝ kupÛn';
	var $_PHPSHOP_COUPON_VALUE_HEADER = 'Hodnota';
	var $_PHPSHOP_COUPON_DELETE_BUTTON = 'Smazat kÛd';
	var $_PHPSHOP_COUPON_CONFIRM_DELETE = 'Opravdu smazat tento kÛd kupÛnu?';
	var $_PHPSHOP_COUPON_COMPLETE_ALL_FIELDS = 'VyplÚte prosÌm vöechny poloûky.';
	var $_PHPSHOP_COUPON_VALUE_NOT_NUMBER = 'Hodnota kupÛnu musÌ b˝t ËÌslo.';
	var $_PHPSHOP_COUPON_NEW_HEADER = 'Nov˝ kupÛn';
	var $_PHPSHOP_COUPON_COUPON_HEADER = 'KÛd kupÛnu';
	var $_PHPSHOP_COUPON_PERCENT = 'Procenta';
	var $_PHPSHOP_COUPON_TOTAL = '»·stka';
	var $_PHPSHOP_COUPON_VALUE = 'Hodnota';
	var $_PHPSHOP_COUPON_CODE_SAVED = 'KÛd kupÛnu byl uloûen.';
	var $_PHPSHOP_COUPON_SAVE_BUTTON = 'Uloûit kupÛn';
	var $_PHPSHOP_COUPON_DISCOUNT = 'Sleva na kupÛn';
	var $_PHPSHOP_COUPON_CODE_INVALID = 'KÛd kupÛnu nenalezen, zkuste jin˝.';
	var $_PHPSHOP_COUPONS_ENABLE = 'Povolit pouûÌv·nÌ kupÛn˘';
	var $_PHPSHOP_COUPONS_ENABLE_EXPLAIN = 'Jestliûe povolÌte pouûÌv·nÌ kupÛnu, mohou z·kaznÌci zadat kÛd kupÛnu pro uplatnÏnÌ slevy na objedn·vku.';
	var $_PHPSHOP_FREE_SHIPPING = 'BalnÈ a doprava zdarma';
	var $_PHPSHOP_FREE_SHIPPING_CUSTOMER_TEXT = 'Pro tuto objedn·vku je balnÈ a doprava zdarma!';
	var $_PHPSHOP_FREE_SHIPPING_AMOUNT = 'Minim·lnÌ objedn·vky pro balnÈ a dopravu zdarma';
	var $_PHPSHOP_FREE_SHIPPING_AMOUNT_TOOLTIP = 'Objedn·vka (VËetnÏ DPH!),  kter· je minim·lnÌ pro balnÈ a dopravu zdarma 
                                                (Nap¯.: <strong>5000</strong> znamen· balnÈ a dopravu zdarma, pokud si z·kaznÌk 
                                                 objedn· za 5000 KË (vË. DPH) Ëi vÌce.';
	var $_PHPSHOP_YOUR_STORE = 'V·ö obchod';
	var $_PHPSHOP_CONTROL_PANEL = 'Ovl·dacÌ Panel';
	var $_PHPSHOP_ADMIN_CFG_PDF_BUTTON = 'TlaËÌtko PDF';
	var $_PHPSHOP_ADMIN_CFG_PDF_BUTTON_EXPLAIN = 'ZobrazÌ Ëi schov· tlaËÌtko PDF';
	var $_PHPSHOP_ADMIN_CFG_AGREE_TERMS_ONORDER = 'Vyûadovat souhlas s obchodnÌmi podmÌnkami pro KAéDOU OBJEDN¡VKU?';
	var $_PHPSHOP_ADMIN_CFG_AGREE_TERMS_ONORDER_EXPLAIN = 'Jestliûe je zaökrtnuto, z·kaznÌcÌ musÌ odsouhlasit obchodnÌ podmÌnky p¯i KAéD… OBJEDN¡VCE (p¯ed jejÌm potvrzenÌm).';
	...
	var $_PHPSHOP_ERROR_CODE = 'KÛd chyby';
	var $_PHPSHOP_ERROR_DESC = 'Popis chyby';
	var $_PHPSHOP_CHANGE_TRANSACTION_KEY = 'Zobrazit/zmÏnit kÛd transakce';
	var $_PHPSHOP_CHANGE_PASSKEY_FORM = 'Zobrazit/zmÏnit heslo/kÛd transakce';
	var $_PHPSHOP_TYPE_PASSWORD = 'Vloûte heslo uûivatele';
	var $_PHPSHOP_CURRENT_PASSWORD = 'SouËasnÈ heslo';
	var $_PHPSHOP_CURRENT_TRANSACTION_KEY = 'SouËasn˝ kÛd transakce';
	var $_PHPSHOP_CHANGE_PASSKEY_SUCCESS = 'KÛd transakce byl ˙spÏönÏ zmÏnÏn.';
	...
	var $_PHPSHOP_PRODUCT_FORM_FILENAME = 'BUœ zadejte n·zev souboru';
	var $_PHPSHOP_PRODUCT_FORM_FILENAME_TOOLTIP = 'POZN¡MKA: Zde m˘ûete zadat n·zev souboru. <strong>Pokud jej zad·te, û·dn˝ soubor nebude nahr·n!!! MusÌte je nahr·t manu·lnÏ p¯es FTP!</strong>.';
	var $_PHPSHOP_PRODUCT_FORM_UPLOAD = 'NEBO nahrajte nov˝ soubor';
	var $_PHPSHOP_PRODUCT_FORM_UPLOAD_TOOLTIP = 'm˘ûete nahr·t mÌstnÌ soubor. Tento soubor bude zboûÌm, kterÈ prod·v·te. ExistujÌcÌ soubor bude p¯eps·n.';
	var $_PHPSHOP_PRODUCT_FORM_AVAILABILITY_TOOLTIP1 = 'Napiötte jak˝koliv text, kter˝ bude zobrazen z·kaznÌkovi na str·nce zboûÌ .<br />tj.: 24h, 48h, 3 - 5 dnÌ, objedn·no.....';
	var $_PHPSHOP_PRODUCT_FORM_AVAILABILITY_TOOLTIP2 = 'NEBO vyberte obr·zek, kter˝ bude zobrazen na str·nce detailnÌho popisu zboûÌ .<br />Obr·zky jsou umÌstÏny v adres·¯i <i>/components/com_phpshop/shop_image/availability</i><br />';
	var $_PHPSHOP_PRODUCT_FORM_ATTRIBUTE_LIST = 'Seznam atribut˘';
	var $_PHPSHOP_PRODUCT_FORM_ATTRIBUTE_LIST_EXAMPLES = '<h4>P¯Ìklady form·tu seznamu atribut˘:</h4>
        <pre>Velikost,XL[+100],M,S[-50];Barva,Ëerven·,zelen·,ûlut·,drah· barva[=999];atd..,..,..</pre>
        <h4>Vloûen· nastavenÌ cen pro pokroËilÈ nastavenÌ atribut˘:</h4>
        <pre>
        + == P¯iËÌst tuto Ë·stku k v˝chozÌ cenÏ.<br />
        - == OdeËÌst tuto Ë·stku od v˝chozÌ ceny.<br />
        = == Nastavit cenu na tuto Ë·stku.
       </pre>';
	var $_PHPSHOP_PRODUCT_FORM_CUSTOM_ATTRIBUTE_LIST = 'Seznam speci·lnÌch atribut˘';
	var $_PHPSHOP_PRODUCT_FORM_CUSTOM_ATTRIBUTE_LIST_EXAMPLES = '<h4>P¯Ìklad form·tu seznamu speci·lnÌch atribut˘:</h4>
        <pre>N·zev;DalöÌ;...</pre>';
	var $_PHPSHOP_MULTISELECT = 'V˝bÏr vÌce poloûek: pouûijte kl·vesu CTRL + myö';
	...
	var $_PHPSHOP_RELATED_PRODUCTS = 'P¯ÌbuznÈ poloûky';
	var $_PHPSHOP_RELATED_PRODUCTS_TIP = 'PomocÌ tohoto seznamu m˘ûete definovat p¯ÌbuznÈ poloûky. Vyberte jednu nebo vÌce (CTRL + myö) poloûek, ze kter˝ch chcete vytvo¯it <strong>p¯ÌbuznÈ poloûky</strong>.';
	var $_PHPSHOP_RELATED_PRODUCTS_HEADING = 'Mohlo by V·s zajÌmat i toto zboûÌ';
	...
	var $_PHPSHOP_ORDER_HISTORY_COMMENT_EMAIL = 'Pozn·mka k VaöÌ objedn·vce';
	var $_PHPSHOP_ORDER_HISTORY_INCLUDE_COMMENT = 'P¯idat pozn·mku?';
	var $_PHPSHOP_ORDER_HISTORY_DATE_ADDED = 'P¯id·no dne';
	var $_PHPSHOP_ORDER_HISTORY_CUSTOMER_NOTIFIED = 'Z·kaznÌk upozornÏn?';
	var $_PHPSHOP_ORDER_STATUS_CHANGE = 'ZmÏna stavu objedn·vky';
	...
	var $_PHPSHOP_PRODUCT_TYPE_LBL = 'Typ zboûÌ';
	var $_PHPSHOP_PRODUCT_TYPE_LIST_LBL = 'Typy zboûÌ';
	var $_PHPSHOP_PRODUCT_TYPE_ADDEDIT = 'P¯idat/upravit typ zboûÌ';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_LIST_LBL = 'Typy zboûÌ pro';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_LIST_MNU = 'Seznam typ˘ zboûÌ';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_FORM_LBL = 'P¯idat typ zboûÌ pro';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_FORM_MNU = 'P¯idat typ zboûÌ';
	var $_PHPSHOP_PRODUCT_PRODUCT_TYPE_FORM_PRODUCT_TYPE = 'Typ zboûÌ';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_NAME = 'N·zev typu zboûÌ';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_DESCRIPTION = 'Popis typu zboûÌ';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_PARAMETERS = 'Parametry';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_LBL = 'Informace o typu zboûÌ';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_PUBLISH = 'Publikovat?';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_BROWSEPAGE = 'Str·nka (seznam) typ˘ zboûÌ';
	var $_PHPSHOP_PRODUCT_TYPE_FORM_FLYPAGE = 'Str·nka typu zboûÌ';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_LIST_LBL = 'Parametry typu zboûÌ';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_LBL = 'Informace o parametru';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_NOT_FOUND = 'Typ zboûÌ nebyyl nalezen!';
	...
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_TYPE_INTEGER = 'CelÈ ËÌslo';
	...
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_TYPE_DATETIME = 'Datum & Ëas';
	...
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_TYPE_MULTIVALUE = 'VÌce hodnot';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_VALUES = 'ZadanÈ hodnoty';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_MULTISELECT = 'Zobrazit ZadanÈ hodnoty jako v˝bÏr vice poloûek?';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_VALUES_DESCRIPTION = '<strong>Pokud zad·ta ZadanÈ hodnoty, parametr m˘ûe nab˝vat pouze tÏchto hodnot. P¯Ìklad:</strong><BR><span class="sectionname">D¯evo;Kov;Plast;...</span>';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_DEFAULT = 'V˝chozÌ hodnota';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_DEFAULT_HELP_TEXT = 'Pro v˝chozÌ hodnotu pouûijte tento form·t:<ul><li>Datum: RRRR-MM-DD</li><li>»as: HH:MM:SS</li><li>Datum & Ëas: RRRR-MM-DD HH:MM:SS</li></ul>';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_UNIT = 'Jednotka';
	var $_PHPSHOP_PARAMETER_SEARCH = 'PokroËilÈ vyhled·v·nÌ podle parametr˘';
	var $_PHPSHOP_ADVANCED_PARAMETER_SEARCH = 'PokroËilÈ vyhled·v·nÌ podle parametr˘';
	var $_PHPSHOP_PARAMETER_SEARCH_TEXT1 = 'Chcete vyhled·vat zboûÌ podle technick˝ch parametr˘?<BR>Vyberte typ parametru ze seznamu:';
	var $_PHPSHOP_PARAMETER_SEARCH_NO_PRODUCT_TYPE = 'Lituji. Nebyla zad·na kategorie pro vyhled·v·nÌ.';
	var $_PHPSHOP_PARAMETER_SEARCH_BAD_PRODUCT_TYPE = 'Lituji. Nebyl publikov·n typ zboûÌ s tÌmto n·zvem.';
	var $_PHPSHOP_PARAMETER_SEARCH_IS_LIKE = 'Is Like';
	var $_PHPSHOP_PARAMETER_SEARCH_IS_NOT_LIKE = 'Is NOT Like';
	var $_PHPSHOP_PARAMETER_SEARCH_FULLTEXT = 'FulltextovÈ vyhled·v·nÌ';
	var $_PHPSHOP_PARAMETER_SEARCH_FIND_IN_SET_ALL = 'Vöechny vybranÈ';
	var $_PHPSHOP_PARAMETER_SEARCH_FIND_IN_SET_ANY = 'JakÈkoliv z vybran˝ch';
	var $_PHPSHOP_PARAMETER_SEARCH_RESET_FORM = 'Vymazat formul·¯';
	var $_PHPSHOP_PARAMETER_SEARCH_IN_CATEGORY = 'Vyhled·vat v kategoriÌch';
	var $_PHPSHOP_PARAMETER_SEARCH_CHANGE_PARAMETERS = 'ZmÏnit parametry';
	var $_PHPSHOP_PARAMETER_SEARCH_DESCENDING_ORDER = 'ÿadit sestupnÏ';
	var $_PHPSHOP_PARAMETER_SEARCH_ASCENDING_ORDER = 'ÿadit vzestupnÏ';
	var $_PHPSHOP_PRODUCT_TYPE_PARAMETERS_IN_CATEGORY = 'Parametry kategorie';
	var $_PHPSHOP_FEE = 'Poplatek';
	var $_PHPSHOP_PRODUCT_CLONE = 'Klonovat zboûÌ';
	var $_PHPSHOP_CSV_SETTINGS = 'NastavenÌ';
	var $_PHPSHOP_CSV_DELIMITER = 'OddÏlovaË';
	var $_PHPSHOP_CSV_ENCLOSURE = 'PoË·teËnÌ/konc. znak pole';
	...
	var $_PHPSHOP_CSV_SELECT_FIELD_ORDERING = 'Zp˘sob ¯azenÌ polÌ';
	var $_PHPSHOP_CSV_DEFAULT_ORDERING = 'V˝chozÌ';
	var $_PHPSHOP_CSV_CUSTOMIZED_ORDERING = 'Moje upravenÈ ¯azenÌ';
	var $_PHPSHOP_CSV_SUBMIT_EXPORT = 'Exportovat vöechno zboûÌ do CSV souboru';
	var $_PHPSHOP_CSV_CONFIGURATION_HEADER = 'NastavÌ Importu / Exportu CSV';
	var $_PHPSHOP_CSV_SAVE_CHANGES = 'Uloûit zmÏny';
	var $_PHPSHOP_CSV_FIELD_NAME = 'N·zev pole';
	var $_PHPSHOP_CSV_DEFAULT_VALUE = 'v˝chozÌ hodnota';
	var $_PHPSHOP_CSV_FIELD_ORDERING = 'Po¯adÌ pole';
	var $_PHPSHOP_CSV_FIELD_REQUIRED = 'Poûadov·no?';
	var $_PHPSHOP_CSV_IMPORT_EXPORT = 'Import/Export';
	var $_PHPSHOP_CSV_NEW_FIELD = 'P¯idat novÈ pole';
	var $_PHPSHOP_CSV_DOCUMENTATION = 'Dokumentace';
	var $_PHPSHOP_PRODUCT_NOT_FOUND = 'Litujeme, ale poûadovanÈ zboûÌ nebylo nalezeno!';
	var $_PHPSHOP_ADMIN_CFG_SHOW_OUT_OF_STOCK_PRODUCTS = 'Zobrazit zboûÌ, kterÈ nenÌ na skladÏ';
	var $_PHPSHOP_ADMIN_CFG_SHOW_OUT_OF_STOCK_PRODUCTS_EXPLAIN = 'Pokud je zaökrtnuto, jsou zobrazeny i produkty, kterÈ nejsou na skladÏ. Jinak je toto zboûÌ skryto.';
	var $_PHPSHOP_PRODUCT_PACKAGING1 = 'PoËet {unit}˘ v balenÌ: ';
	var $_PHPSHOP_PRODUCT_PACKAGING2 = 'PoËet {unit}˘ v krabici: ';
