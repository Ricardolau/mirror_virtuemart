 ...
 */
public class Tarpatch extends MatchingTask {
// Greg start
	static final File NULL_FILE_PLACEHOLDER = new File("/NULL_FILE");
	private Set<String> manifest = new HashSet<String>();
...
//Greg end
    ...
    public void execute() throws BuildException {
        ...
        try {
            ...
            log("Building tarpatch: " + tarFile.getAbsolutePath(), Project.MSG_INFO);
...
//                }
                ...
                try {
                    ...
                    writeManifest( writer, sortedPaths );
                    writer.close();
                } catch (IOException e) {
                    throw new BuildException("Failed to write " + manifestFile, e, getLocation());
                }
                
                TarFileSet manifestFileSet = new TarFileSet(fileset);//new FileSet());
                manifestFileSet.setDir(new File(manifestFile.getParent()));
//                manifestFileSet.setFile(manifestFile);
                tar( (TarFileSet) manifestFileSet, tOut );
...
//Greg start
	public void writeManifest( BufferedWriter writer, SortedSet<String> sortedPaths ) throws IOException
	{
...
// Greg end
    ...
    protected boolean supportsNonFileResources() {
        return getClass().equals(Tarpatch.class);
    }
    ...
    protected boolean check(ResourceCollection rc) {
        ...
        if (isFileFileSet(rc)) {
            ...
            while (iter.hasNext()) {
                ...
                upToDate &=
                    check(base == NULL_FILE_PLACEHOLDER ? null : base,
                          files);
            }
