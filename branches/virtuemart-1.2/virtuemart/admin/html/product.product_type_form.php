...
$formObj = &new formFactory( $VM_LANG->_('VM_PRODUCT_TYPE_FORM_LBL') );
//Then Start the form
$formObj->startForm();
...
<table class="adminform">
	<tr> 
      <td class="labelcell"><?php echo $VM_LANG->_('VM_PRODUCT_TYPE_FORM_PUBLISH') ?>:</td>
      <td width="62%"><?php 
	...
	<tr> 
          <td class="labelcell"><?php echo $VM_LANG->_('VM_PRODUCT_TYPE_FORM_NAME') ?>:</td>
          <td width="62%"> 
            <input type="text" class="inputbox" name="product_type_name" size="60" value="<?php $db->sp('product_type_name') ?>" />
          </td>
	</tr>
	<tr> 
        <td class="labelcell"><?php echo $VM_LANG->_('VM_PRODUCT_TYPE_FORM_DESCRIPTION') ?>:</td>
	...
	<tr>
      <td class="labelcell"><?php echo $VM_LANG->_('VM_MODULE_LIST_ORDER') ?>: </td>
      <td valign="top"><?php 
	...
	<tr>
      <td class="labelcell"><?php echo $VM_LANG->_('VM_PRODUCT_TYPE_FORM_BROWSEPAGE') ." ". $VM_LANG->_('VM_LEAVE_BLANK') ?>: </td>
      <td valign="top">
	...
	<tr>
      <td class="labelcell">
        <?php echo $VM_LANG->_('VM_PRODUCT_TYPE_FORM_FLYPAGE') ." ". $VM_LANG->_('VM_LEAVE_BLANK') ?>:
      </td>
      <td valign="top">
