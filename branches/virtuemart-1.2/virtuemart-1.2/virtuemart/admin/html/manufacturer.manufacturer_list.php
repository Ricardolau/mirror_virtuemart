...
$listObj->writeSearchHeader($VM_LANG->_('VM_MANUFACTURER_LIST_LBL'), VM_THEMEURL.'images/administration/dashboard/manufacturer.png', $modulename, "manufacturer_list");
...
$columns = Array(  "#" => "width=\"20\"", 
					...
					'ID' => 'width="5%"',
					$VM_LANG->_('VM_MANUFACTURER_LIST_MANUFACTURER_NAME') => 'width="45%"',
					$VM_LANG->_('VM_MANUFACTURER_LIST_ADMIN') => 'width="45%"',
...
while ($db->next_record()) {
    ...
    $tmp_cell = "<a href=\"". $sess->url($_SERVER['PHP_SELF']."?page=$modulename.manufacturer_form&manufacturer_id=" . $db->f("manufacturer_id")) ."\">".$VM_LANG->_('VM_UPDATE') ."</a>";
    $listObj->addCell( $tmp_cell );
