...
/**
*
* @version $Id: admin.country_state_form.php 1760 2009-05-03 22:58:57Z Aravot $
* @package VirtueMart
* @subpackage html
...
<table class="adminform">
    ...
    <tr> 
      <td width="24%" align="right"><?php echo $VM_LANG->_('VM_STATE_LIST_NAME') ?>:</td>
      <td width="76%"> 
        <input type="text" class="inputbox" name="state_name" value="<?php $db->sp("state_name") ?>" />
      </td>
    </tr>
    <tr> 
      <td width="24%" align="right"><?php echo $VM_LANG->_('VM_STATE_LIST_2_CODE') ?>:</td>
      <td width="76%"> 
        <input type="text" class="inputbox" name="state_2_code" value="<?php $db->sp("state_2_code") ?>" />
      </td>
    </tr>
        <tr> 
      <td width="24%" align="right"><?php echo $VM_LANG->_('VM_STATE_LIST_3_CODE') ?>:</td>
      <td width="76%"> 
