...
*
* @version $Id: mod_virtuemart_search.php 1760 2009-05-03 22:58:57Z Aravot $
* @package VirtueMart
* @subpackage modules
*
...
<form action="<?php $sess->purl( $mm_action_url."index.php?page=shop.browse" ) ?>" method="post">
	...
	<p><label for="keyword"><?php echo $VM_LANG->_('VM_SEARCH_LBL') ?></label></p>
	<p>
		<input name="keyword" type="text" size="12" title="<?php echo $VM_LANG->_('VM_SEARCH_TITLE') ?>" class="inputbox" id="keyword"  />
