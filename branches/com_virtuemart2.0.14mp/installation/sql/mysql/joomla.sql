...
INSERT INTO `#__extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
	...
	(10006, 'VM Payment - PayPal', 'plugin', 'paypal', 'vmpayment', 0, 0, 1, 0, '{"legacy":false,"name":"PayPal","type":"plugin","creationDate":"${PHING.VM.RELDATE}","author":"The VirtueMart Development Team","copyright":"${PHING.VM.COPYRIGHT}","authorEmail":"","authorUrl":"http:\\/\\/www.virtuemart.net","version":"${PHING.VM.RELEASE}","description":"PaypPal","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 3, 0),
	...
	(10008, 'VM Payment - Paybox', 'plugin', 'paybox', 'vmpayment', 0, 0, 1, 0, '{"legacy":false,"name":"Paybox","type":"plugin","creationDate":"${PHING.VM.RELDATE}","author":"The VirtueMart Development Team","copyright":"${PHING.VM.COPYRIGHT}","authorEmail":"","authorUrl":"http:\\/\\/www.virtuemart.net","version":"${PHING.VM.RELEASE}","description":"Realex","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
	(10009, 'VM Payment - Moneybookers', 'plugin', 'moneybookers', 'vmpayment', 0, 0, 1, 0, '{"legacy":true,"name":"Moneybookers","type":"plugin","creationDate":"April 2012","author":"Skrill Holdings Limited","copyright":"Copyright (C) 2012 Skrill.","authorEmail":"","authorUrl":"http:\\/\\/www.skrill.com","version":"${PHING.VM.RELEASE}","description":"<a href=\\"http:\\/\\/www.skrill.com\\" target=\\"_blank\\">Moneybookers<\\/a> is a popular\\n\\tpayment provider authorised by the Financial Services Authority of the United Kingdom (FSA). \\n    ","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
	(10010, 'VM Payment - Moneybookers Credit Cards', 'plugin', 'moneybookers_acc', 'vmpayment', 0, 0, 1, 0, '{"legacy":true,"name":"Moneybookers Credit Cards","type":"plugin","creationDate":"April 2012","author":"Skrill Holdings Limited","copyright":"Copyright (C) 2012 Skrill.","authorEmail":"","authorUrl":"http:\\/\\/www.skrill.com","version":"${PHING.VM.RELEASE}","description":"<a href=\\"http:\\/\\/www.skrill.com\\" target=\\"_blank\\">Moneybookers<\\/a> is a popular\\n\\tpayment provider authorised by the Financial Services Authority of the United Kingdom (FSA). \\n    ","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
	(10011, 'VM Payment - Moneybookers Lastschrift', 'plugin', 'moneybookers_did', 'vmpayment', 0, 0, 1, 0, '{"legacy":true,"name":"Moneybookers Lastschrift","type":"plugin","creationDate":"April 2012","author":"Skrill Holdings Limited","copyright":"Copyright (C) 2012 Skrill.","authorEmail":"","authorUrl":"http:\\/\\/www.skrill.com","version":"${PHING.VM.RELEASE}","description":"<a href=\\"http:\\/\\/www.skrill.com\\" target=\\"_blank\\">Moneybookers<\\/a> is a popular\\n\\tpayment provider authorised by the Financial Services Authority of the United Kingdom (FSA). \\n    ","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
	(10012, 'VM Payment - Moneybookers iDeal', 'plugin', 'moneybookers_idl', 'vmpayment', 0, 0, 1, 0, '{"legacy":true,"name":"Moneybookers iDeal","type":"plugin","creationDate":"April 2012","author":"Skrill Holdings Limited","copyright":"Copyright (C) 2012 Skrill.","authorEmail":"","authorUrl":"http:\\/\\/www.skrill.com","version":"${PHING.VM.RELEASE}","description":"<a href=\\"http:\\/\\/www.skrill.com\\" target=\\"_blank\\">Moneybookers<\\/a> is a popular\\n\\tpayment provider authorised by the Financial Services Authority of the United Kingdom (FSA). \\n    ","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
	(10013, 'VM Payment - Moneybookers Giropay', 'plugin', 'moneybookers_gir', 'vmpayment', 0, 0, 1, 0, '{"legacy":true,"name":"Moneybookers Giropay","type":"plugin","creationDate":"April 2012","author":"Skrill Holdings Limited","copyright":"Copyright (C) 2012 Skrill.","authorEmail":"","authorUrl":"http:\\/\\/www.skrill.com","version":"${PHING.VM.RELEASE}","description":"<a href=\\"http:\\/\\/www.skrill.com\\" target=\\"_blank\\">Moneybookers<\\/a> is a popular\\n\\tpayment provider authorised by the Financial Services Authority of the United Kingdom (FSA). \\n    ","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
	(10014, 'VM Payment - Moneybookers Sofortueberweisung', 'plugin', 'moneybookers_sft', 'vmpayment', 0, 0, 1, 0, '{"legacy":true,"name":"Moneybookers Sofortueberweisung","type":"plugin","creationDate":"April 2012","author":"Skrill Holdings Limited","copyright":"Copyright (C) 2012 Skrill.","authorEmail":"","authorUrl":"http:\\/\\/www.skrill.com","version":"${PHING.VM.RELEASE}","description":"<a href=\\"http:\\/\\/www.skrill.com\\" target=\\"_blank\\">Moneybookers<\\/a> is a popular\\n\\tpayment provider authorised by the Financial Services Authority of the United Kingdom (FSA). \\n    ","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
	(10015, 'VM Payment - Moneybookers Przelewy24', 'plugin', 'moneybookers_pwy', 'vmpayment', 0, 0, 1, 0, '{"legacy":true,"name":"Moneybookers Przelewy24","type":"plugin","creationDate":"April 2012","author":"Skrill Holdings Limited","copyright":"Copyright (C) 2012 Skrill.","authorEmail":"","authorUrl":"http:\\/\\/www.skrill.com","version":"${PHING.VM.RELEASE}","description":"<a href=\\"http:\\/\\/www.skrill.com\\" target=\\"_blank\\">Moneybookers<\\/a> is a popular\\n\\tpayment provider authorised by the Financial Services Authority of the United Kingdom (FSA). \\n    ","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
	(10016, 'VM Payment - Moneybookers Online Bank Transfer', 'plugin', 'moneybookers_obt', 'vmpayment', 0, 0, 1, 0, '{"legacy":true,"name":"Moneybookers Bank Transfer","type":"plugin","creationDate":"April 2012","author":"Skrill Holdings Limited","copyright":"Copyright (C) 2012 Skrill.","authorEmail":"","authorUrl":"http:\\/\\/www.skrill.com","version":"${PHING.VM.RELEASE}","description":"<a href=\\"http:\\/\\/www.skrill.com\\" target=\\"_blank\\">Moneybookers<\\/a> is a popular\\n\\tpayment provider authorised by the Financial Services Authority of the United Kingdom (FSA). \\n    ","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
	(10017, 'VM Payment - Moneybookers Skrill Digital Wallet', 'plugin', 'moneybookers_wlt', 'vmpayment', 0, 0, 1, 0, '{"legacy":true,"name":"Moneybookers Digital Wallet","type":"plugin","creationDate":"April 2012","author":"Skrill Holdings Limited","copyright":"Copyright (C) 2012 Skrill.","authorEmail":"","authorUrl":"http:\\/\\/www.skrill.com","version":"${PHING.VM.RELEASE}","description":"<a href=\\"http:\\/\\/www.skrill.com\\" target=\\"_blank\\">Moneybookers<\\/a> is a popular\\n\\tpayment provider authorised by the Financial Services Authority of the United Kingdom (FSA). \\n    ","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
	(10018, 'VM Payment - Authorize.net', 'plugin', 'authorizenet', 'vmpayment', 0, 0, 1, 0, '{"legacy":true,"name":"Authorize.net AIM","type":"plugin","creationDate":"${PHING.VM.RELDATE}","author":"The VirtueMart Development Team","copyright":"${PHING.VM.COPYRIGHT}","authorEmail":"","authorUrl":"http:\\/\\/www.virtuemart.net","version":"${PHING.VM.RELEASE}","description":"","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
	(10019, 'VM Payment - Sofort iDeal', 'plugin', 'sofort_ideal', 'vmpayment', 0, 0, 1, 0, '{"legacy":true,"name":"Sofort Ideal","type":"plugin","creationDate":"${PHING.VM.RELDATE}","author":"The VirtueMart Development Team","copyright":"${PHING.VM.COPYRIGHT}","authorEmail":"","authorUrl":"http:\\/\\/www.virtuemart.net","version":"${PHING.VM.RELEASE}","description":"<a href=\\"http:\\/www.sofort.com\\" target=\\"_blank\\">Sofort<\\/a> is a popular\\n\\tpayment provider and available in many countries. \\n    ","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 2, 0),
	(10020, 'VM Shipment - By weight, ZIP and countries', 'plugin', 'weight_countries', 'vmshipment', 0, 1, 1, 0, '{"legacy":true,"name":"VMSHIPMENT_WEIGHT_COUNTRIES","type":"plugin","creationDate":"${PHING.VM.RELDATE}","author":"The VirtueMart Development Team","copyright":"${PHING.VM.COPYRIGHT}","authorEmail":"","authorUrl":"http:\\/\\/www.virtuemart.net","version":"${PHING.VM.RELEASE}","description":"VMSHIPMENT_WEIGHT_COUNTRIES_PLUGIN_DESC","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
	(10021, 'VM Custom - Customer text input', 'plugin', 'textinput', 'vmcustom', 0, 1, 1, 0, '{"legacy":true,"name":"VMCustom - textinput","type":"plugin","creationDate":"${PHING.VM.RELDATE}","author":"The VirtueMart Development Team","copyright":"Copyright (C) 2004-2012 Virtuemart Team. All rights reserved.","authorEmail":"","authorUrl":"http:\\/\\/www.virtuemart.net","version":"${PHING.VM.RELEASE}","description":"text input plugin for product","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
	(10022, 'VM Custom - Product specification', 'plugin', 'specification', 'vmcustom', 0, 1, 1, 0, '{"legacy":true,"name":"VMCustom - specification","type":"plugin","creationDate":"January 09 2013","author":"The VirtueMart Development Team","copyright":"Copyright (C) 2004-2012 Virtuemart Team. All rights reserved.","authorEmail":"","authorUrl":"http:\\/\\/www.virtuemart.net","version":"2.0.18a","description":"Specification plugin for product","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
	...
	(10027, 'mod_virtuemart_currencies', 'module', 'mod_virtuemart_currencies', '', 0, 1, 1, 0, '{"legacy":true,"name":"mod_virtuemart_currencies","type":"module","creationDate":"${PHING.VM.RELDATE}","author":"The VirtueMart Development Team","copyright":"${PHING.VM.COPYRIGHT}","authorEmail":"","authorUrl":"http:\\/\\/www.virtuemart.net","version":"${PHING.VM.RELEASE}","description":"MOD_VIRTUEMART_CURRENCIES_DESC","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
	(10028, 'mod_virtuemart_product', 'module', 'mod_virtuemart_product', '', 0, 1, 1, 0, '{"legacy":true,"name":"mod_virtuemart_product","type":"module","creationDate":"${PHING.VM.RELDATE}","author":"The VirtueMart Development Team","copyright":"${PHING.VM.COPYRIGHT}","authorEmail":"","authorUrl":"http:\\/\\/www.virtuemart.net","version":"${PHING.VM.RELEASE}","description":"MOD_VIRTUEMART_PRODUCT_DESC","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 3, 0),
	...
	(10030, 'mod_virtuemart_manufacturer', 'module', 'mod_virtuemart_manufacturer', '', 0, 1, 1, 0, '{"legacy":true,"name":"mod_virtuemart_manufacturer","type":"module","creationDate":"${PHING.VM.RELDATE}","author":"The VirtueMart Development Team","copyright":"${PHING.VM.COPYRIGHT}","authorEmail":"","authorUrl":"http:\\/\\/www.virtuemart.net","version":"${PHING.VM.RELEASE}","description":"MOD_VIRTUEMART_MANUFACTURER_DESC","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 8, 0),
	(10031, 'mod_virtuemart_cart', 'module', 'mod_virtuemart_cart', '', 0, 1, 1, 0, '{"legacy":true,"name":"VirtueMart Shopping Cart","type":"module","creationDate":"${PHING.VM.RELDATE}","author":"The VirtueMart Development Team","copyright":"${PHING.VM.COPYRIGHT}","authorEmail":"","authorUrl":"http:\\/\\/www.virtuemart.net","version":"${PHING.VM.RELEASE}","description":"MOD_VIRTUEMART_CART_DESC","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
	(10032, 'mod_virtuemart_category', 'module', 'mod_virtuemart_category', '', 0, 1, 1, 0, '{"legacy":true,"name":"mod_virtuemart_category","type":"module","creationDate":"${PHING.VM.RELDATE}","author":"The VirtueMart Development Team","copyright":"${PHING.VM.COPYRIGHT}","authorEmail":"","authorUrl":"http:\\/\\/www.virtuemart.net","version":"${PHING.VM.RELEASE}","description":"MOD_VIRTUEMART_CATEGORY_DESC","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 4, 0),
	(10033, 'mod_vmmenu', 'module', 'mod_vmmenu', '', 1, 1, 1, 0, '{"legacy":false,"name":"mod_vmmenu","type":"module","creationDate":"March 2014","author":"The VirtueMart Development Team","copyright":"{PHING.VM.COPYRIGHT}","authorEmail":"","authorUrl":"http:\\/\\/www.virtuemart.net","${PHING.VM.RELEASE}","description":"VirtueMart Administrator Menu Module","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 1, 0),
	(10034, 'vmbeez5', 'template', 'vmbeez5', '', 0, 1, 1, 0, '{"legacy":false,"name":"vmbeez5","type":"template","creationDate":"21 May 2010","author":"Angie Radtke and the VirtueMart Team","copyright":"Copyright (C) 2005 - 2014 Open Source Matters, Inc. All rights reserved.","authorEmail":"a.radtke@derauftritt.de","authorUrl":"http:\\/\\/www.der-auftritt.de","version":"2.5.0","description":"TPL_VIRTUEMART_XML_DESCRIPTION","group":""}', '{"wrapperSmall":"53","wrapperLarge":"72","logo":images\\/stories\\/virtuemart.png","sitetitle":"VirtueMart, free online shop solution","sitedescription":"free online shop solution","navposition":"center","html5":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0);
...
#INSERT INTO `#__menu_types` VALUES (2, 'mainmenude', 'Main Menu de', 'Das Hauptmenu');
...
INSERT INTO `#__modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
	...
	(3, 'Popular Articles', '', '', 3, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_popular', 3, 1, '{"count":"5","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"1","automatic_title":"1"}', 1, '*'),
	...
	(93, 'VM - Admin Menu', '', '', 2, 'menu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_vmmenu', 3, 1, '{"show_vmmenu":"1"}', 1, '*'),
	(94, 'Main Menu DE', '', '', 1, 'position-1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenude","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, 'de-DE');
...
INSERT INTO `#__template_styles` VALUES (4, 'beez_20', '0', '0', 'Beez2 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"","navposition":"left","templatecolor":"personal","html5":"0"}');
...
INSERT INTO `#__template_styles` VALUES (7, 'vmbeez5', 0, 1, 'vmBeez5 - Default', '{"wrapperSmall":53,"wrapperLarge":85,"logo":"images\\/stories\\/virtuemart.png","sitetitle":"VirtueMart free online shop solution","sitedescription":"free online shop solution","navposition":"left","html5":0}');
