...
class vmLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_NO_USER_TO_SELECT = 'Sentimos muito, mas não há nenhum usuário que possa ser adicionado à lista de clientes com_phpshop';
	...
	var $_PHPSHOP_ADMIN_CFG_URL_EXPLAIN = 'URL do seu site. Normalmente idêntico a URL do Mambo (com barra invertida no final!)';
	...
	var $_PHPSHOP_ADMIN_CFG_URLIMAGE_EXPLAIN = 'A URL ao diretório do componente de imagem do mambo-phpShop (com barra invertida no final!).';
	var $_PHPSHOP_ADMIN_CFG_ADMINPATH = 'ADMINPATH';
	var $_PHPSHOP_ADMIN_CFG_ADMINPATH_EXPLAIN = 'Caminho ao diretório de componente mambo-phpShop.';
	var $_PHPSHOP_ADMIN_CFG_CLASSPATH = 'CLASSPATH';
	var $_PHPSHOP_ADMIN_CFG_CLASSPATH_EXPLAIN = 'Caminho ao diretório de classes do phpShop.';
	var $_PHPSHOP_ADMIN_CFG_PAGEPATH = 'PAGEPATH';
	var $_PHPSHOP_ADMIN_CFG_PAGEPATH_EXPLAIN = 'Caminho ao diretório phpShop html.';
	var $_PHPSHOP_ADMIN_CFG_IMAGEPATH = 'IMAGEPATH';
	var $_PHPSHOP_ADMIN_CFG_IMAGEPATH_EXPLAIN = 'Caminho ao diretório do phpShop shop_image.';
	...
	var $_PHPSHOP_ADMIN_CFG_MAXIMUMROWS = 'MÁXIMO COLUNAS';
	var $_PHPSHOP_ADMIN_CFG_MAXIMUMROWS_EXPLAIN = 'Define o número de colunas a ser mostrado em uma caixa de seleção de listagem de ordem.';
	...
	var $_PHPSHOP_ADMIN_CFG_STORE_ENCODEKEY_EXPLAIN = 'Usado para encriptar informações guardadas em banco de dados com esta chave. Significa que este arquivo deve sempre ser protegido de ser visualisado.';
	...
	var $_PHPSHOP_PRODUCT_FORM_AVAILABILITY_TOOLTIP2 = 'OU selecione uma imagem a ser mostrada na página de detalhes (pag. do produto).<br />A imagem reside no diretório <i>/components/com_phpshop/shop_image/availability</i><br />';
...
//	var $_PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_USPS_SHIPSERVICE_TOOLTIP = 'USPS Shipping type (Express,First Class,Priority,Parcel,BPM,Library,Media)';
	...
	var $_PHPSHOP_USPS_RESPONSE_ERROR = 'USPS was not able to process the Shipping Rate Request.';	var $_PHPSHOP_PARAMETERS_LBL = 'Parameters';
