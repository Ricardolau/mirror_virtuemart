...
/**
*
* @version $Id: store.store_form.php 1760 2009-05-03 22:58:57Z Aravot $
* @package VirtueMart
* @subpackage html
...
$title = '<img src="'. VM_THEMEURL.'images/administration/dashboard/store.png" align="absmiddle" border="0" alt="Store" />'.'&nbsp;&nbsp;&nbsp;'. $VM_LANG->_('VM_STORE_FORM_LBL');
...
<br /><br />
  <table class="adminform">
    <tr> 
 		<td width="50%" valign="top"><br />
		  ...
		  <legend><?php echo $VM_LANG->_('VM_STORE_MOD') ?></legend>
	 		<table class="adminform">
			    ...
			    <tr class="row0"> 
			      <td class="labelcell"><?php echo $VM_LANG->_('VM_STORE_FORM_ZIP') ?>:</td>
			      <td width="78%" > 
			        <input type="text" class="inputbox" name="zip" value="<?php $db->sp("zip") ?>" size="10" />
			      </td>
			    </tr>
			    <tr class="row1"> 
			      <td class="labelcell"><?php echo $VM_LANG->_('VM_STORE_FORM_PHONE') ?>:</td>
			      <td width="78%" > 
			        <input type="text" class="inputbox" name="vendor_phone" value="<?php $db->sp("vendor_phone") ?>" size="16" />
			      </td>
			    </tr>
			    <tr class="row0"> 
			      <td class="labelcell"><?php echo $VM_LANG->_('VM_STORE_ADDRESS_FORMAT') ?>:<br />
					<?php
					echo vmToolTip($VM_LANG->_('VM_STORE_ADDRESS_FORMAT_TIP') . ':<br />
			        		<strong>{storename}</strong>: '.$VM_LANG->_('VM_STORE_FORM_STORE_NAME').'<br />
			        		<strong>{address_1}</strong>: '.$VM_LANG->_('VM_STORE_FORM_ADDRESS_1').'<br />
			        		<strong>{address_2}</strong>: '.$VM_LANG->_('VM_STORE_FORM_ADDRESS_2').'<br />
			        		<strong>{state}</strong>: '.$VM_LANG->_('VM_STORE_FORM_STATE').'<br />
			        		<strong>{statename}</strong>: '.$VM_LANG->_('VM_STATE_LIST_2_CODE').'<br />
			        		<strong>{city}</strong>: '.$VM_LANG->_('VM_STORE_FORM_CITY').'<br />
			        		<strong>{zip}</strong>: '.$VM_LANG->_('VM_STORE_FORM_ZIP').'<br />
			        		<strong>{country}</strong>: '.$VM_LANG->_('VM_STORE_FORM_COUNTRY').'<br />
			        		<strong>{phone}</strong>: '.$VM_LANG->_('VM_STORE_FORM_PHONE').'<br />
			        		<strong>{fax}</strong>: '.$VM_LANG->_('VM_STORE_FORM_FAX').'<br />
			        		<strong>{email}</strong>: '.$VM_LANG->_('VM_STORE_FORM_EMAIL').'<br />
			        		<strong>{url}</strong>: '.$VM_LANG->_('VM_PRODUCT_FORM_URL').'<br />
			        		');
			        ?>
			        </td>
			    ...
			    <tr class="row1"> 
			      <td class="labelcell"><?php echo $VM_LANG->_('VM_STORE_DATE_FORMAT') ?>:
				  </td>
			      <td width="78%" > 
			  ...
			  <br />
			<fieldset>
		  <legend><?php echo $VM_LANG->_('VM_STORE_FORM_LBL') ?></legend>
	    	  <table class="adminform">
	    		<tr class="row0"> 
			      <td class="labelcell"><?php echo $VM_LANG->_('VM_STORE_FORM_FULL_IMAGE') ?>:</td>
			      <td width="78%" ><?php  
			    ...
			    <tr class="row1"> 
			      <td class="labelcell"><?php echo $VM_LANG->_('VM_STORE_FORM_UPLOAD') ?>:</td>
			      <td width="78%" > 
			        <input type="file" name="vendor_full_image" size="16" />
			      </td>
			    </tr>
			    <tr class="row0"> 
			      <td class="labelcell"><?php echo $VM_LANG->_('VM_STORE_FORM_MPOV') ?>: </td>
			      <td width="78%" > 
			        <input type="text" class="inputbox" name="vendor_min_pov" value="<?php $db->sp("vendor_min_pov") ?>" size="6" />
			      </td>
			    </tr>
			    <tr class="row1"> 
			      <td class="labelcell"><?php echo $VM_LANG->_('VM_FREE_SHIPPING_AMOUNT') ?>: </td>
			      <td width="78%" > 
    	...
    	<td width="50%" valign="top"><br />
		  			  <fieldset>
			  <legend><?php echo $VM_LANG->_('VM_STORE_FORM_CONTACT_LBL') ?></legend>
			  <table class="adminform">
			    <tr class="row0">
			      <td class="labelcell"> <?php echo $VM_LANG->_('VM_STORE_FORM_LAST_NAME') ?>:</td>
			      <td width="78%" > 
			        <input type="text" class="inputbox" name="last_name" value="<?php $db->sp("last_name") ?>" size="16" />
			      </td>
			    </tr>
			    <tr class="row1"> 
			      <td class="labelcell"> <?php echo $VM_LANG->_('VM_STORE_FORM_FIRST_NAME') ?>:</td>
			      <td width="78%" > 
			        <input type="text" class="inputbox" name="first_name" value="<?php $db->sp("first_name") ?>" size="16" />
			      </td>
			    </tr>
			    <tr class="row0"> 
			      <td class="labelcell"> <?php echo $VM_LANG->_('VM_STORE_FORM_MIDDLE_NAME') ?>:</td>
			      <td width="78%" > 
			        <input type="text" class="inputbox" name="middle_name" value="<?php $db->sp("middle_name") ?>" size="16">
			      </td>
			    </tr>
			    <tr class="row1"> 
			      <td class="labelcell"> <?php echo $VM_LANG->_('VM_STORE_FORM_TITLE') ?>:</td>
			      <td width="78%" > 
			        <input type="text" class="inputbox" name="title" value="<?php $db->sp("title") ?>" size="16" />
			      </td>
			    </tr>
			    <tr class="row0"> 
			      <td class="labelcell"> <?php echo $VM_LANG->_('VM_STORE_FORM_PHONE_1') ?>:</td>
			      <td width="78%" > 
			        <input type="text" class="inputbox" name="phone_1" value="<?php $db->sp("phone_1") ?>" size="16" />
			      </td>
			    </tr>
			    <tr class="row1"> 
			      <td class="labelcell"> <?php echo $VM_LANG->_('VM_STORE_FORM_PHONE_2') ?>:</td>
			      <td width="78%" > 
			        <input type="text" class="inputbox" name="phone_2" value="<?php $db->sp("phone_2") ?>" size="16" />
			      </td>
			    </tr>
			    <tr class="row0"> 
			      <td class="labelcell"> <?php echo $VM_LANG->_('VM_STORE_FORM_FAX') ?>:</td>
			      <td width="78%" > 
			        <input type="text" class="inputbox" name="fax" value="<?php $db->sp("fax") ?>" size="16" />
			      </td>
			    </tr>
			    <tr class="row1"> 
			      <td class="labelcell"> <?php echo $VM_LANG->_('VM_STORE_FORM_EMAIL') ?>:</td>
			      <td width="78%" > 
	      ...
	      <br />
	      <fieldset><legend><?php echo $VM_LANG->_('VM_CURRENCY_DISPLAY') ?></legend>
	      <table class="adminform"><?php
				...
				?>
		    <tr class="row0"> 
		      <td class="labelcell"><?php echo $VM_LANG->_('VM_STORE_FORM_CURRENCY') ?>: </td>
		      <td width="78%" > 
		        <?php $ps_html->list_currency("vendor_currency", $db->sf("vendor_currency")) ?>
		      </td>
		    </tr>
		    <tr class="row1">
		      <td class="labelcell"><?php echo $VM_LANG->_('VM_CURRENCY_SYMBOL') ?>: </td>
		      <td>
		    ...
		    <tr class="row0">
		      <td class="labelcell"><?php echo $VM_LANG->_('VM_CURRENCY_DECIMALS') ?>: </td>
		    ...
		    <tr class="row1">
		      <td class="labelcell"><?php echo $VM_LANG->_('VM_CURRENCY_DECIMALSYMBOL') ?>: </td>
		    ...
		    <tr class="row0">
		      <td class="labelcell"><?php echo $VM_LANG->_('VM_CURRENCY_THOUSANDS') ?>: </td>
		    ...
		    <tr class="row1">
		      <td class="labelcell"><?php echo $VM_LANG->_('VM_CURRENCY_POSITIVE_DISPLAY') ?>: </td>
		      <td>
		        <?php 
		        ps_html::dropdown_display( 'display_style[5]', $currency_display['positive'], $currency_style_positive );
				echo vmToolTip( $VM_LANG->_('VM_CURRENCY_POSITIVE_DISPLAY_TOOLTIP') ) ?>
		      </td>
		    </tr>
		    <tr class="row0">
		      <td class="labelcell"><?php echo $VM_LANG->_('VM_CURRENCY_NEGATIVE_DISPLAY') ?>: </td>
		      <td>
		        <?php
		        ps_html::dropdown_display( 'display_style[6]', $currency_display['negative'], $currency_style_negative );
				echo vmToolTip( $VM_LANG->_('VM_CURRENCY_NEGATIVE_DISPLAY_TOOLTIP') ) 
				?>
		      </td>
		    </tr>
		    <tr class="row1">
...
<fieldset>
	<legend><?php echo $VM_LANG->_('VM_STORE_FORM_DESCRIPTION') ?></legend>
	<?php
	editorArea( 'editor1', $db->f("vendor_store_desc"), 'vendor_store_desc', '400', '200', '70', '15' );
    ?>
</fieldset>
<fieldset>
	<legend><?php echo $VM_LANG->_('VM_STORE_FORM_TOS') ?></legend>
    <?php
