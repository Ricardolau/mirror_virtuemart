...
$formObj = &new formFactory( $VM_LANG->_('VM_CREDITCARD_FORM_LBL') );
//Then Start the form
$formObj->startForm();
...
<table class="adminform">
    ...
    <tr> 
      <td width="24%" align="right"><?php echo $VM_LANG->_('VM_CREDITCARD_NAME') ?>:</td>
      <td width="76%"> 
        <input type="text" class="inputbox" name="creditcard_name" value="<?php $db->sp("creditcard_name") ?>" />
      </td>
    </tr>
    <tr> 
      <td width="24%" align="right"><?php echo $VM_LANG->_('VM_CREDITCARD_CODE') ?>:</td>
      <td width="76%"> 
