...
$columns = Array(  "#" => 'width="3%"',
					...
					$VM_LANG->_('Name') => 'width="20%"',
					$VM_LANG->_('Type') => "width=\"10%\"",
					$VM_LANG->_('Element') => "width=\"10%\"",
...
while ($db->next_record()) {
	...
	$tmpcell = "<a href=\"". $sess->url( $_SERVER['SCRIPT_NAME']."?page=admin.plugins&folder=$folder&plugin_id=".$db->f("id")."&id=".$db->f("id")."&func=changePublishState" );
