...
/**
*
* @version $Id: product.product_attribute_list.php 1760 2009-05-03 22:58:57Z Aravot $
* @package VirtueMart
* @subpackage html
...
if (!empty($product_parent_id)) {
  $title = $VM_LANG->_('VM_ATTRIBUTE_LIST_LBL'). " - Product:";
} else {
  $title = $VM_LANG->_('VM_ATTRIBUTE_LIST_LBL'). " - Item:";
}
...
$columns = Array(  "#" => "width=\"20\"", 
					...
					$VM_LANG->_('VM_ATTRIBUTE_LIST_NAME') => 'width="30%"',
					$VM_LANG->_('VM_ATTRIBUTE_LIST_ORDER') => 'width="45%"',
