...
/**
*
* @version $Id: shipping.carrier_list.php 1760 2009-05-03 22:58:57Z Aravot $
* @package VirtueMart
* @subpackage html
...
$listObj->writeSearchHeader($VM_LANG->_('VM_CARRIER_LIST_LBL'), VM_THEMEURL."images/administration/dashboard/ups.gif", $modulename, "carrier_list");
...
$columns = Array(  "#" => "width=\"20\"", 
					...
					$VM_LANG->_('VM_CARRIER_LIST_NAME_LBL') => '',
					$VM_LANG->_('VM_CARRIER_LIST_ORDER_LBL') => '',
