...
$formObj = &new formFactory( $VM_LANG->_('VM_CURRENCY_LIST_ADD') );
//Then Start the form
$formObj->startForm();
...
<table class="adminform">
    ...
    <tr> 
      <td width="24%" align="right"><?php echo $VM_LANG->_('VM_CURRENCY_LIST_NAME') ?>:</td>
      <td width="76%"> 
        <input type="text" class="inputbox" name="currency_name" value="<?php $db->sp("currency_name") ?>" />
      </td>
    </tr>
    <tr> 
      <td width="24%" align="right"><?php echo $VM_LANG->_('VM_CURRENCY_LIST_CODE') ?>:</td>
      <td width="76%"> 
