...
$formObj = &new formFactory( $VM_LANG->_('VM_MANUFACTURER_CAT_FORM_LBL') );
//Then Start the form
$formObj->startForm();
?>
<table class="adminform">
	<tr> 
                  <td width="38%" align="right"><B><?php echo $VM_LANG->_('VM_MANUFACTURER_CAT_FORM_INFO_LBL') ?></b> 
                  </td>
                  <td width="62%">&nbsp;</td>
	</tr>
	<tr> 
                  <td width="38%" align="right"><?php echo $VM_LANG->_('VM_MANUFACTURER_CAT_FORM_NAME') ?>:</td>
                  <td width="62%"> 
                    <input type="text" class="inputbox" name="mf_category_name" size="18" value="<?php $db->sp('mf_category_name') ?>" />
                  </td>
	</tr>
	<tr> 
                  <td width="38%" nowrap align="right" valign="top"><?php echo $VM_LANG->_('VM_MANUFACTURER_CAT_FORM_DESCRIPTION') ?>:</td>
