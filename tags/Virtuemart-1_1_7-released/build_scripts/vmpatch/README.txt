...
Annoying and tedious. I decided not to do that from 1.1.6 on.
...
2. Copy build.patch113-112.properties. Rename it to build.patch11y-11x.properties (use your x & y).
3. Copy build.patch113-112.xml. Rename it to build.patch11y-11x.xml.
...
5. Inside build.patch11y-11x.xml, change the line below to match your properties file name (from step 4):
 <property file="build.patch113-112.properties" />
6. Run the "patch" target in build.patch11y-11x.xml. It is the default target. E.g.

	ant -f build.patch117-112.xml patch
...
Remember to update "release_revisions.txt" also.
