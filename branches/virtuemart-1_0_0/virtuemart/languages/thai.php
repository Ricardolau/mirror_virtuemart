...
class vmLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_NO_USER_TO_SELECT = 'ขออภัย ไม่พบผู้ใช้ในระบบของแมมโบ้จึงไม่สามารถเพิ่มในส่วนของผู้ใช้งาน com_phpshop';
	...
	var $_PHPSHOP_ADMIN_CFG_URL_EXPLAIN = 'URL สำหรับ Mambo ไซต์ของท่าน (ใส่เครื่องหมาย / ต่อท้่ายด้วย!)';
	...
	var $_PHPSHOP_ADMIN_CFG_URLCOMPONENT_EXPLAIN = 'URL สำหรับคอมโพเน้นท์ของ mambo-phpShop (ใส่เครื่องหมาย / ต่อท้่ายด้วย!)';
	var $_PHPSHOP_ADMIN_CFG_URLIMAGE = 'IMAGEURL';
	var $_PHPSHOP_ADMIN_CFG_URLIMAGE_EXPLAIN = 'URL สำหรับเก็บรูปภาพคอมโพเน้นท์ของ mambo-phpShop (ใส่เครื่องหมาย / ต่อท้่ายด้วย!)';
	var $_PHPSHOP_ADMIN_CFG_ADMINPATH = 'ADMINPATH';
	var $_PHPSHOP_ADMIN_CFG_ADMINPATH_EXPLAIN = 'ไดเรคทอรี่พาธสำหรับคอมโพเน้นท์ของ mambo-phpShop';
	var $_PHPSHOP_ADMIN_CFG_CLASSPATH = 'CLASSPATH';
	var $_PHPSHOP_ADMIN_CFG_CLASSPATH_EXPLAIN = 'ไดเรคทอรี่พาธสำหรับคลาสของ phpShop';
	var $_PHPSHOP_ADMIN_CFG_PAGEPATH = 'PAGEPATH';
	var $_PHPSHOP_ADMIN_CFG_PAGEPATH_EXPLAIN = 'ไดเรคทอรี่พาธสำหรับเก็บไฟล์ html ของ phpShop';
	var $_PHPSHOP_ADMIN_CFG_IMAGEPATH = 'IMAGEPATH';
	var $_PHPSHOP_ADMIN_CFG_IMAGEPATH_EXPLAIN = 'ไดเรคทอรี่พาธสำหรับเก็บรูปภาพของ phpShop';
	...
	var $_PHPSHOP_ADMIN_CFG_SEARCHROWS = 'จำนวนบรรทัดต่อหน้า';
	var $_PHPSHOP_ADMIN_CFG_SEARCHROWS_EXPLAIN = 'ระบุจำนวนบรรทัดต่อหน้า จากผลการค้นหาที่ได้';
	var $_PHPSHOP_ADMIN_CFG_SEARCHCOLOR1 = 'สีแถบรายการค้นหา 1';
	var $_PHPSHOP_ADMIN_CFG_SEARCHCOLOR1_EXPLAIN = 'กำหนดสีของแถบรายการค้นหาในแถวเลขคี่';
	var $_PHPSHOP_ADMIN_CFG_SEARCHCOLOR2 = 'สีแถบรายการค้นหา 2';
	var $_PHPSHOP_ADMIN_CFG_SEARCHCOLOR2_EXPLAIN = 'กำหนดสีของแถบรายการค้นหาในแถวเลขคู่';
	var $_PHPSHOP_ADMIN_CFG_MAXIMUMROWS = 'จำนวนบรรทัดสูงสุด';
	var $_PHPSHOP_ADMIN_CFG_MAXIMUMROWS_EXPLAIN = 'กำหนดจำนวนบรรทัดที่จะแสดงในส่วนของรายการ';
