...
/**
*
* @version $Id: login_registration.tpl.php 1760 2009-05-03 22:58:57Z Aravot $
* @package VirtueMart
...
<label for="toggler1"><?php echo $VM_LANG->_('VM_RETURN_LOGIN') ?></label>
</h4>
...
<label for="toggler2"><?php echo $VM_LANG->_('VM_NEW_CUSTOMER') ?></label></h4>
