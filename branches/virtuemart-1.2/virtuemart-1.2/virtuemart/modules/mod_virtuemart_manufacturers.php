...
/*
* @version $Id: mod_virtuemart_manufacturers.php 1760 2009-05-03 22:58:57Z Aravot $
* @package VirtueMart
* @subpackage modules
*
  ...
  <div> 
  	<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" name="vm_manufacturer">
        ...
        <select class="inputbox" name="manufacturer_id" onchange="document.vm_manufacturer.submit()">
            <option value=""><?php echo $VM_LANG->_('VM_SELECT') ?></option>
        <?php  
    ...
    <br />
      <input class="button" type="submit" name="manufacturerSearch" value="<?php echo $VM_LANG->_('VM_SEARCH_TITLE') ?>" />
